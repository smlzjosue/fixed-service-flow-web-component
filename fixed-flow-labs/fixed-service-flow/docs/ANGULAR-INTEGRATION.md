...
```html
<script type="module" src="https://cdn.jsdelivr.net/gh/smlzjosue/fixed-service-flow-web-component@v1.2.6/fixed-flow-labs/fixed-service-flow/dist/fixed-service-flow/fixed-service-flow.esm.js"></script>
```
