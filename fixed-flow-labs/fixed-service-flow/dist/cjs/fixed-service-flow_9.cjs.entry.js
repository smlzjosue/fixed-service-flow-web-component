...
const StepContract = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2f9c47b6c246b9276582b054d4acd5b5b93d120b' }, index.h("div", { key: '5b1aeb54cb7a37e15c577c024eac0f55c15304ad', class: "step-contract" }, index.h("header", { key: '8124ea48b7f4b7275506d5eb641fcdce708b6c53', class: "step-contract__header" }, index.h("h1", { key: '3e6716b94aa4d6982f5f006ec4cbacaefe44e4d7', class: "step-contract__title" }, "Selecciona un tipo de contrato"), index.h("button", { key: '8a857e12ddf111e8ec13dcc82eebdc00dbe82749', class: "step-contract__btn-back", onClick: this.onBack }, "Regresar")), index.h("div", { key: '5ca2f0d833ba164ae68ffec105a1ca71932ec3a3', class: "step-contract__tabs" }, index.h("button", { key: 'c1825dbde1dc8ce831d17a0cd39e28c28df28560', class: {
                'step-contract__tab': true,
                'step-contract__tab--active': this.activeTab === 1,
            }, onClick: () => this.handleTabChange(1) }, index.h("span", { key: '50ccd7deb4f256b89da061effffe695e0ec581de', class: "step-contract__tab-title" }, "Con contrato"), index.h("span", { key: '7e843b6d67ac076caf7440699bdc832f9bf490fa', class: "step-contract__tab-subtitle" }, "12 y 24 meses de contrato")), index.h("button", { key: '62315f4009bd88143214c66b2daaa001d81ed921', class: {
                'step-contract__tab': true,
                'step-contract__tab--active': this.activeTab === 0,
            }, onClick: () => this.handleTabChange(0) }, index.h("span", { key: 'ea46ea0c39ac56434943c9b50e6f1d543066a31e', class: "step-contract__tab-title" }, "Sin contrato"), index.h("span", { key: 'ad729aa2d84dbfb7b6119a1bc22ff7e67e71e959', class: "step-contract__tab-subtitle" }, "Plan mensual con pago por adelantado"))), index.h("div", { key: 'ee383044912670ca01820363ff22ba9f80fff0d3', class: "step-contract__content" }, this.activeTab === 1 && withContract && (index.h("div", { key: 'b8cdb6a4896b2f0967c477ce1f14a255b5960255', class: "step-contract__options" }, withContract.contract.map((option) => {
        ...
        }))), this.activeTab === 0 && withoutContract && (index.h("div", { key: '35fa055c3a36d4b3146f773f1dd8339d7b5131cf', class: "step-contract__options step-contract__options--single" }, withoutContract.contract.map((option) => {
            const totalCost = this.getTotalInstallationCost(option);
            return (index.h("label", { class: {
                    'step-contract__option': true,
        ...
        })))), index.h("div", { key: 'aaebc10f26e262a70f5b59683dffac9a213742ef', class: "step-contract__actions" }, index.h("button", { key: 'fa4628928d489765766d08dbe90f6f1bc8a3c87e', class: "step-contract__btn-continue", onClick: this.handleContinue, disabled: !this.selectedOption }, "Continuar"), index.h("button", { key: '8f4ecec2da5c42e53fe78b21326c5417cb3f2d62', type: "button", class: "step-contract__btn-back-mobile", onClick: this.onBack }, "Regresar")))));
    }
};
...
const StepForm = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2fa4a0352177c811fb5afc47e4ad07f24166f4ab' }, index.h("div", { key: '88d7652756cb1e5d5009b06e81535cd98ff432d8', class: "step-form" }, index.h("header", { key: '2b0a19cb32480eee44a3e0b33cf054464920a159', class: "step-form__header" }, index.h("h1", { key: 'afed1e19359a5b05f4b868d4d424df7e2825f7ad', class: "step-form__title" }, "Formulario de solicitud de servicio fijo"), index.h("button", { key: 'df02c419da69c9817f5af3e42c520be6b9878012', type: "button", class: "step-form__btn-back", onClick: this.handleBack }, "Regresar")), this.isMobile && (index.h("div", { key: 'b9424e82af8c80fbeab8689d8d36595114710daa', class: "step-form__stepper" }, index.h("ui-stepper", { key: '1806f334bdb2c3eecab309f2b6b862531c28e58e', steps: FORM_STEPS, currentStep: currentStepNumber }))), index.h("form", { key: 'a071baff2c9ea83e0c500aeb5a3193e5a95c3eb7', onSubmit: this.handleSubmit }, index.h("p", { key: 'a5b037e74a6523f1008e7f8b447a586b94e9af28', class: "step-form__instructions" }, "Por favor, ingresa la informaci\u00F3n personal solicitada. Su nombre y apellido deben ser iguales a su identificaci\u00F3n de gobierno."), !this.isMobile && ([
            this.renderIdentificationSection(),
            ...this.renderContactSection(),
        ]), this.isMobile && this.currentSection === 'identification' && (this.renderIdentificationSection()), this.isMobile && this.currentSection === 'contact' && (this.renderContactSection()), index.h("div", { key: 'cef96813a085fceb80023f35f14093b13197940f', class: "step-form__actions" }, index.h("button", { key: 'cb4e112737a3651603851fa7470a0d8f6396f628', type: "submit", class: "step-form__btn-submit", disabled: !this.isCurrentSectionValid() }, "Continuar"), index.h("button", { key: '1e43e11844b4e4e8abc90d3ffdeac3de191d8401', type: "button", class: "step-form__btn-back-mobile", onClick: this.handleBack }, "Regresar"))))));
    }
};
...
const StepLocation = class {
    ...
    // ------------------------------------------
    render() {
        return (index.h(index.Host, { key: 'a0fdfad7a80905bc3141ce6302af7256365a18da' }, index.h("div", { key: '6b74fcce9383db47460bb4f7f130f857b4738bf4', class: "step-location" }, this.isValidating && (index.h("div", { key: 'df9d5d8ad2f5c75579c9585684831a4bf98d4825', class: "step-location__validating-overlay" }, index.h("div", { key: '3b4a202ce7f1c87679ccc2c56ca5873b230c1056', class: "step-location__validating-content" }, index.h("div", { key: '42f54fee8387c2ef51a2dea1163c46632e150e66', class: "step-location__validating-spinner" }), index.h("p", { key: '72430e87f565c5acc19434a6c8355a1f7036091c', class: "step-location__validating-text" }, "Validando cobertura...")))), index.h("header", { key: 'c69038b1231461cb213fdf0fdfa1c8c384214025', class: "step-location__header" }, index.h("h1", { key: '61fd8665ccbe62bab912208cdc0f8398d0600567', class: "step-location__title" }, index.h("span", { key: 'a7de8d8ebc2d29801563450c909f7779e662e61c', class: "step-location__title--highlight" }, "Servicio fijo empresarial"), ' ', "en tu \u00E1rea")), index.h("div", { key: 'd06f446f759ab7a242cb72c7a939de6ba22aa7e4', class: "step-location__map-container" }, index.h("div", { key: '177368ec4c2f2b3c051e8db95f1b2d8971c228db', class: "step-location__controls" }, index.h("div", { key: 'ccfc60346af14245e4d206fb7b9637ebd5d93017', class: "step-location__input-group" }, index.h("span", { key: 'a131e0801ae2a5c211a960348b79018868bef126', class: "step-location__input-icon" }, index.h("svg", { key: '1f3992c346f3508e2917c0e43f14b890b1b5a973', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: '10b96b5a2d113b8b663b00be61302687ecc6d53f', d: "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" }), index.h("circle", { key: 'a294b8189754fc5dc4e825e37e84f2fb535e03b9', cx: "12", cy: "10", r: "3" }))), index.h("input", { key: '3bf292ddee316f4b413e3d0f8b45cc392f1eea8a', type: "text", class: "step-location__input", placeholder: "Ingrese su direcci\u00F3n", value: this.address, onInput: this.handleAddressChange, onKeyPress: this.handleKeyPress, ref: (el) => this.addressInput = el }), index.h("button", { key: 'bad47c7f3307d9d81278b30b53d6491b1854c4af', class: {
                'step-location__btn-validate': true,
                'step-location__btn-validate--loading': this.isValidating,
            }, onClick: this.handleValidate, disabled: this.isValidating || (!this.address.trim() && !this.currentCoordinates) }, this.isValidating ? (index.h("span", { class: "step-location__btn-validate-content" }, index.h("span", { class: "step-location__btn-spinner" }), "Validando...")) : ('Validar'))), index.h("div", { key: 'a502425053a83561ee44061dadf13f09ccf8d199', class: "step-location__location-container" }, index.h("button", { key: '6bf0ef16f7318d7a8fd0b4debd11fe9b60bb76c2', class: "step-location__btn-location", onClick: this.handleUseCurrentLocation, disabled: this.isGettingLocation || this.isLoadingMap }, index.h("svg", { key: 'f6de87717c9e21457a237d64238971f247ce5166', class: "step-location__btn-location-icon", viewBox: "0 0 24 24", fill: "currentColor", stroke: "none" }, index.h("path", { key: 'f984f44eca6955577daea1e2be42b1f02171470f', d: "M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" })), this.isGettingLocation ? 'Obteniendo ubicación...' : 'Utilizar Ubicación Actual'))), index.h("div", { key: 'd6cf5a98c1fb5afc2fd069b2d3c0150b824158d8', class: "step-location__map" }, this.isLoadingMap && !this.mapError && (index.h("div", { key: '55608fde515440a7f43f7f8258b6d26abee6f160', class: "step-location__map-loading" }, index.h("div", { key: '41cd04d0eb061ab9ebaec6a04f0b989bc8b843ae', class: "step-location__spinner" }), index.h("p", { key: 'c084625896cec00e76f1276403c06c47bbaf92ff' }, "Cargando mapa..."))), this.mapError && (index.h("div", { key: '08a2a87133de69b9aa5bffd3471f74417898ef2a', class: "step-location__map-error" }, index.h("p", { key: '837216b8693265ce2d0ab6e64fe3e06332e6211c' }, this.mapError), !this.googleMapsKey && (index.h("small", { key: '839af12d94b96e2d3173bfaacfa3ddcf8ac9ec65' }, "Configura la prop google-maps-key en el componente")))), index.h("div", { key: 'f3d4e74af751b703fbde4c711a7916bc2b5403a4', class: "step-location__map-canvas", ref: (el) => this.mapContainer = el, style: { display: this.mapError ? 'none' : 'block' } }))), this.showErrorModal && (index.h("div", { key: '742b0c5d5bde185c75d85559e7b034cc99cb542b', class: "step-location__modal-backdrop" }, index.h("div", { key: '63f4d5c22000f78ae0f36a398963c887a8436c36', class: "step-location__modal step-location__modal--error" }, index.h("button", { key: 'eac5df4ad471cc1dd140450925da89eb7976f618', class: "step-location__modal-close", onClick: () => this.showErrorModal = false }, "\u00D7"), index.h("div", { key: 'd822289c60d275817eabf7f62ca4462ade3c65a5', class: "step-location__modal-error-bar" }, "Error"), index.h("p", { key: 'ba7d2f9c9aa46e573282ad7a3dc2a8c823dbcfb6', class: "step-location__modal-message" }, this.errorMessage), index.h("button", { key: '9070d8dfdda3359c33b1f64ae26f07f5f863823b', class: "step-location__modal-btn", onClick: () => this.showErrorModal = false }, "Cerrar")))))));
    }
};
...
const StepPlans = class {
    ...
    render() {
        ...
        const totalToday = 0;
        return (index.h(index.Host, { key: 'ce4bdd1822f0418bbe4cd6403cecfc60a81499fd' }, index.h("div", { key: '38976660d6e3896bcb92f42c2f10d7b021180fb1', class: "step-plans" }, index.h("header", { key: '0d683bb4162744cd85ed4860dfd711b0ed8b46d9', class: "step-plans__header" }, index.h("h1", { key: '4f66e42bf7d39fd9cbef543b7bdee009457198b9', class: "step-plans__title" }, "Elige tu plan"), index.h("button", { key: '6e0d378f423df0195f6a8005ce3dabdfda0aeaa0', class: "step-plans__btn-back", onClick: this.onBack }, "Regresar")), this.isLoading && (index.h("div", { key: 'f34a8fd65581325f2c8e43962d28c62ddcc7d53c', class: "step-plans__loading" }, index.h("div", { key: '66507730218129cce81e7eafc74bb1d8019f2d38', class: "step-plans__spinner" }), index.h("p", { key: 'd4434bdf2778ab37665e9e23441a73974c1137ef' }, "Cargando planes..."))), this.error && (index.h("div", { key: '3a58571b1d567de14059f24bbb47c6ed235df90f', class: "step-plans__error" }, index.h("p", { key: '77aa040bbe6b3893d008d996e76ff821b5da4c4e' }, this.error), index.h("button", { key: '2ffaa904005874041feb12dda1ea7fc27586725f', onClick: () => this.loadPlans() }, "Reintentar"))), !this.isLoading && !this.error && this.plans.length > 0 && (index.h("div", { key: '44215a7aebba82416cd8f5dc965d9b77d184b69e', class: "step-plans__carousel-container" }, index.h("ui-carousel", { key: '163f4d7469975cc1f0434cecb27c9be84cd6add9', totalItems: this.plans.length, gap: 24, showNavigation: false, showPagination: true, breakpoints: [
                { minWidth: 0, slidesPerView: 1 },
                { minWidth: 500, slidesPerView: 2 },
                { minWidth: 800, slidesPerView: 3 },
                { minWidth: 1100, slidesPerView: 4 },
            ] }, this.plans.map((plan) => this.renderPlanCard(plan))))), !this.isLoading && !this.error && this.plans.length === 0 && (index.h("div", { key: '5357ee725145edfed49e9e014e52386465ed33c6', class: "step-plans__empty" }, index.h("p", { key: '21cba0327cc39f3f81aa81fea3c162bea5d21569' }, "No hay planes disponibles para tu \u00E1rea."))), index.h("footer", { key: '6f6b93e7fb3f6cb8a9b739d839439169de7be3dd', class: "step-plans__footer" }, index.h("div", { key: '95d9c33f6f82b9e2750264ee710dc276262df131', class: "step-plans__footer-left" }, index.h("div", { key: 'af5ef8dc173fb0bcbf4acaf2852dbb4cf8266229', class: "step-plans__footer-info" }, index.h("div", { key: '57bc69a6b30f13223a5984298ad1377a7550a90f', class: "step-plans__footer-item" }, index.h("span", { key: '94c0f380a7c660092d5631b0d6658603b18451bf', class: "step-plans__footer-label" }, "Pago mensual"), index.h("span", { key: '6c925764bfc5b8ffce889e8de23ef4916eeed71b', class: "step-plans__footer-value" }, formatPrice(monthlyPayment))), index.h("div", { key: 'f064724dee792e20e747ada032e14b2c1351a55f', class: "step-plans__footer-item step-plans__footer-item--separator" }, index.h("span", { key: 'a7c8bba8b4fa48d947851cbc87cea3f0221162ff', class: "step-plans__footer-label" }, "Paga hoy"), index.h("span", { key: 'd9d4050c7d0ee7e9c81505e88bf8440fa7bda1d6', class: "step-plans__footer-value step-plans__footer-value--highlight" }, formatPrice(totalToday)))), index.h("p", { key: '717963632f536afdabeca705acf9d5f21992614f', class: "step-plans__footer-note" }, "Renta mensual aproximada no incluye cargos estatales, federales, ni otros impuestos.")), index.h("button", { key: '690c687202551a680b6835f5407260f2a042069d', class: "step-plans__footer-btn", onClick: this.handleContinue, disabled: !this.selectedPlan || this.isAddingToCart }, this.isAddingToCart ? 'Procesando...' : 'Continuar')))));
    }
};
