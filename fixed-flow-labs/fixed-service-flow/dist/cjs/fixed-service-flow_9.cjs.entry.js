...
const StepConfirmation = class {
    ...
    render() {
        return (index.h(index.Host, { key: '449778ed0f375ee034a3df3b8b6e8f533f8cb0db' }, index.h("div", { key: 'a1bdb548476effe70f6f35b72fe1b6e5b8d1baf3', class: "step-confirmation" }, index.h("header", { key: '45ea030ea6ed2731d6c4b9e6f5da0f6396a77740', class: "step-confirmation__header" }, index.h("h1", { key: '1c79e21c0f27fc6bdd26f107a6f8a40956804b68', class: "step-confirmation__header-title" }, "Confirmaci\u00F3n de Solicitud")), index.h("div", { key: 'd772325d6bb91350a9004def2044985a9c222ca9', class: "step-confirmation__content" }, this.status === 'loading' && this.renderLoading(), this.status === 'success' && this.renderSuccess(), this.status === 'error' && this.renderError()), this.status === 'success' && (index.h("div", { key: '723bb7a27e30753b5b886630094e0bc9524d69fa', class: "step-confirmation__actions" }, index.h("button", { key: '49ddcbb3a848dc86c575bc58f16570fede2dd478', class: "step-confirmation__btn", onClick: this.handleClose }, "Cerrar"))), this.status === 'error' && (index.h("div", { key: '8660a2a85187276b0b530844bf96d03c3b6e6414', class: "step-confirmation__actions" }, index.h("button", { key: '633987a833750a44047650b84c47168cfbad0a04', class: "step-confirmation__btn step-confirmation__btn--error", onClick: this.handleRetry }, "Volver a intentar"))))));
    }
};
...
const StepLocation = class {
    ...
    // ------------------------------------------
    render() {
        return (index.h(index.Host, { key: 'a277c65d6f7cde73682ce009dfe64f99b33625bb' }, index.h("div", { key: 'f00353c6dfcbcfc3836342ad3c2c5d381106f8b1', class: "step-location" }, this.isValidating && (index.h("div", { key: '9a34be5eac8ccc560e8d2da86cacbea1c97e4b45', class: "step-location__validating-overlay" }, index.h("div", { key: 'c80ef7ec8645849010e98e839f6b1219e9b90309', class: "step-location__validating-content" }, index.h("div", { key: '2ccc798f4428d95fe26cb6f7cb1a2c3dc36b96be', class: "step-location__validating-spinner" }), index.h("p", { key: '34ebb862679139420d7f3b32444fe1e88214c15a', class: "step-location__validating-text" }, "Validando cobertura...")))), index.h("header", { key: '8647775f5792b425d5ba16ad1a8c4a8c214cebdb', class: "step-location__header" }, index.h("h1", { key: '3ee52c05e8e89260f4592d944a8fa95331ab2002', class: "step-location__title" }, index.h("span", { key: 'b34d3156c80ed7063a71fdacd827dbca5a76cd08', class: "step-location__title--highlight" }, "Servicio fijo empresarial"), ' ', "en tu \u00E1rea")), index.h("div", { key: '72407fb0ae165412c6458f73c8b2264787d67e63', class: "step-location__map-container" }, index.h("div", { key: 'bcc1e45a5bc782ef34c4ab0cdb599f1759ab85f9', class: "step-location__controls" }, index.h("div", { key: '8eeb6651e6bd8d816807ebf445feef71536fa8a4', class: "step-location__input-group" }, index.h("span", { key: 'cb801b24e2d0d1b47610f020a93cdb2d0aee3de8', class: "step-location__input-icon" }, index.h("svg", { key: '03058476c09fedb579f29881bab5f70e0a48d0ae', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: 'e35449e03553f32589953e4e852d1b4a2f372b6b', d: "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" }), index.h("circle", { key: 'faf9d798c9b013e8feba55983fa9ee7a120331ba', cx: "12", cy: "10", r: "3" }))), index.h("input", { key: 'b917469ffc983c38ef23c5a8598eb98015f868ac', type: "text", class: "step-location__input", placeholder: "Ingrese su direcci\u00F3n", value: this.address, onInput: this.handleAddressChange, onKeyPress: this.handleKeyPress, ref: (el) => this.addressInput = el }), index.h("button", { key: '4c3202666dd4877aa3e7f39dbb8368740ea6c3c1', class: {
                'step-location__btn-validate': true,
                'step-location__btn-validate--loading': this.isValidating,
            }, onClick: this.handleValidate, disabled: this.isValidating || (!this.address.trim() && !this.currentCoordinates) }, this.isValidating ? (index.h("span", { class: "step-location__btn-validate-content" }, index.h("span", { class: "step-location__btn-spinner" }), "Validando...")) : ('Validar'))), index.h("div", { key: '3c6e604950eb7a88816cab297a043dc8a72b3af1', class: "step-location__location-container" }, index.h("button", { key: '6a9bcd5c4c344f7e91b9ce233ab3c85a85e4d809', class: "step-location__btn-location", onClick: this.handleUseCurrentLocation, disabled: this.isGettingLocation || this.isLoadingMap }, index.h("svg", { key: '8aea5e38394da1b7c86acfa8622bf9b046931cee', class: "step-location__btn-location-icon", viewBox: "0 0 24 24", fill: "currentColor", stroke: "none" }, index.h("path", { key: '5985f65e567d22f4d32aa6cfc30a2266aa5a6311', d: "M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" })), this.isGettingLocation ? 'Obteniendo ubicación...' : 'Utilizar Ubicación Actual'))), index.h("div", { key: 'f10c38d5f3bd13581f8320b1f04ea9627b014167', class: "step-location__map" }, this.isLoadingMap && !this.mapError && (index.h("div", { key: '133b0e2e407c71d800897290d5a509e343264461', class: "step-location__map-loading" }, index.h("div", { key: '9d920b95c0490bf7714843b41bbcf6e736ffa376', class: "step-location__spinner" }), index.h("p", { key: '856e550515254cfd86aeceb32152368a2fd71224' }, "Cargando mapa..."))), this.mapError && (index.h("div", { key: 'd7d40cf0157461f7e6b4fb35f617b8c364d848fc', class: "step-location__map-error" }, index.h("p", { key: 'af873c95809968e2ce24f86db7be0704eb4cc972' }, this.mapError), !this.googleMapsKey && (index.h("small", { key: '2aee4f15642716404901765b8f91f6aa08656cc9' }, "Configura la prop google-maps-key en el componente")))), index.h("div", { key: '4f45f8222fe2351c5aea27052849dac227513c65', class: "step-location__map-canvas", ref: (el) => this.mapContainer = el, style: { display: this.mapError ? 'none' : 'block' } }))), this.showErrorModal && (index.h("div", { key: '4885ff4d073000fa62e0a651e36931755639ba3e', class: "step-location__modal-backdrop" }, index.h("div", { key: 'f24eb86b71643b6a4af0e11ea40ed9063a364644', class: "step-location__modal step-location__modal--error" }, index.h("button", { key: 'd59dbeff27d1ffb29b5d24ae6c153f00ed49ce1c', class: "step-location__modal-close", onClick: () => this.showErrorModal = false }, "\u00D7"), index.h("div", { key: '4dc63bc763cedb2f305985b867be54e031f7c6a9', class: "step-location__modal-error-bar" }, "Error"), index.h("p", { key: 'abcd81b8349b00b2ecf623dfb402ec3072cc4220', class: "step-location__modal-message" }, this.errorMessage), index.h("button", { key: '8157f3342e2e79faa3187042768f84b67c385315', class: "step-location__modal-btn", onClick: () => this.showErrorModal = false }, "Cerrar")))))));
    }
};
...
const StepPlans = class {
    ...
    render() {
        ...
        const totalToday = 0;
        return (index.h(index.Host, { key: '71c916044e88e63578e0093f15ddcbe0287a0449' }, index.h("div", { key: 'b451804ab60176a01dbe351e61a4d6699936ffba', class: "step-plans" }, index.h("header", { key: '3a9885fb7071d80ee8f6f60cce18c3bd67dc6fef', class: "step-plans__header" }, index.h("button", { key: 'ddfa2321981cd0a4468d1a5a7fa7345139ec342c', class: "step-plans__back-link", onClick: this.onBack }, index.h("svg", { key: 'd7b8ef58798169dea02f7ffa16085761713d60c6', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("polyline", { key: 'fecc51fcec60640d6d0133cd6511a85420290544', points: "15 18 9 12 15 6" })), index.h("span", { key: '71e56cec810389d4c8dc6020ef018f15d9082696' }, "Regresar")), index.h("h1", { key: 'ff70c76faf831a80dce5e844e556614d00d8f720', class: "step-plans__title" }, "Elige tu plan"), index.h("div", { key: '89c8c48112081ae1cfdc1b7ac38ad08bef23ec91', class: "step-plans__divider" })), this.isLoading && (index.h("div", { key: 'dd3ee1883c99148424a4afb47b186d5f0c26a9cd', class: "step-plans__loading" }, index.h("div", { key: '1b85359c971e156c68c6ae6a26a2a0e7af96e901', class: "step-plans__spinner" }), index.h("p", { key: 'ed08b8a31592da0bcdf3ae373373d4c7b44977f2' }, "Cargando planes..."))), this.error && (index.h("div", { key: '860ef48d0c1b48b8be08565c3d3c3e166fe17bc8', class: "step-plans__error" }, index.h("p", { key: 'd4819934b6a45838e8112c1bcd20496554b247a4' }, this.error), index.h("button", { key: '85f71600e4dab0a8e29514360867aee5395a8a79', onClick: () => this.loadPlans() }, "Reintentar"))), !this.isLoading && !this.error && this.plans.length > 0 && (index.h("div", { key: '92528629d3d40596f32e9c0099e7ce26f1723cb9', class: "step-plans__carousel-container" }, index.h("ui-carousel", { key: 'd3f02d81bd4faa661ef52ec4f098e9ed1db82775', totalItems: this.plans.length, gap: 24, showNavigation: false, showPagination: true, breakpoints: [
                { minWidth: 0, slidesPerView: 1 },
                { minWidth: 500, slidesPerView: 2 },
                { minWidth: 800, slidesPerView: 3 },
                { minWidth: 1100, slidesPerView: 4 },
            ] }, this.plans.map((plan) => this.renderPlanCard(plan))))), !this.isLoading && !this.error && this.plans.length === 0 && (index.h("div", { key: '2e0947419e26a6d5b662fa234e1874df48a75120', class: "step-plans__empty" }, index.h("p", { key: 'bbe9e5d84363c6ae3ab81dc34d43d1b82b34a46b' }, "No hay planes disponibles para tu \u00E1rea."))), index.h("footer", { key: 'b14a72d1ac25fee9325801f2019f05a5c370dd63', class: "step-plans__footer" }, index.h("div", { key: '1aa9e2de4ccff26772475de2478772f759b48558', class: "step-plans__footer-left" }, index.h("div", { key: 'b317441bffd781f7bb2ce96598615f9b2def1c44', class: "step-plans__footer-info" }, index.h("div", { key: 'c2bd471a1c366ea382ada43b342963c0ce226302', class: "step-plans__footer-item" }, index.h("span", { key: '8131b6c6794d88b03e9b18811bae54fe1d1043b1', class: "step-plans__footer-label" }, "Pago mensual"), index.h("span", { key: 'f2a7817042d267aba146d281d871123939506e84', class: "step-plans__footer-value" }, formatPrice(monthlyPayment))), index.h("div", { key: '679047174259006b71821fcc208521224ef0127e', class: "step-plans__footer-item step-plans__footer-item--separator" }, index.h("span", { key: '32deed61a01762e549679834564a3d3baafc18ae', class: "step-plans__footer-label" }, "Paga hoy"), index.h("span", { key: '5a5a62b56fc9bedacb36865cb3a4a169b2ca4415', class: "step-plans__footer-value step-plans__footer-value--highlight" }, formatPrice(totalToday)))), index.h("p", { key: '7c10e8cbcbcc334d8ae9ede73b00d9cb47212b45', class: "step-plans__footer-note" }, "Renta mensual aproximada no incluye cargos estatales, federales, ni otros impuestos.")), index.h("button", { key: 'd772ec9082de9536b94c7609f04e7299d2d87a17', class: "step-plans__footer-btn", onClick: this.handleContinue, disabled: !this.selectedPlan || this.isAddingToCart }, this.isAddingToCart ? 'Procesando...' : 'Continuar')))));
    }
};
