...
const UiButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cc7f1be74ec793ade6906f7742d2e093aff405ff' }, index.h("button", { key: 'd416922c0b6461b3ebce9a346a7cd490199386e9', class: classes, type: this.type, disabled: this.disabled || this.loading, onClick: this.handleClick }, this.loading && (index.h("span", { key: '84fbd928ad7abeeba01ae7a1d22361299dfa40d4', class: "ui-button__spinner" })), index.h("span", { key: 'eeca2010f006dd7647d6dd780a99b888e9f588bc', class: "ui-button__content" }, index.h("slot", { key: '52903878f8c0f08f6473a686c2b7b6c304a3b79d' })))));
    }
};
