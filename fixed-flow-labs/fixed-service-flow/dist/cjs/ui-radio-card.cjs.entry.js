...
const UiRadioCard = class {
    constructor(hostRef) {
        ...
        this.cardSelect = index.createEvent(this, "cardSelect");
    }
    // ------------------------------------------
    // PROPS
    // ------------------------------------------
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd12d163681f1f07e8c081aa8b28314bd84ff21a5' }, index.h("div", { key: '58bb40c6e20a51a71a4957fba61706c8c91e6541', class: classes, role: "radio", "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: this.disabled ? -1 : 0, onClick: this.handleSelect, onKeyDown: this.handleKeyDown }, index.h("input", { key: 'c2c2ead50ec5825a4c06b4f4e8ba29c0fee63213', type: "radio", class: "ui-radio-card__input", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, tabIndex: -1 }), this.badge && (index.h("span", { key: 'bbf7ac4cc6018cda4b8011543aaf0f1fd3dcbee3', class: "ui-radio-card__badge" }, this.badge)), index.h("div", { key: 'd99cbe0fdfc97fac40fc9f0391b21bbe1373aeb6', class: "ui-radio-card__indicator" }, index.h("span", { key: 'b4b666d531312857ca332cec80e5e99e7614fcff', class: "ui-radio-card__indicator-dot" })), index.h("div", { key: '3e1bd4bda69a5f5831f808c45f2429cfd1857e45', class: "ui-radio-card__content" }, this.icon && (index.h("div", { key: '02ea3f14f99fc2603650651c3112d3f598be1f93', class: "ui-radio-card__icon" }, index.h("slot", { key: '6dc60a9a3adfe35188d6bf97788e222aea3ded87', name: "icon" }, index.h("img", { key: '52bc4c5a55e6424b2680ad6bf87a899035d76b79', src: this.icon, alt: "" })))), index.h("div", { key: '938303753dfc53fa24a57b0fd570b43051e28ff7', class: "ui-radio-card__text" }, this.cardTitle && (index.h("h4", { key: 'e08580b3fcc8b29fc0f5122b0d5b316051055d41', class: "ui-radio-card__title" }, this.cardTitle)), this.description && (index.h("p", { key: 'b54a9e9fecd108aafc97961e9d19dc94995f9902', class: "ui-radio-card__description" }, this.description)), index.h("slot", { key: '08038bbf6a214dd679944a7bf6e92dd1076d9946' })), this.price && (index.h("div", { key: '722334c464a6365aa9c78158793b3893cb9f7790', class: "ui-radio-card__price" }, this.price))))));
    }
};
UiRadioCard.style = uiRadioCardCss();

exports.ui_radio_card = UiRadioCard;
//# sourceMappingURL=ui-radio-card.entry.cjs.js.map
