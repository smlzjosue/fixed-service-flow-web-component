...
const UiRadioCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2e68558ea972039e06e99723d1f1dc8076353f71' }, index.h("div", { key: '88027bdd23d38de850092b1d5828e1223999dbfe', class: classes, role: "radio", "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: this.disabled ? -1 : 0, onClick: this.handleSelect, onKeyDown: this.handleKeyDown }, index.h("input", { key: 'b950800f90a4e0afd5e3a9b8417c92f1ceec1e52', type: "radio", class: "ui-radio-card__input", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, tabIndex: -1 }), this.badge && (index.h("span", { key: '0de31dfe0f0d0652b1f5f10d2b7a7c20873e8920', class: "ui-radio-card__badge" }, this.badge)), index.h("div", { key: '69b695f350f0fa846c2d6ff669886797b69bd716', class: "ui-radio-card__indicator" }, index.h("span", { key: '0c8d037fbf2c6e66336ee80928017ca29dcc4ed2', class: "ui-radio-card__indicator-dot" })), index.h("div", { key: 'a49023646a3eda9641cd4ebad4aeb76654bbc5bd', class: "ui-radio-card__content" }, this.icon && (index.h("div", { key: '0fc2355d6a6ad451de5424bdceec98f2c83c237d', class: "ui-radio-card__icon" }, index.h("slot", { key: '4341e87837a4f8afefd94103ac9dfdac614fa4a3', name: "icon" }, index.h("img", { key: 'b0f32581a62e160dbd66ca78cf3f440d7c4396da', src: this.icon, alt: "" })))), index.h("div", { key: '7f653fdcf76444f7559c0a98240850fbea65603f', class: "ui-radio-card__text" }, this.cardTitle && (index.h("h4", { key: '50cf26921ee423ef8cf989006fa09222f6c809e7', class: "ui-radio-card__title" }, this.cardTitle)), this.description && (index.h("p", { key: 'cfff88b731aba9fd5bf34bb478ca937e17e13d89', class: "ui-radio-card__description" }, this.description)), index.h("slot", { key: 'f236aef647bd3c209e50ce1040324b8e313155b0' })), this.price && (index.h("div", { key: 'f2db25133995a99277476e01e630180e10f38e00', class: "ui-radio-card__price" }, this.price))))));
    }
};
