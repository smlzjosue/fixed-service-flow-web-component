...
const UiRadioCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1c41c8217c70e9f480bb7a1748f6e1eb689491ec' }, index.h("div", { key: 'ca1afac1bcca4cd50a4fc16130b4aebd547b1783', class: classes, role: "radio", "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: this.disabled ? -1 : 0, onClick: this.handleSelect, onKeyDown: this.handleKeyDown }, index.h("input", { key: '64292419422633d3d0401dff3f11cf5c55f4a617', type: "radio", class: "ui-radio-card__input", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, tabIndex: -1 }), this.badge && (index.h("span", { key: 'c77466bd35d573616c41cfe30dff8234218dc8c7', class: "ui-radio-card__badge" }, this.badge)), index.h("div", { key: 'b2378af1641a1c54b9df4971a8854ff3d265200c', class: "ui-radio-card__indicator" }, index.h("span", { key: '60e459800c4293ba88c24177c50cd4e412094d76', class: "ui-radio-card__indicator-dot" })), index.h("div", { key: 'd68455ab07ca8e162c48e909dcaac56ddee2c94a', class: "ui-radio-card__content" }, this.icon && (index.h("div", { key: '81bdca159ec377094410366c1d4b1dfbd97ea343', class: "ui-radio-card__icon" }, index.h("slot", { key: 'f2b397b1dd8fd280bf8fd5d9b8eea204bf8849ea', name: "icon" }, index.h("img", { key: 'b843b0c0b56a2cdaa97f38aaef82cddc68ca8ed1', src: this.icon, alt: "" })))), index.h("div", { key: '1241a9775169718f650be2e5694cdf5c1bf53cf4', class: "ui-radio-card__text" }, this.cardTitle && (index.h("h4", { key: 'c55dff86af55bba621699779e9d5b29038d2d83d', class: "ui-radio-card__title" }, this.cardTitle)), this.description && (index.h("p", { key: 'da6d4f38d523c3586db5c2566f5713d52da2c2ed', class: "ui-radio-card__description" }, this.description)), index.h("slot", { key: '0d04e6330e9853e3f6f0cc4e5f39206bb518cd29' })), this.price && (index.h("div", { key: 'a808d901d24f36e0b5d659f0cfa7447f464e5324', class: "ui-radio-card__price" }, this.price))))));
    }
};
