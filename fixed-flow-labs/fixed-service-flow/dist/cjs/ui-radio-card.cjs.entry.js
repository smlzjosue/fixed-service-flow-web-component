...
const UiRadioCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e723bb7d9908e73b2da21b541b7667b578775b26' }, index.h("div", { key: 'f405c20fcaa00122e658eb8428c51bf78d323a59', class: classes, role: "radio", "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: this.disabled ? -1 : 0, onClick: this.handleSelect, onKeyDown: this.handleKeyDown }, index.h("input", { key: '6c925d310a0169922c0f2562ece51f688414b941', type: "radio", class: "ui-radio-card__input", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, tabIndex: -1 }), this.badge && (index.h("span", { key: 'fa6d60f225621c7d92c924e3d93f9c6b54ea9dfb', class: "ui-radio-card__badge" }, this.badge)), index.h("div", { key: '84c2ebdd0e6a585700dff78f90124c7337bfef0b', class: "ui-radio-card__indicator" }, index.h("span", { key: 'a2fc5631643f988d26203d994939a258a13cea78', class: "ui-radio-card__indicator-dot" })), index.h("div", { key: '5d9be107f32ecf67bbe0da159b52ed45605d8c26', class: "ui-radio-card__content" }, this.icon && (index.h("div", { key: '1d3b926f1cbf9c3eccfe507319844a817a75a690', class: "ui-radio-card__icon" }, index.h("slot", { key: 'c0fe7b272baba67871877f27655ad296917cb1a0', name: "icon" }, index.h("img", { key: 'bdb4fb3898503d28394382d2540446c33aee8db0', src: this.icon, alt: "" })))), index.h("div", { key: 'caaed923ee0126f860dda3638732ca575c71ad56', class: "ui-radio-card__text" }, this.cardTitle && (index.h("h4", { key: '0e2af4cea7248d1d22e916121e60b094f87f8424', class: "ui-radio-card__title" }, this.cardTitle)), this.description && (index.h("p", { key: 'f78aed2d474a15051103a3c303d2be7cf7f29c22', class: "ui-radio-card__description" }, this.description)), index.h("slot", { key: '145b0b783b0401ec96275a37b590342da62db751' })), this.price && (index.h("div", { key: '206ed0aa3e28a4da91f37d0b9e2cb13bc1192f31', class: "ui-radio-card__price" }, this.price))))));
    }
};
