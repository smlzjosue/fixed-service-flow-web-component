...
const StepConfirmation = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e0eceafd99b97d025bd5f35e3df9f4ee4230e464' }, index.h("div", { key: '5eee1e9849c360af57aedf8c814f08f4ebc7dfef', class: "step-confirmation" }, index.h("header", { key: 'ba063cc7fe7b1ce5415c728fd545db9c7285888e', class: "step-confirmation__header" }, index.h("h1", { key: '9774de7b3e8a2676ac166dc37b41c8e38fe078a5', class: "step-confirmation__header-title" }, "Confirmaci\u00F3n de Solicitud")), index.h("div", { key: 'b09c1a71dc5d00c76dbbb53607614ddf662b792a', class: "step-confirmation__content" }, this.status === 'loading' && this.renderLoading(), this.status === 'success' && this.renderSuccess(), this.status === 'error' && this.renderError()), this.status === 'success' && (index.h("div", { key: 'de5c20cbb95532044a47037c1b99c4fa3687d0af', class: "step-confirmation__actions" }, index.h("button", { key: '6613d3fd9a74882ca546b41480d0d62f4a9b061a', class: "step-confirmation__btn", onClick: this.handleClose }, "Cerrar"))), this.status === 'error' && (index.h("div", { key: '09f4a1fd41e742b70b66d2ba33dcd5aec6ad4390', class: "step-confirmation__actions" }, index.h("button", { key: '4cf91fa8b9b99c6c7c5944e20f76e2ab95695abc', class: "step-confirmation__btn step-confirmation__btn--error", onClick: this.handleRetry }, "Volver a intentar"))))));
    }
};
...
const StepPlans = class {
    ...
    render() {
        ...
        const totalToday = 0;
        return (index.h(index.Host, { key: '3b5f35cdfc65071e8812f2fed7ee34235d79f286' }, index.h("div", { key: '965c768228db89a86b0750530448f181e4c2df2c', class: "step-plans" }, index.h("header", { key: 'd25edd634609f7b234b7fae6eb240d296b015593', class: "step-plans__header" }, index.h("h1", { key: 'b1a105e2c2bbb544b4daab329c6912087cf62704', class: "step-plans__title" }, "Elige tu plan"), index.h("button", { key: '6ef1b13c36060d6fdb88a9cb58b723d99dc369f5', class: "step-plans__btn-back", onClick: this.onBack }, "Regresar")), this.isLoading && (index.h("div", { key: '15df9d2b0979776f1a4b955fc24c6ea0d104dc62', class: "step-plans__loading" }, index.h("div", { key: 'da32e48865d242ac96eb417c9ca73c62c8d553fc', class: "step-plans__spinner" }), index.h("p", { key: '65718e3a2daf46185c69beb8904daf5738fbd271' }, "Cargando planes..."))), this.error && (index.h("div", { key: 'caaeda8da6c56994f58bb9ffe6330ea90ba8dd98', class: "step-plans__error" }, index.h("p", { key: '53dc7b6ebef2312749c01822d0a6fbfe800b0674' }, this.error), index.h("button", { key: '1aed81ca60266a511e186b474a373e5ba8ab551b', onClick: () => this.loadPlans() }, "Reintentar"))), !this.isLoading && !this.error && this.plans.length > 0 && (index.h("div", { key: 'aa59736d6519793c9d996640e983f2d506faf44c', class: "step-plans__carousel-container" }, index.h("ui-carousel", { key: '44f6ce2018f3291c2eefedb55dcb0c69d1700214', totalItems: this.plans.length, gap: 24, showNavigation: false, showPagination: true, breakpoints: [
                { minWidth: 0, slidesPerView: 1 },
                { minWidth: 500, slidesPerView: 2 },
                { minWidth: 800, slidesPerView: 3 },
                { minWidth: 1100, slidesPerView: 4 },
            ] }, this.plans.map((plan) => this.renderPlanCard(plan))))), !this.isLoading && !this.error && this.plans.length === 0 && (index.h("div", { key: 'f2307ae3051846e8856bc79357c1e0484c932230', class: "step-plans__empty" }, index.h("p", { key: '5aac2fe50868431fadc98608ffaaaee27e8a949f' }, "No hay planes disponibles para tu \u00E1rea."))), index.h("footer", { key: '946020db3fcb9988b69c917e47eafb3d4e0c3580', class: "step-plans__footer" }, index.h("div", { key: '38d5db323807e7dee0e81802f2a74b3ece20f22a', class: "step-plans__footer-left" }, index.h("div", { key: '55a16f53a716352a46a05d5978ae1fcc922aeaa8', class: "step-plans__footer-info" }, index.h("div", { key: 'dfce819c5772d8a823242afe30d58f0f7c2d2638', class: "step-plans__footer-item" }, index.h("span", { key: '6906f80d9838041847a6c9243522ff2da5ae0f3e', class: "step-plans__footer-label" }, "Pago mensual"), index.h("span", { key: 'ad72c7c7777399ae3bf8fc8511fce1ba0aebce54', class: "step-plans__footer-value" }, formatPrice(monthlyPayment))), index.h("div", { key: 'ac4e5f57aa18cb7cae2687b663be7bd5d2c44b81', class: "step-plans__footer-item step-plans__footer-item--separator" }, index.h("span", { key: 'e6e40cd9ef813aa8400a01f639d93e71c77e3454', class: "step-plans__footer-label" }, "Paga hoy"), index.h("span", { key: '71af6c8f8b90dd23f539188c4a41977c4fb3c423', class: "step-plans__footer-value step-plans__footer-value--highlight" }, formatPrice(totalToday)))), index.h("p", { key: 'ce00ab6c4a85cc7e76b426d685398282a90478ff', class: "step-plans__footer-note" }, "Renta mensual aproximada no incluye cargos estatales, federales, ni otros impuestos.")), index.h("button", { key: 'e1cc610390e28136802f93cc1e2f0a86836fa2f1', class: "step-plans__footer-btn", onClick: this.handleContinue, disabled: !this.selectedPlan || this.isAddingToCart }, this.isAddingToCart ? 'Procesando...' : 'Continuar')))));
    }
};
