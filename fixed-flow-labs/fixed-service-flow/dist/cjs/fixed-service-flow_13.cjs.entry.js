...
const StepContract = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '29cf3d679c2803ea1fb5529f32a39b1a8f186003' }, index.h("div", { key: '994e15bc052c3be582ad3d7579898a7a26581049', class: "step-contract" }, index.h("header", { key: '5bddb4e258c2c1f838893ae8f150ec797c628917', class: "step-contract__header" }, index.h("h1", { key: 'e9127bb729aed221bc75a3e9d20e407c5cd5748b', class: "step-contract__title" }, "Selecciona un tipo de contrato"), index.h("button", { key: '94071b93852ac46d1edf123239a0a5e7939808ef', class: "step-contract__btn-back", onClick: this.onBack }, "Regresar")), index.h("div", { key: '269d9627d831b10e781b6d91d6b287ae84e82eeb', class: "step-contract__tabs" }, index.h("button", { key: '3301c449db74fdffdc7c5dc9f8127c44a6b4ab1a', class: {
                'step-contract__tab': true,
                'step-contract__tab--active': this.activeTab === 1,
            }, onClick: () => this.handleTabChange(1) }, index.h("span", { key: 'f2a2e40945863a78571c9b58b6f80949fbb4d79f', class: "step-contract__tab-title" }, "Con contrato"), index.h("span", { key: 'bae82158d5c45aa2aaf2ea343333b60709d8286e', class: "step-contract__tab-subtitle" }, "12 y 24 meses de contrato")), index.h("button", { key: 'ee4e9bfc3f250456330e43f0043360918e1808b3', class: {
                'step-contract__tab': true,
                'step-contract__tab--active': this.activeTab === 0,
            }, onClick: () => this.handleTabChange(0) }, index.h("span", { key: 'a1238ac61cd15563f582d1d4eaf10244788d1a75', class: "step-contract__tab-title" }, "Sin contrato"), index.h("span", { key: '86c1e3e51c3e487243a2da65446dffababaeeb69', class: "step-contract__tab-subtitle" }, "Plan mensual con pago por adelantado"))), index.h("div", { key: '1ca6835907555e07c7088dfbcb0a8a8354ff436f', class: "step-contract__content" }, this.activeTab === 1 && withContract && (index.h("div", { key: 'f741a4f0224c6b84e32697be48f11808f1a65874', class: "step-contract__options" }, withContract.contract.map((option) => {
        ...
        }))), this.activeTab === 0 && withoutContract && (index.h("div", { key: 'ea88719ac616f6d0495ffeb627a413d27e949813', class: "step-contract__options step-contract__options--single" }, withoutContract.contract.map((option) => {
            const totalCost = this.getTotalInstallationCost(option);
            return (index.h("label", { class: {
                    'step-contract__option': true,
        ...
        })))), index.h("div", { key: '031b0a7d971f934de6078801d809538352d621f8', class: "step-contract__actions" }, index.h("button", { key: 'ebfb477a49e9c19f29201ba2e89dc59c706f4b3a', class: "step-contract__btn-continue", onClick: this.handleContinue, disabled: !this.selectedOption }, "Continuar")))));
    }
};
...
const StepForm = class {
    ...
    // ------------------------------------------
    render() {
        return (index.h(index.Host, { key: '0b2f99bd94e1adbf650f44a55db6525c6899cf46' }, index.h("div", { key: 'bab002c14860341264211f063160759ab37934d0', class: "step-form" }, index.h("header", { key: '3ff52f43ce12b47c99b459924a7c412c4ae31937', class: "step-form__header" }, index.h("h1", { key: '5415a1edaefe1dbcf6c15b37199381ea3780386d', class: "step-form__title" }, "Formulario de solicitud de servicio fijo"), index.h("button", { key: 'a2a97733267d9816f59646e2c49cca3fc1d2a87a', class: "step-form__btn-back", onClick: this.onBack }, "Regresar")), index.h("form", { key: '17f59261ae81fca827a728f72152b1a2e135071c', onSubmit: this.handleSubmit }, index.h("p", { key: '267f119a14581b2201e7a24d3fb0d10295b12206', class: "step-form__instructions" }, "Por favor, ingresa la informaci\u00F3n personal solicitada. Su nombre y apellido deben ser iguales a su identificaci\u00F3n de gobierno."), index.h("div", { key: '324437746373bc40a75c7cc24520ec49bbe2a3fb', class: "step-form__section" }, index.h("div", { key: '510e1e8bca4554f2a8577df839f77bb6433e57b1', class: "step-form__row" }, this.renderInput('Nombre', 'firstName', 'personal', this.formData.personal.firstName, {
        ...
        })), index.h("div", { key: 'b4ad26b6b1f4b8ccfe0149c5fef93e89e6ebebcf', class: "step-form__row" }, this.renderInput('Apellido', 'lastName', 'personal', this.formData.personal.lastName, {
            placeholder: 'Ingrese apellido',
            required: true,
        }), this.renderInput('Segundo apellido', 'secondLastName', 'personal', this.formData.personal.secondLastName, {
            placeholder: 'Ingrese segundo apellido',
            required: true,
        })), index.h("div", { key: '559571d64825f3d68d41ac65f288dc59ee635759', class: "step-form__row" }, index.h("div", { key: '920720d8ea94f7ce5abe8262a03bc50d83db92bb', class: "step-form__field step-form__field--id" }, index.h("label", { key: 'a7b2e8574c96e3c772ba52d997f8054a2d44102a', class: "step-form__label" }, index.h("span", { key: '884b499ce30bfbbf703c204f5d0965bf109caaa2', class: "step-form__required" }, "*"), "Identificaci\u00F3n:"), index.h("div", { key: '720f30ea432fd5ef746007154559d61d66217d55', class: "step-form__id-row" }, index.h("div", { key: '684aa154a379c5e4022989f4cf9b77048f50c87c', class: "step-form__radio-group" }, index.h("label", { key: 'b30a8b648b875b4b1cea14e3ab5b73260e147b6a', class: "step-form__radio" }, index.h("input", { key: '6faee17560e5d8cb0b376a61a4532a6d4ab74afa', type: "radio", name: "idType", checked: this.formData.personal.identificationType === 'license', onChange: () => this.handleRadioChange('identificationType', 'license') }), "Licencia de conducir"), index.h("label", { key: 'dfb0c00309925bdab56701e648e4dd402bf527e4', class: "step-form__radio" }, index.h("input", { key: '7a4fbfdbcf1e25b87dcf0f4c18d5d801556da806', type: "radio", name: "idType", checked: this.formData.personal.identificationType === 'passport', onChange: () => this.handleRadioChange('identificationType', 'passport') }), "Pasaporte")), index.h("input", { key: 'fe262abad7767ca9f677d5c208e026828bbdeb46', type: "text", class: { 'step-form__input': true, 'step-form__input--error': !!(this.touched['identificationNumber'] && this.errors['identificationNumber']) }, value: this.formData.personal.identificationNumber, placeholder: "Ingrese nro de identificaci\u00F3n", onInput: this.handleInput('personal', 'identificationNumber') })), this.touched['identificationNumber'] && this.errors['identificationNumber'] && (index.h("span", { key: 'f6cc1b9a9034fbe3868a25d4ba24071005b4fcb2', class: "step-form__error" }, this.errors['identificationNumber']))), this.renderInput('Fecha de vencimiento', 'identificationExpiration', 'personal', this.formData.personal.identificationExpiration, {
            type: 'date',
            required: true,
        })), index.h("div", { key: '9ac276afc5c1a29c8829819475c9d5018baf1055', class: "step-form__row" }, this.renderInput('Teléfono de contacto 1', 'phone1', 'personal', this.formData.personal.phone1, {
            type: 'tel',
            ...
            type: 'tel',
            placeholder: 'Ingrese nro de teléfono',
        }))), index.h("div", { key: 'ae2a5883df29772e1de14b8ea1db1ebda264712d', class: "step-form__section" }, index.h("div", { key: '81820f7fdae07c99fc9de3127fa88856655beac1', class: "step-form__row" }, this.renderInput('Nombre legal de Empresa (según IRS)', 'businessName', 'business', this.formData.business.businessName, {
            ...
            required: true,
        }))), index.h("div", { key: 'a3d96e10f02fc2e8badaf1e0055dcd5dfb881287', class: "step-form__section" }, index.h("div", { key: '9d72e0baedfd021596fa0bd4f8a730c566742c6d', class: "step-form__row" }, this.renderInput('Dirección', 'address', 'address', this.formData.address.address, {
            placeholder: 'Ingrese dirección',
            required: true,
        }), this.renderInput('Ciudad', 'city', 'address', this.formData.address.city, {
            placeholder: 'Ingrese ciudad',
            required: true,
        })), index.h("div", { key: '996c0aab4c1c57f4014bfdb30e202342243db058', class: "step-form__row" }, this.renderInput('Código postal', 'zipCode', 'address', this.formData.address.zipCode, {
            ...
            required: true,
        }))), index.h("div", { key: '8b7aeacdd37fc6b98797b498628ab9d129f10bd6', class: "step-form__section" }, index.h("div", { key: 'fde1815a479609bf7ae45bc6b780efa2431e8a1e', class: "step-form__field" }, index.h("label", { key: 'faea036119860ca1b8bbaca80986587c7438594a', class: "step-form__label" }, index.h("span", { key: '70c30d45a29a996f153642f778d172d6f5ee0cf0', class: "step-form__required" }, "*"), "Cliente existente de Claro PR:"), index.h("div", { key: 'c096231cc8d69b9b0d2c7ed343977f48cc99b810', class: "step-form__radio-group step-form__radio-group--horizontal" }, index.h("label", { key: 'c06ddf0911aaf06571cb12135d160768236b82b0', class: "step-form__radio" }, index.h("input", { key: '93242f3fcaf0b45d60d3cf593b6c75ad9a0901a9', type: "radio", name: "existingCustomer", checked: this.formData.isExistingCustomer === true, onChange: () => this.handleRadioChange('isExistingCustomer', true) }), "S\u00ED"), index.h("label", { key: '4739e30de1341859773c3f51b47172f49f7597a1', class: "step-form__radio" }, index.h("input", { key: '9dfd6b22495955d9fb4a8b3593df08768cf73b81', type: "radio", name: "existingCustomer", checked: this.formData.isExistingCustomer === false, onChange: () => this.handleRadioChange('isExistingCustomer', false) }), "No")))), index.h("div", { key: '2656e64fb81fb912b4176749118b8dc5fcddcae1', class: "step-form__actions" }, index.h("button", { key: 'e6156b9570363d80d6e9c6101fe063af41962b8f', type: "submit", class: "step-form__btn-submit", disabled: !this.isFormValid() }, "Continuar"))))));
    }
};
...
const StepLocation = class {
    ...
    // ------------------------------------------
    render() {
        return (index.h(index.Host, { key: '2c8f6a961a85b824e9a85de70ead29a534d4a897' }, index.h("div", { key: 'ac1ec34f9bfdb2a7ab540d2cae3e4b67160b4bb3', class: "step-location" }, this.isValidating && (index.h("div", { key: '44197f1334c1616bf16ebea6aaa4ee62d2df829e', class: "step-location__validating-overlay" }, index.h("div", { key: 'bedfaea659d06328993affdebef2ca37ace38be4', class: "step-location__validating-content" }, index.h("div", { key: 'a25b48d4a9f0794b4e85454265fe1bc6f8508964', class: "step-location__validating-spinner" }), index.h("p", { key: '1a709e4f309c48a56768884881f38d1288d890ca', class: "step-location__validating-text" }, "Validando cobertura...")))), index.h("header", { key: '2a947717ce26017638f68116480513fecf2c5951', class: "step-location__header" }, index.h("h1", { key: '8a5140fae64e91dfb144fe1404743c45816692c7', class: "step-location__title" }, index.h("span", { key: '8c16e083469cdef3723c9e6c78898da2dfaba1a9', class: "step-location__title--highlight" }, "Servicio fijo empresarial"), ' ', "en tu \u00E1rea")), index.h("div", { key: '472964ddd2d2c172f0548fb063304816f42677e6', class: "step-location__map-container" }, index.h("div", { key: '111c1efc7a8a95135b66af71625cbae8bb564e3d', class: "step-location__controls" }, index.h("div", { key: 'f18da275ca833e889c2d91f9cd28f8823d67a746', class: "step-location__input-group" }, index.h("span", { key: '8cd1fb816216a1879b9d9b06835378fac83617ad', class: "step-location__input-icon" }, index.h("svg", { key: '38e3f02c3d1d29c00725f528f9301fcfc990b5c5', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: 'a82af2add5969cd72bf4b3760ce84c2e6f50ae37', d: "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" }), index.h("circle", { key: '9c80df77d6d577d00f0b24a0e43916c5e653e378', cx: "12", cy: "10", r: "3" }))), index.h("input", { key: 'a446b9596a4c3ae4e9f29d88ce9a4bea1b2529c0', type: "text", class: "step-location__input", placeholder: "Ingrese su direcci\u00F3n", value: this.address, onInput: this.handleAddressChange, onKeyPress: this.handleKeyPress, ref: (el) => this.addressInput = el }), index.h("button", { key: 'df44398539d6a09f1397c0e01131afa022fb3451', class: {
                'step-location__btn-validate': true,
                'step-location__btn-validate--loading': this.isValidating,
            }, onClick: this.handleValidate, disabled: this.isValidating || (!this.address.trim() && !this.currentCoordinates) }, this.isValidating ? (index.h("span", { class: "step-location__btn-validate-content" }, index.h("span", { class: "step-location__btn-spinner" }), "Validando...")) : ('Validar'))), index.h("button", { key: '9be446cda265a74c4be684f77096d769df4e3dcd', class: "step-location__btn-location", onClick: this.handleUseCurrentLocation, disabled: this.isGettingLocation || this.isLoadingMap }, index.h("svg", { key: 'd26386c0e5968088b4ce26ee43e6e344edecc159', class: "step-location__btn-location-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("circle", { key: '305ed4421540682debf2166c69a51fd2204139c9', cx: "12", cy: "12", r: "10" }), index.h("circle", { key: '2098fb87a1c5a7ebd09fff005d281dd368b07415', cx: "12", cy: "12", r: "3" }), index.h("line", { key: '6e705969a5e5cf5275d757bf459e9fd2647514ac', x1: "12", y1: "2", x2: "12", y2: "6" }), index.h("line", { key: '0f864276a49d685158eeb462c9068e7aabd69ab3', x1: "12", y1: "18", x2: "12", y2: "22" }), index.h("line", { key: 'd65b42ba47f577d24130316a0b3014e69187fd7b', x1: "2", y1: "12", x2: "6", y2: "12" }), index.h("line", { key: 'dcd3fad6259de3c80eddc8e32ef30dbcff16a615', x1: "18", y1: "12", x2: "22", y2: "12" })), this.isGettingLocation ? 'Obteniendo ubicación...' : 'Utilizar Ubicación Actual')), index.h("div", { key: '95c0fa349a5b7119cae4c0bca80ad966b4bf9c82', class: "step-location__map" }, this.isLoadingMap && !this.mapError && (index.h("div", { key: 'f8821e1c39018185236c98552adc592d49b17365', class: "step-location__map-loading" }, index.h("div", { key: '61d546024598f25914d61d24c4e639e9ff844e16', class: "step-location__spinner" }), index.h("p", { key: '1e9e8b9f9383cc88deb506d4e714f98600c9b314' }, "Cargando mapa..."))), this.mapError && (index.h("div", { key: '933fe3aedd72d139717fab3978df9a4f777d5203', class: "step-location__map-error" }, index.h("p", { key: '863824c972c6ff52c31b9b6c49ac8c7aaf7a893f' }, this.mapError), !this.googleMapsKey && (index.h("small", { key: 'c811bd149f780af33606609edcc99fc7c91341a6' }, "Configura la prop google-maps-key en el componente")))), index.h("div", { key: '9728b428e75641db9d16b9c450b55edd92b74c6e', class: "step-location__map-canvas", ref: (el) => this.mapContainer = el, style: { display: this.mapError ? 'none' : 'block' } }))), this.showErrorModal && (index.h("div", { key: '39957723559961bfdb693886c16e2e2610d7d1d3', class: "step-location__modal-backdrop" }, index.h("div", { key: '8860113883786c78b4d45e9006fca9bb8499e47f', class: "step-location__modal step-location__modal--error" }, index.h("button", { key: 'cbf18a9ea4117b97a3e50b26a95f9b0727b272a7', class: "step-location__modal-close", onClick: () => this.showErrorModal = false }, "\u00D7"), index.h("div", { key: 'a1cf84a852d23fe278fc1e114311dafac42fb915', class: "step-location__modal-error-bar" }, "Error"), index.h("p", { key: '8cf60d6e9cc5bec9900314838bf660a12927461f', class: "step-location__modal-message" }, this.errorMessage), index.h("button", { key: '1f8588f361058ae98f36d048babc8b16f82bfa5d', class: "step-location__modal-btn", onClick: () => this.showErrorModal = false }, "Cerrar")))))));
    }
};
...
const StepOrderSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a90ce12970a97524223087434a6b77d85ce634c8' }, index.h("div", { key: 'b727124f7f3252d24575970bf911b1c9e637effe', class: "step-order-summary" }, index.h("header", { key: '602f59b8270ceb018e0a400c6986a65a88865e4a', class: "header" }, index.h("button", { key: '1c83f3ba699283a86334c3ed149539c13807ded4', class: "btn-back", onClick: this.onBack }, index.h("svg", { key: '9bf02da90358f3e3d68cc01225ab400602a2eb1e', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: 'b0dcba4a227a811ac8e69b3e90d467b25a9ebc82', d: "M19 12H5M12 19l-7-7 7-7" })), index.h("span", { key: '438a01d513f5c8415083ec432f61b8b8d2e8a743' }, "Regresar")), index.h("div", { key: '04355f7b5b9d42dde8e7f19d2c5a5ea108d3e009', class: "header__title-group" }, index.h("h1", { key: 'f8ec57bf3420be3e30064dc4be1e50a7c7360b91', class: "title" }, "Resumen de tu orden"), hasItems && (index.h("span", { key: '29872cb74bbc89d6846de91ebdb118d8d0a061ce', class: "item-count" }, itemCount, " ", itemCount === 1 ? 'artículo' : 'artículos')))), this.isLoading && (index.h("div", { key: '40566bb773821ee0d3e3682ac9029de8e05c37ad', class: "state-container" }, index.h("div", { key: '975992d517381260b50022f05d4075ee20677bff', class: "spinner" }), index.h("p", { key: '84e7dbb0f25a1772554e9d4312bef5112ebe110f' }, "Cargando tu carrito..."))), this.error && !this.isLoading && (index.h("div", { key: '79e8bc44213cbca07a6faae8b3e7260e9018775e', class: "state-container state-container--error" }, index.h("svg", { key: '6c8cc2fc074098a61691b467a45000fae3ab1993', class: "state-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.5" }, index.h("circle", { key: '2284e1c63dc9ccb41899e5d4989c229f95d87575', cx: "12", cy: "12", r: "10" }), index.h("line", { key: '90ecdc71a197f7fd479f2c6993fbf5ff5b725472', x1: "12", y1: "8", x2: "12", y2: "12" }), index.h("line", { key: 'efb1f329a57bc1ee273de85b2648e9e8f0457a21', x1: "12", y1: "16", x2: "12.01", y2: "16" })), index.h("p", { key: '1b4cb065642cac4b33730c900536f81a4ffd0e81' }, this.error), index.h("button", { key: '1959a6acd158821b58fca0dfacc3df3415188df2', class: "btn-retry", onClick: () => this.loadCart() }, "Reintentar"))), !this.isLoading && !this.error && !hasItems && (index.h("div", { key: 'b3cf27058be42bbf42e5d266e095d10412363de1', class: "state-container state-container--empty" }, index.h("svg", { key: 'd68a2a215f90a5544922281f9ecd348f062dd114', class: "state-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.5" }, index.h("circle", { key: '2e77b8310660f7785f5fb1b8a78ec73157396121', cx: "9", cy: "21", r: "1" }), index.h("circle", { key: '2e3cbed8df1799c9610611a8e4adabdaabace295', cx: "20", cy: "21", r: "1" }), index.h("path", { key: '62dff73663a07aa5f867eda99835ae9ead1431e4', d: "M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6" })), index.h("h3", { key: '1b728e21a6ecb2191cba302373d9c38820b4ec3f' }, "Tu carrito est\u00E1 vac\u00EDo"), index.h("p", { key: '4eb1d9492e9bd775e852784efe203a059e521dc8' }, "Agrega productos para continuar con tu compra"), index.h("button", { key: 'f6cbdf76e1db89141c2c711df1d102d38343319f', class: "btn-back-catalog", onClick: this.onBack }, "Ir al cat\u00E1logo"))), !this.isLoading && !this.error && hasItems && (index.h("div", { key: '0d28ec3b275b76e938079602243f18bddc7e99ba', class: "content-layout" }, index.h("div", { key: '71b346dc3a421614691702e2b4155d4ce5fb0817', class: "products-column" }, equipmentItems.map((item, index) => this.renderEquipmentItem(item, index)), standalonePlans.map(plan => this.renderStandalonePlan(plan))), index.h("div", { key: 'ed74aaf2ae1667a9de77c39cb59c862fa50bf74f', class: "summary-column" }, this.renderPromoCode(), this.renderPaymentSummary(), this.renderTermsCheckbox(), index.h("button", { key: '34e19e459da25d0e23506f9ee797c7638bbc7fe6', class: {
                'btn-proceed': true,
                'disabled': !canProceed,
            }, onClick: this.handleProceed, disabled: !canProceed }, index.h("span", { key: 'afb6046899d156a13607a613c460ae6426acd49b' }, "Procesar orden"), index.h("svg", { key: '120807274eb2f466743270e6dd2099f32c140e5d', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: '6a784ebb04afa593f1ab8b5825c1d4421cb1face', d: "M5 12h14M12 5l7 7-7 7" })))))))));
    }
};
...
const StepPayment = class {
    ...
    render() {
        return (index.h(index.Host, { key: '74ccd06f102429de79883621c555d5a056feda61' }, index.h("div", { key: 'd8c04ad1eae1fdc56ee8a600c01cc1c20a946d85', class: "step-payment" }, index.h("div", { key: '47d79f3225761ab9479f10e9cfe387928d1a6c98', class: "header" }, this.screen !== 'processing' && this.screen !== 'success' && (index.h("button", { key: 'adf923db5bef8388e923f5838be48de5994d4b37', class: "btn-back-nav", onClick: () => this.onBack?.() }, index.h("svg", { key: 'f8d58bfbe12680e97751dcd14faf9b2f31c6d2f1', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: 'da87ca559951c74c0c7cb783560de50e146ce5e8', d: "M19 12H5M12 19l-7-7 7-7" })), "Regresar")), index.h("h1", { key: '5575483ecc2e67ce4d267ff1a0a62349c9b2bb46', class: "title" }, "Pago")), index.h("div", { key: '749c3334f95e76b9b0733cb07426c8f0fddd2618', class: "content" }, this.screen === 'loading' && this.renderLoading(), this.screen === 'creating-order' && this.renderCreatingOrder(), this.screen === 'payment' && this.renderPaymentForm(), this.screen === 'processing' && this.renderProcessing(), this.screen === 'success' && this.renderSuccess(), this.screen === 'error' && this.renderError()))));
    }
};
...
const StepPlans = class {
    ...
    render() {
        ...
        const totalToday = 0;
        return (index.h(index.Host, { key: '34415fdf7adb297e19ec23088ff3a18c0dad752d' }, index.h("div", { key: '01a17e6dfdf182be2e91948dd41cc7e8cdebdbed', class: "step-plans" }, index.h("header", { key: '1b2878eced9e68c6e4bdfe41b62f23d18af32ed6', class: "step-plans__header" }, index.h("h1", { key: '43fcc4ec973e63948086d8df50bc0e4375d942d0', class: "step-plans__title" }, "Elige tu plan"), index.h("button", { key: 'cdf623d6c3fa87308e953a11633ff824c17787d6', class: "step-plans__btn-back", onClick: this.onBack }, "Regresar")), this.isLoading && (index.h("div", { key: '1063f032dace3e9a201c924026e58a0721fa3bff', class: "step-plans__loading" }, index.h("div", { key: '8ec36dd95782b585185d6aab76a0aea0a3d395b4', class: "step-plans__spinner" }), index.h("p", { key: 'b69b09cd82b4b1553b2f53e7b1e4dcfdb0425dab' }, "Cargando planes..."))), this.error && (index.h("div", { key: '5c9f07f02dd42c73db057def4696fc5e7094f892', class: "step-plans__error" }, index.h("p", { key: '297ce470626c998458513731f8e7f886e7b4c07b' }, this.error), index.h("button", { key: '8eeb4f9e22d9cccde344af09444c3e60c81161d8', onClick: () => this.loadPlans() }, "Reintentar"))), !this.isLoading && !this.error && this.plans.length > 0 && (index.h("div", { key: 'eb7511e871ba573950643455f98d98537383018a', class: "step-plans__carousel-container" }, index.h("ui-carousel", { key: 'd0125b09b6926ac69eda3bbb2891b4aee5634bc2', totalItems: this.plans.length, gap: 24, showNavigation: true, showPagination: true, breakpoints: [
                { minWidth: 0, slidesPerView: 1 },
                { minWidth: 500, slidesPerView: 2 },
                { minWidth: 800, slidesPerView: 3 },
                { minWidth: 1100, slidesPerView: 4 },
            ] }, this.plans.map((plan) => this.renderPlanCard(plan))))), !this.isLoading && !this.error && this.plans.length === 0 && (index.h("div", { key: '8964acaed4e35d38baed0e8e7382221278086493', class: "step-plans__empty" }, index.h("p", { key: 'efaadbf685e9dfb551848bc6ddcd8110fb451740' }, "No hay planes disponibles para tu \u00E1rea."))), index.h("footer", { key: 'f9148a21e40798c573876ca0a1eb4277d837bc53', class: "step-plans__footer" }, index.h("div", { key: 'df04a8b4b6e39c1e960fc972d05961c62a7391e4', class: "step-plans__footer-left" }, index.h("div", { key: 'e83bdfd77bd8c242d903d29009962c2fd9db2cb7', class: "step-plans__footer-info" }, index.h("div", { key: 'd7d9dc8fab38bba5b3012157df8cb2382744e6bf', class: "step-plans__footer-item" }, index.h("span", { key: '6a254189a1ff389fe15110480bf7d0eae6745a99', class: "step-plans__footer-label" }, "Pago mensual"), index.h("span", { key: '625152a0ad5524c43e8e4822de708d3f78a2261b', class: "step-plans__footer-value" }, formatPrice(monthlyPayment))), index.h("div", { key: '4581b080ffffb7a263b5c9c09b35c71d8f210030', class: "step-plans__footer-item step-plans__footer-item--separator" }, index.h("span", { key: '66081e71fd0eb8682645a6df58010b3ebd194c53', class: "step-plans__footer-label" }, "Paga hoy"), index.h("span", { key: '471b0051747f3e1955441684c3e4cd6b14ddf175', class: "step-plans__footer-value step-plans__footer-value--highlight" }, formatPrice(totalToday)))), index.h("p", { key: 'f33f49cd46ae1a496212c1ea03454d84d3d0e82e', class: "step-plans__footer-note" }, "Renta mensual aproximada no incluye cargos estatales, federales, ni otros impuestos.")), index.h("button", { key: '1d165145af48d1646d397e837171ca6196d3344e', class: "step-plans__footer-btn", onClick: this.handleContinue, disabled: !this.selectedPlan || this.isAddingToCart }, this.isAddingToCart ? 'Procesando...' : 'Continuar')))));
    }
};
...
const StepProductDetail = class {
    ...
    // ------------------------------------------
    render() {
        return (index.h(index.Host, { key: 'af187d60d6c4cee216e9993c8a02b86c903bd1ea' }, index.h("div", { key: '3a619111d42da7044010e8243f3844c69d80227f', class: "step-product-detail" }, this.renderUnavailableAlert(), this.isLoading && (index.h("div", { key: '5a1bdf8f07f4320e8eda25ea92dedde11d382c66', class: "loading-container" }, index.h("div", { key: '435f31c32e0dae1726ce5d18ff4c7a4a9781efb3', class: "spinner" }), index.h("p", { key: '3719de9dae95c3999f910a1e2755eaed815f9e57' }, "Cargando producto..."))), this.error && !this.isLoading && (index.h("div", { key: 'f6eb3ebc3cb46822ec9f26306e973c2091368457', class: "error-container" }, index.h("p", { key: 'bb77b8c765c79f51a39e5fb553344150b9e820af' }, this.error), index.h("button", { key: '85574f4cd2f925b3eceee56860d09f74d287ebf6', class: "btn-retry", onClick: () => this.loadProductDetail() }, "Reintentar"), index.h("button", { key: '3b811a94a1876a48be25f95857f1723fecaad538', class: "btn-back", onClick: this.onBack }, "Volver al cat\u00E1logo"))), !this.isLoading && !this.error && this.product && (index.h("div", { key: 'a909b2e7baa56e0900956c624fd3108e6924559f', class: "product-container" }, this.renderBreadcrumb(), index.h("div", { key: 'dbd2e612fa6c37b276e2f13d8b52b6f92bd2f03f', class: "product-grid" }, index.h("div", { key: '6a0d55b1bdd3645b588095abc114532965ac8a3e', class: "product-image-section" }, index.h("ui-image-carousel", { key: 'b956a928f422f82da0fdbfbff1ca3e92425a9681', images: this.productImages, loop: true, showNavigation: this.productImages.length > 1, showIndicators: this.productImages.length > 1, autoplayInterval: 0 })), index.h("div", { key: '78cfddd2a432b8772b827e1bbf2117672e00339a', class: "product-details-section" }, this.product.brandName && (index.h("span", { key: '53cc708e01bf36693c650dbd09fa826e889c3a06', class: "brand-name" }, this.product.brandName)), index.h("h1", { key: 'b311030defc58424fca609da87452288c9691f4b', class: "product-name" }, this.product.productName), this.product.shortDescription && (index.h("p", { key: '8a3084855d07a17cb1b54aec9f74459334b34a4e', class: "product-description" }, productService.cleanDescription(this.product.shortDescription))), this.renderAvailabilityStatus(), this.renderColorSelector(), this.renderStorageSelector(), this.renderInstallmentSelector(), this.renderQuantitySelector(), this.renderPriceSection(), index.h("button", { key: '8d8fa0387b3e71394e59563c1b5305fbd3c439a8', class: {
                'btn-add-to-cart': true,
                'loading': this.isAddingToCart,
                'disabled': !this.isAvailable,
            }, onClick: this.handleAddToCart, disabled: this.isAddingToCart || !this.isAvailable }, this.isAddingToCart ? (index.h("span", { class: "loading-text" }, index.h("span", { class: "spinner-small" }), "Agregando...")) : !this.isAvailable ? ('No disponible') : ('Continuar')), index.h("button", { key: '961aabd7b04c48e9dc80a6e0b30838bcbec77a45', class: "btn-back-link", onClick: this.onBack }, "\u2190 Volver al cat\u00E1logo"))), this.product.features && this.product.features.length > 0 && (index.h("div", { key: '3cdecc1e0edb59a8ce2a2e9b5f19f2e2c20deaf8', class: "features-section" }, index.h("h3", { key: '718e3635682061f79462614889b7b5cb78ed12bd', class: "features-title" }, "Caracter\u00EDsticas"), index.h("ul", { key: 'e0ecd30e6f5f208d25b7c0f3e49986af672db36c', class: "features-list" }, this.product.features.map(feature => (index.h("li", { class: "feature-item" }, feature)))))), this.product.specifications && this.product.specifications.length > 0 && (index.h("div", { key: '648bf2a0297e7a410d91faabe7dc80e135e684bc', class: "specs-section" }, index.h("h3", { key: '12e80ac827eefb9d03ab61c7b2ec7541532dc083', class: "specs-title" }, "Especificaciones"), index.h("div", { key: '216b9c886b144c65b51547b7a7176222e59fc746', class: "specs-grid" }, this.product.specifications.map((spec) => (index.h("div", { class: "spec-item" }, index.h("span", { class: "spec-label" }, spec.name), index.h("span", { class: "spec-value" }, spec.value))))))))))));
    }
};
...
const StepShipping = class {
    ...
    // ------------------------------------------
    render() {
        return (index.h(index.Host, { key: 'c07553bdbaa3372ca94591fb13dd23ca919fd7cd' }, index.h("div", { key: '4ed5a61e3b9453c946c1ee251c7af433632b1a47', class: "step-shipping" }, index.h("p", { key: '56af6226a93d1b721250595712dc9ae388fe6352', class: "info-message" }, "Por favor, ingresa la informaci\u00F3n personal solicitada. Su nombre y apellido deben ser iguales a su identificaci\u00F3n de gobierno."), this.error && (index.h("div", { key: 'ade2b1dde278061611862e1935b593d74aa18a08', class: "error-alert" }, index.h("svg", { key: '36b884150ff4815eaae6f5b8e8b8d9cde3febcbe', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("circle", { key: '2c90b3776ae3c35643ee0384436e174f198fa84a', cx: "12", cy: "12", r: "10" }), index.h("line", { key: 'a13513e527287809096b473428adc9eb620306a1', x1: "12", y1: "8", x2: "12", y2: "12" }), index.h("line", { key: 'f1ead6eed9d8e258952321364ee504f3ea8a90b6', x1: "12", y1: "16", x2: "12.01", y2: "16" })), index.h("span", { key: 'edc327fe90f09aea6b449ea1d85e4212921826e6' }, this.error))), index.h("div", { key: '8ca4e304db4fe381fcb3908f3cde5fb4b74141ac', class: "form-container" }, index.h("div", { key: '76cb518d3b890f3a122bf78a9d90e46781bf41b7', class: "form-row" }, index.h("div", { key: '7ae1d427963f6387bda0696f5eab053fe40722d5', class: "form-group" }, index.h("label", { key: 'd6a23ccea5367a19035116b16c7bda1e9de09fe5', class: "form-label" }, index.h("span", { key: '99de19d5c3dde6c267a513c55d582dd0f7bf5410', class: "required" }, "*"), "Nombre:"), index.h("input", { key: 'ac5dfa6dff61b5e4b3e8abd308b94d2a0fd46144', type: "text", class: { 'form-input': true, error: this.touched.name && !!this.formErrors.name }, value: this.name, onInput: this.handleInputChange('name'), placeholder: "Ingresar nombre" }), this.touched.name && this.formErrors.name && index.h("span", { key: 'f7a28376fc546336a36f5d12d80c094dd60d9e2c', class: "error-message" }, this.formErrors.name)), index.h("div", { key: '8deff41d097263f18f578d84c6b40b1c69982bf4', class: "form-group" }, index.h("label", { key: '41400f13d2bdaa85480b155d07e193eb980001a2', class: "form-label" }, "Segundo nombre:"), index.h("input", { key: '67573cc53af5d658c7b705c8f2ea47f387e9ea83', type: "text", class: "form-input", value: this.secondName, onInput: this.handleInputChange('secondName'), placeholder: "Ingresar segundo nombre (Opcional)" }))), index.h("div", { key: '7edcd4d93e14526ba432d9b4d21846b04f140596', class: "form-row" }, index.h("div", { key: '16520203d44a9f23a04bd93fd1445dedd8e24978', class: "form-group" }, index.h("label", { key: '3dfae7e516e9798cdb460c580fc7442f46fdfc75', class: "form-label" }, index.h("span", { key: 'da03d5edba574af10137aa40fdd40214e7426ec2', class: "required" }, "*"), "Apellido:"), index.h("input", { key: '68fbc627ed84ab9695b135ade5ab0335009d1bf7', type: "text", class: { 'form-input': true, error: this.touched.lastname && !!this.formErrors.lastname }, value: this.lastname, onInput: this.handleInputChange('lastname'), placeholder: "Ingresar apellido" }), this.touched.lastname && this.formErrors.lastname && index.h("span", { key: 'c63dda9d8efb56c73b0fb294c8882363b45453e3', class: "error-message" }, this.formErrors.lastname)), index.h("div", { key: '20b2308f610fe8f7ffac7c83b467fbf9830bd29c', class: "form-group" }, index.h("label", { key: '32c03703d5089dfbaea81bc13b10f99f30cb505c', class: "form-label" }, index.h("span", { key: '5b26734a7289e0f7bdbd7f12c0a58f2454c6b90a', class: "required" }, "*"), "Segundo apellido:"), index.h("input", { key: '16118423cb334b85379553359d25e44324cbf02d', type: "text", class: { 'form-input': true, error: this.touched.secondLastname && !!this.formErrors.secondLastname }, value: this.secondLastname, onInput: this.handleInputChange('secondLastname'), placeholder: "Ingresar segundo apellido" }), this.touched.secondLastname && this.formErrors.secondLastname && index.h("span", { key: 'aa062fa68bc1b44be0ed56e8450dc09c7ccb940c', class: "error-message" }, this.formErrors.secondLastname))), index.h("div", { key: 'f32bda48060872b868097b663299e218f8db2344', class: "form-row" }, index.h("div", { key: '91e11d90e279c45d57716ad7e57a8ff101f7f5eb', class: "form-group" }, index.h("label", { key: '90ce229b347974b7d5f5e7f834b78c899fe2d3f2', class: "form-label" }, index.h("span", { key: '3ab365d6756c952d10f70a3e31d4a692b042c32a', class: "required" }, "*"), "Identificaci\u00F3n:"), index.h("div", { key: 'b2bcd6c4a185f30664e9a46c5c4068d2a0bf601a', class: "id-field" }, index.h("div", { key: '1851ff3305e49e344208e49e99a7276f7c779b91', class: "radio-group" }, index.h("label", { key: '5a7954738f7ea0f896e4a38afd431f1beb14b176', class: "radio-label" }, index.h("input", { key: 'ef932dd61bcc37c75519c3d1e0505bfa1fed4f38', type: "radio", name: "idType", checked: this.idType === 'license', onChange: this.handleRadioChange('idType', 'license') }), index.h("span", { key: '3a7b8f96a9b321d135d54f8e35a108f22c3d6c55', class: "radio-custom" }), index.h("span", { key: 'd890af48f323ab67b6b254a48a92f9b099a1d930', class: "radio-text" }, "Licencia de conducir")), index.h("label", { key: '01670f605ec76a8386116b88048db54973be8d47', class: "radio-label" }, index.h("input", { key: '573798d590a46ee6c83178a71fdbe68c4baac8cf', type: "radio", name: "idType", checked: this.idType === 'passport', onChange: this.handleRadioChange('idType', 'passport') }), index.h("span", { key: 'bcb4e2dc3fdb8bacfe86f04a508c10a42ff9903d', class: "radio-custom" }), index.h("span", { key: 'aee5b52e256597d9414f08ad49977be65ac07d3c', class: "radio-text" }, "Pasaporte"))), index.h("input", { key: '1c388b898cfa13659b04abd6892faee39b0df6d1', type: "text", class: { 'form-input': true, 'id-input': true, error: this.touched.idNumber && !!this.formErrors.idNumber }, value: this.idNumber, onInput: this.handleInputChange('idNumber'), placeholder: "Ingresar nro de identificaci\u00F3n" })), this.touched.idType && this.formErrors.idType && index.h("span", { key: 'b2427fffb3a111384d5c946b6f6e2aeec279129f', class: "error-message" }, this.formErrors.idType), this.touched.idNumber && this.formErrors.idNumber && index.h("span", { key: '05d4b92beacd9b41c9f9de3b047c92633a9d8b3a', class: "error-message" }, this.formErrors.idNumber)), index.h("div", { key: '3821bcea062c63dcddf5626071d3690238192c6f', class: "form-group" }, index.h("label", { key: '52be2efd130820f13f057229923732e31d7050b7', class: "form-label" }, index.h("span", { key: '28e1d4c8c838235d3ab7b58feefc339570106081', class: "required" }, "*"), "Fecha de vencimiento:"), index.h("div", { key: '103969c96a32758608896967caff011b148fdf5f', class: "date-input-wrapper" }, index.h("input", { key: 'bf9e5b53ee5cfb8df18ff8dbd9b60572f9b764bb', type: "date", class: { 'form-input': true, error: this.touched.expirationDate && !!this.formErrors.expirationDate }, value: this.expirationDate, onInput: this.handleInputChange('expirationDate'), placeholder: "Seleccionar" })), this.touched.expirationDate && this.formErrors.expirationDate && index.h("span", { key: '311fb163a8c986be979d998e17b3870b512901e9', class: "error-message" }, this.formErrors.expirationDate))), index.h("div", { key: '111588d4c1726e20a2b9783b4d08d52e97147ec2', class: "form-row" }, index.h("div", { key: '986224ced53c65a7144b1da6c0c3be98ca295156', class: "form-group" }, index.h("label", { key: '2d9fd90d956b0c5e2f0bf2395bbbd423c6a4aac7', class: "form-label" }, index.h("span", { key: 'd840a52b6d6cdd7e3133672b2e692e2cbdc7cccb', class: "required" }, "*"), "Tel\u00E9fono de contacto 1:"), index.h("input", { key: '693860bdf028bef79ea5c09c03466a0f3b47159f', type: "tel", class: { 'form-input': true, error: this.touched.phone && !!this.formErrors.phone }, value: this.phone, onInput: this.handleInputChange('phone'), placeholder: "Ingresar nro de tel\u00E9fono" }), this.touched.phone && this.formErrors.phone && index.h("span", { key: 'ff7b3ea2c2ca470c122e923f9b91c8c6e4c0fec5', class: "error-message" }, this.formErrors.phone)), index.h("div", { key: '2155e49b260846cfb8327b8461f2718b7b49674a', class: "form-group" }, index.h("label", { key: 'bc1854ca36aa98dc5292eafea366350b0ecdc80f', class: "form-label" }, "Tel\u00E9fono de contacto 2:"), index.h("input", { key: 'ba461ffe0cf3a2048f44ff2428f0537361fc098c', type: "tel", class: "form-input", value: this.phone2, onInput: this.handleInputChange('phone2'), placeholder: "Ingresar nro de tel\u00E9fono" }))), index.h("div", { key: '2e2f49470951085e9bf8c4ed38e8460dae7b9156', class: "form-row" }, index.h("div", { key: 'f60814966ea372a28cbabbbbc4b41ba3af10a21e', class: "form-group" }, index.h("label", { key: 'c71e46f2f78573c923a25960789910f370c27ce1', class: "form-label" }, index.h("span", { key: '11bb1896bb6915efc677b3ce754049468c8f7cdf', class: "required" }, "*"), "Nombre del Negocio:"), index.h("input", { key: '969838eae6fc87103469153f0e5f2c5083271179', type: "text", class: { 'form-input': true, error: this.touched.businessName && !!this.formErrors.businessName }, value: this.businessName, onInput: this.handleInputChange('businessName'), placeholder: "Ingresar nombre del negocio" }), this.touched.businessName && this.formErrors.businessName && index.h("span", { key: '9646b721d08f29cde95cf78dbc1001abb934836d', class: "error-message" }, this.formErrors.businessName)), index.h("div", { key: 'd45bd7f5cca0a2ad58df815d756d60cb4b38e7f9', class: "form-group" }, index.h("label", { key: '71734e73b70775a0c7d22b699ff4a5e3056da0b6', class: "form-label" }, index.h("span", { key: 'efe7dee11cf6da58edef0e55fd819bfef1df73e4', class: "required" }, "*"), "Posici\u00F3n en la Empresa:"), index.h("input", { key: '13aacdcbe0fba647b8089bf9501b6876d8c07d62', type: "text", class: { 'form-input': true, error: this.touched.position && !!this.formErrors.position }, value: this.position, onInput: this.handleInputChange('position'), placeholder: "Ingresar posici\u00F3n actual" }), this.touched.position && this.formErrors.position && index.h("span", { key: 'a76d5d2ecc698e2d5c2213825a57d8f97f1a450f', class: "error-message" }, this.formErrors.position))), index.h("div", { key: '6532f090127fa795374ca8de3d5e0d13f2207289', class: "form-row" }, index.h("div", { key: '1c61342e3a30ca3b2c6e11e207a041d4d99ee031', class: "form-group" }, index.h("label", { key: '8a9ad21933e56287f96c2ae34452852eeb578aa4', class: "form-label" }, index.h("span", { key: 'c55ed9cbacc909c8f7381d152407ad090ca8289d', class: "required" }, "*"), "Direcci\u00F3n:"), index.h("input", { key: '7de7c7e9a8e765dedb2ed471dbfc172b98825d03', type: "text", class: { 'form-input': true, error: this.touched.address && !!this.formErrors.address }, value: this.address, onInput: this.handleInputChange('address'), placeholder: "Ingresar direcci\u00F3n" }), this.touched.address && this.formErrors.address && index.h("span", { key: '79b209b7c6af74362fc467965feafd62a0a3120e', class: "error-message" }, this.formErrors.address)), index.h("div", { key: '4dda998d4b27d4917ba9863bae3d07515f1b0f53', class: "form-group" }, index.h("label", { key: '4f8a2929520eeeebd71c908b86e0f95693214a9d', class: "form-label" }, index.h("span", { key: 'bd125c14674af3b003fad1433883380a88117d9b', class: "required" }, "*"), "Ciudad:"), index.h("input", { key: '29fcaf0d0009f9cd02c179f74ec23e0d8f7a6047', type: "text", class: { 'form-input': true, error: this.touched.city && !!this.formErrors.city }, value: this.city, onInput: this.handleInputChange('city'), placeholder: "Ingresar ciudad" }), this.touched.city && this.formErrors.city && index.h("span", { key: '87d40db52764bbd0cadfe3442d831979f3f91a13', class: "error-message" }, this.formErrors.city))), index.h("div", { key: '43cd8a11b5aaccd906dcce39336bf82e5404d41d', class: "form-row" }, index.h("div", { key: '0264f0507d4e424e20ab50334ba4ab7b47b09a21', class: "form-group" }, index.h("label", { key: '9edd52e8be58ce08fbcc2a41131eedb873118ed6', class: "form-label" }, index.h("span", { key: '3cf11c65ee0b5dd7c8292198643d560a07cd0dae', class: "required" }, "*"), "C\u00F3digo postal"), index.h("input", { key: '27d4e2778d959edbf41b929af2b9d42768d7970b', type: "text", class: { 'form-input': true, error: this.touched.zipcode && !!this.formErrors.zipcode }, value: this.zipcode, onInput: this.handleInputChange('zipcode'), placeholder: "Ingresar c\u00F3digo postal", maxLength: 5 }), this.touched.zipcode && this.formErrors.zipcode && index.h("span", { key: '4aa0b6d39a97406dfe46fd9552aba92f01b75575', class: "error-message" }, this.formErrors.zipcode)), index.h("div", { key: 'f8f23653a2702f1907bce04cf300f6c384e25606', class: "form-group" }, index.h("label", { key: '539fcbb8c4272ade2545e6d3e0f192cf3f2807a4', class: "form-label" }, index.h("span", { key: '0d343d4f6c0a8c3dd4ba8b00e2d1af87d732e969', class: "required" }, "*"), "Correo electr\u00F3nico:"), index.h("input", { key: 'cc13283c527c53f54808aed96ada16f3b9daf6a7', type: "email", class: { 'form-input': true, error: this.touched.email && !!this.formErrors.email }, value: this.email, onInput: this.handleInputChange('email'), placeholder: "Ingresar Correo electr\u00F3nico" }), this.touched.email && this.formErrors.email && index.h("span", { key: '1b1bd7846f05f11d894550d0a0fa22d8fc8c6ba4', class: "error-message" }, this.formErrors.email))), index.h("div", { key: '236feb774283965aaf4038e8c34b79c20467b64d', class: "form-group existing-customer" }, index.h("label", { key: 'da698ad0d7fc2c10318c061763f4523546eae390', class: "form-label" }, index.h("span", { key: '7e05e2afc564ae6d9f0685aa959b73e4b08c6ebf', class: "required" }, "*"), "Cliente existente de Claro PR:"), index.h("div", { key: '36d6dc1fa3276487c90c4f7dc0e57dcb2be0ac0d', class: "radio-group horizontal" }, index.h("label", { key: 'b4f5b27abf98cd81c33b8cdbcb1c9b001ed66bbe', class: "radio-label" }, index.h("input", { key: '95b4bd907ce7c6e711fb29a6c9f564d490b53447', type: "radio", name: "existingCustomer", checked: this.existingCustomer === 'yes', onChange: this.handleRadioChange('existingCustomer', 'yes') }), index.h("span", { key: '4658a0a02dad4910abcb1558418ac43005e7cbea', class: "radio-custom" }), index.h("span", { key: '99c0626890d48aff3e5d3c2c64bad27d774b0dcb', class: "radio-text" }, "S\u00ED")), index.h("label", { key: '6ac7653c1263c60adb2e11310a76bb16fff697db', class: "radio-label" }, index.h("input", { key: 'ecc6b2c0c2b293407fea5197aa999dd12527b181', type: "radio", name: "existingCustomer", checked: this.existingCustomer === 'no', onChange: this.handleRadioChange('existingCustomer', 'no') }), index.h("span", { key: '2337987d047019faa419de4db247dcaadd892710', class: "radio-custom" }), index.h("span", { key: '59e68d9372cb5b1a8b3639cef1d6d6d73cee0c52', class: "radio-text" }, "No"))), this.touched.existingCustomer && this.formErrors.existingCustomer && (index.h("span", { key: 'a0bd452e77948bae5aef81715346b910889ea5fa', class: "error-message" }, this.formErrors.existingCustomer))), index.h("div", { key: '276b369032ecf9d25836be9fbe91ac806fc65c1a', class: "btn-container" }, index.h("button", { key: 'f03d5bbe83a5d16741cd63fd77234db38c340197', class: { 'btn-submit': true, loading: this.isLoading }, onClick: this.handleSubmit, disabled: this.isLoading }, this.isLoading ? (index.h("span", { class: "btn-loading" }, index.h("span", { class: "spinner" }), "Procesando...")) : ('Continuar')))))));
    }
};
