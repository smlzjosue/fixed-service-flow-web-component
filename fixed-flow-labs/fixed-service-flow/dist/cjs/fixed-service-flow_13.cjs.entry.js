...
const StepCatalogue = class {
    ...
    render() {
        ...
        const title = this.selectedFilter === catalogueService.FILTER_INTERNET_INALAMBRICO
            ...
            : 'Internet + Telefonía';
        return (index.h(index.Host, { key: '633cab4f89f3e79907cb5db33eb2897e114ecf97' }, index.h("div", { key: '9390e25d97abc32a1ad7c303b1460f310f6f05ab', class: "step-catalogue" }, index.h("div", { key: '02e7d0c13069e26f9a07ea6e0c307f5bb699954c', class: "container-filter" }, index.h("h1", { key: 'ccded62f26e8b1cb8719a5e85965cbb87a793689', class: "filter-title-main" }, title), index.h("div", { key: '2e8b8d5966728504b0c9a35953d2734cfc9d2166', class: "filter-content" }, index.h("div", { key: 'c7b44c9803036ea915e916276935c123e1ae6394', class: "input-filter-wrapper" }, index.h("svg", { key: 'fc68b3c733ac05a3d72f3242281495b1a4d195dd', class: "search-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("circle", { key: '465cf04a8bac926218930455360383f4ce76d4d2', cx: "11", cy: "11", r: "8" }), index.h("path", { key: '94880ba619fba184c09735fb5dee50a2dc9e2638', d: "m21 21-4.35-4.35" })), index.h("input", { key: '96e070ad2f6913c5dac4f32a0331f9c8452c5ca4', type: "text", class: "input-filter", placeholder: "Buscar articulo", value: this.searchText, onInput: this.handleSearchInput, onKeyPress: this.handleKeyPress })), index.h("button", { key: '3ed9a4be367b1daded8e20f9d04876a5cceaddf4', class: "btn-search", onClick: this.handleSearch }, "Buscar"))), index.h("div", { key: '31dedbc72907c038675e86e69610d656dfb1933c', class: "catalogue-content" }, this.renderFilterSidebar(), index.h("div", { key: '5fc3589a28fc81d2fa105d2ab68a8645c3e16d3c', class: "products-section" }, this.isLoading && (index.h("div", { key: '292cb80c0714438e041805d2250be61c4db7a0e1', class: "loading-container" }, index.h("div", { key: 'e58b5e87f3092109d7ebb87f9ad4827d17e9527a', class: "spinner" }), index.h("p", { key: 'd8ea4899e95713de1acb4d5c9e1df3d0da6f00bc' }, "Cargando productos..."))), this.error && !this.isLoading && (index.h("div", { key: 'd12da3b185d76e74f3b195a7bc95115502d50801', class: "error-container" }, index.h("p", { key: 'bd2d3bbdd3a22d41d90760af4103fcd413858551' }, this.error), index.h("button", { key: 'aecf413d4416c536d035453741ccf0b10f07ddc5', onClick: () => this.loadProducts() }, "Reintentar"))), !this.isLoading && !this.error && (index.h("div", { key: 'ab42f43d608c13216bee78a5f6979bb883908434', class: {
                'container-product': true,
                'container-product-filter-off': !this.showFilters,
            } }, this.filteredProducts.map((product) => this.renderProductCard(product)))), !this.isLoading && !this.error && this.filteredProducts.length === 0 && (index.h("div", { key: 'fe07cc32a053431c0f5624669646ed95d52b2014', class: "empty-container" }, index.h("p", { key: '354f47fce91aa5d8e7d09127119fcfcad12c6a49' }, "No hay productos disponibles para esta categor\u00EDa"))))), index.h("div", { key: '9edaae5bf982ec881e74353e952ae4158ce9e87c', class: "back-button-container" }, index.h("button", { key: 'ccb3b1dcafbf7a0f4938e5192874a4c59087a6d1', class: "btn-back", onClick: this.onBack }, "Regresar"))), this.showDetailModal && (index.h("div", { key: '3c3d144571de958f77d47a1d2077e6914f758ec2', class: "modal-overlay", onClick: this.closeDetailModal }, index.h("div", { key: '6e0ea7baa3b102322a025c316276f50468ec1e5f', class: "modal-content", onClick: (e) => e.stopPropagation() }, index.h("button", { key: '3f9017ff359a09a6f56ab2b998b64f12f408712d', class: "modal-close", onClick: this.closeDetailModal }, index.h("svg", { key: '8b5debf990dfba49121bc00557ff8787b98766b0', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("line", { key: '73e21236ccdc9be42e65ada13b224dfeed689247', x1: "18", y1: "6", x2: "6", y2: "18" }), index.h("line", { key: 'e54bf79a62b785719755ee4e0e906e8540dc2001', x1: "6", y1: "6", x2: "18", y2: "18" }))), index.h("div", { key: 'af62534c7dbdbe94508f0f177200e3362828b595', class: "modal-title" }, index.h("div", { key: '2e867881616c387d65681cf3cc0e9d097e64568a', class: "modal-subtitle" }, "Descripci\u00F3n completa"), this.modalTitle), index.h("div", { key: '5361636aec7839c921dc8d48d2bb5432aff0a876', class: "modal-body" }, index.h("p", { key: '51f2c1a26f1ada39a8e3543dd2b0c4006f566773', class: "modal-text" }, this.modalContent)))))));
    }
};
...
const StepConfirmation = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5215f0878f1df6b712acc38537e948ce3425b759' }, index.h("div", { key: '9e12c496833250df2608be2b17d6281df49b4a81', class: "step-confirmation" }, index.h("header", { key: '59751a8125cfa08dbffe6ede377909dee0dc36b9', class: "step-confirmation__header" }, index.h("h1", { key: 'e3dcbfa01d585cb8a927e5f65d3f3c3be7882e5e', class: "step-confirmation__header-title" }, "Confirmaci\u00F3n de Solicitud")), index.h("div", { key: '8c19786bfe36d066a46185738e4d23ca2ffc205b', class: "step-confirmation__content" }, this.status === 'loading' && this.renderLoading(), this.status === 'success' && this.renderSuccess(), this.status === 'error' && this.renderError()), this.status === 'success' && (index.h("div", { key: '82a95ae0d94faf62ce1274059cc34bd0343e299c', class: "step-confirmation__actions" }, index.h("button", { key: '1a3e1d2a74e0ad18f5934ab9a872c1d8975708ed', class: "step-confirmation__btn", onClick: this.handleClose }, "Cerrar"))), this.status === 'error' && (index.h("div", { key: '32cbebb3bbd7de33beb7ab6f956032e77232443d', class: "step-confirmation__actions" }, index.h("button", { key: '1e2a9b4e0919322310e234db3222a023eb46a3c4', class: "step-confirmation__btn step-confirmation__btn--error", onClick: this.handleRetry }, "Volver a intentar"))))));
    }
};
...
const StepContract = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f1905e6b70dc6122709e028226af1a20f4c968f0' }, index.h("div", { key: 'c08690c9d77c82e1b38bde06f53a4cf8fe57959c', class: "step-contract" }, index.h("header", { key: '4a2d90242969243120d78af3f6cf009b8ff9db57', class: "step-contract__header" }, index.h("h1", { key: '47c0a78c53271fd222de19dc91d55baa80f74c0d', class: "step-contract__title" }, "Selecciona un tipo de contrato"), index.h("button", { key: '33159923e314ff5bf6185ac5e0ed818f30af1c10', class: "step-contract__btn-back", onClick: this.onBack }, "Regresar")), index.h("div", { key: '0b1c67f46bfce90276b503d217340b7c196ff12d', class: "step-contract__tabs" }, index.h("button", { key: '646a2264e8069b0000bb891b7f3aaddd64d9bcf8', class: {
                'step-contract__tab': true,
                'step-contract__tab--active': this.activeTab === 1,
            }, onClick: () => this.handleTabChange(1) }, index.h("span", { key: '352c1520f14c686bcc190ccc916ce4d3d30f9616', class: "step-contract__tab-title" }, "Con contrato"), index.h("span", { key: '014665509e201e6d6d90c93a90ffc0d6bd5da668', class: "step-contract__tab-subtitle" }, "12 y 24 meses de contrato")), index.h("button", { key: 'bdabf0e35ef436bd3137301c734f0a17dadf9f3b', class: {
                'step-contract__tab': true,
                'step-contract__tab--active': this.activeTab === 0,
            }, onClick: () => this.handleTabChange(0) }, index.h("span", { key: '8963df3a459b259a9ac841d0ddd428c2f52f63bf', class: "step-contract__tab-title" }, "Sin contrato"), index.h("span", { key: 'f2337aa7d97707a5e46c966d4b7f00243bdfa6b2', class: "step-contract__tab-subtitle" }, "Sin verificaci\u00F3n de cr\u00E9dito", index.h("br", { key: 'f8bf274567bc524d85864f92db61f48f7daed407' }), "1 mes de plan por adelantado"))), index.h("div", { key: '1a08c254123f8312f938139a328ee34650d1fc22', class: "step-contract__content" }, this.activeTab === 1 && withContract && (index.h("div", { key: '9686ff7cf25586051b19c1becc9d2aca89c92263', class: "step-contract__options" }, withContract.contract.map((option) => (index.h("label", { class: {
                ...
                this.selectedOption?.typeId === 1, onChange: () => this.handleSelectOption(1, option) }), index.h("div", { class: "step-contract__option-content" }, index.h("span", { class: "step-contract__option-title" }, formatContractDuration(option.deadlines)), index.h("div", { class: "step-contract__option-details" }, index.h("span", null, "Instalaci\u00F3n: ", option.installation > 0 ? formatPrice(option.installation) : 'Sin Costo'), index.h("span", null, "Activaci\u00F3n: ", option.activation > 0 ? formatPrice(option.activation) : 'Sin Costo'), index.h("span", null, "Modem: ", option.modem > 0 ? formatPrice(option.modem) : 'Sin Costo')))))))), this.activeTab === 0 && withoutContract && (index.h("div", { key: '8a9c1a251df633a2eb37f5055a4efebe925b3c39', class: "step-contract__options" }, withoutContract.contract.map((option) => (index.h("label", { class: {
                'step-contract__option': true,
                'step-contract__option--selected': this.selectedOption?.typeId === 0,
            } }, index.h("input", { type: "radio", name: "contract", checked: this.selectedOption?.typeId === 0, onChange: () => this.handleSelectOption(0, option) }), index.h("div", { class: "step-contract__option-content" }, index.h("span", { class: "step-contract__option-title" }, "Sin contrato"), index.h("div", { class: "step-contract__option-details" }, index.h("span", null, "Activaci\u00F3n: ", option.activation > 0 ? formatPrice(option.activation) : 'Sin Costo'), index.h("span", null, "Modem: ", formatPrice(option.modem)), index.h("span", null, "Instalaci\u00F3n: ", formatPrice(option.installation)))))))))), index.h("div", { key: '56a8e1df201c55a6686afed6678e04420d1f6000', class: "step-contract__actions" }, index.h("button", { key: '856440da906e26ccd05a915e4b3d45cf17f945d3', class: "step-contract__btn-continue", onClick: this.handleContinue, disabled: !this.selectedOption }, "Continuar")))));
    }
};
...
const StepForm = class {
    ...
    renderInput(label, field, section, value, options = {}) {
        ...
        return (index.h("div", { class: "step-form__field" }, index.h("label", { class: "step-form__label" }, label, required && index.h("span", { class: "step-form__required" }, "*")), index.h("input", { type: type, class: { 'step-form__input': true, 'step-form__input--error': !!hasError }, value: displayValue, placeholder: placeholder, disabled: disabled, onInput: this.handleInput(section, field) }), hasError && index.h("span", { class: "step-form__error" }, this.errors[field])));
    }
    // ------------------------------------------
    // RENDER
    // ------------------------------------------
    render() {
        return (index.h(index.Host, { key: 'c481713f5117e41c0e66218f0622861aa0768f79' }, index.h("div", { key: '5a841d19a81206b88033bd3be24655af80df0736', class: "step-form" }, index.h("header", { key: '0f5ae19659d3ca868400a2309c48bb67f60634b6', class: "step-form__header" }, index.h("h1", { key: '5fcd2bd13efe8a7e4323026461fb8181bc123ec5', class: "step-form__title" }, "Formulario de solicitud de servicio fijo"), index.h("button", { key: '3cc16cf0a596ffb7dbe32470f997c59666cd501c', class: "step-form__btn-back", onClick: this.onBack }, "Regresar")), index.h("form", { key: 'ba16ab5360e054f0a59251bd8d983fd06f669291', onSubmit: this.handleSubmit }, index.h("p", { key: '3017b8bceec5c2dfa9faba7cb32bf2443fa60560', class: "step-form__instructions" }, "Por favor, ingresa la informaci\u00F3n personal solicitada. Su nombre y apellido deben ser iguales a su identificaci\u00F3n de gobierno."), index.h("div", { key: '6b15392974cdd563184b014e7a9bf520fc797d9b', class: "step-form__section" }, index.h("div", { key: '1f300e12e8f24a7e6ae101c8e1fa129c8ef39cf9', class: "step-form__row" }, this.renderInput('Nombre', 'firstName', 'personal', this.formData.personal.firstName, {
        ...
        })), index.h("div", { key: '41e11ee93af952e5f56ca5d701ef203124a3a31c', class: "step-form__row" }, this.renderInput('Apellido', 'lastName', 'personal', this.formData.personal.lastName, {
            placeholder: 'Ingrese apellido',
            required: true,
        }), this.renderInput('Segundo apellido', 'secondLastName', 'personal', this.formData.personal.secondLastName, {
            placeholder: 'Ingrese segundo apellido',
            required: true,
        })), index.h("div", { key: '0e48c1ca2e08a196c22bf98f9143803b4b5767c9', class: "step-form__row" }, index.h("div", { key: '1291f02f66593b9e7941534bd7c692d22e18d18f', class: "step-form__field step-form__field--id" }, index.h("label", { key: 'd0c40f3ab735276355394cc6fcca3edc25651dc9', class: "step-form__label" }, "Identificaci\u00F3n", index.h("span", { key: '116025fc57c98d50b4dcd5f788443717263dd1ae', class: "step-form__required" }, "*")), index.h("div", { key: '26410addf965b2a13a4e6861d3e6aa930fb8f307', class: "step-form__id-row" }, index.h("div", { key: '3741dd30d2cdded7699a46147e804b87d3a6f4be', class: "step-form__radio-group" }, index.h("label", { key: '16b7fe472ae0c03762f3c81deb27d0191c6c6dc7', class: "step-form__radio" }, index.h("input", { key: '3e5eddae5e960abc387ab5add8353a4dd265ddb6', type: "radio", name: "idType", checked: this.formData.personal.identificationType === 'license', onChange: () => this.handleRadioChange('identificationType', 'license') }), "Licencia de conducir"), index.h("label", { key: '12d1e3594613178153f90b3b9239a9188254366b', class: "step-form__radio" }, index.h("input", { key: 'e13b28e7686054edeb3068bc1861c911bbfe318f', type: "radio", name: "idType", checked: this.formData.personal.identificationType === 'passport', onChange: () => this.handleRadioChange('identificationType', 'passport') }), "Pasaporte")), index.h("input", { key: '3ed6acf3d4638279f914e5da15fef7cb7767cac0', type: "text", class: { 'step-form__input': true, 'step-form__input--error': !!(this.touched['identificationNumber'] && this.errors['identificationNumber']) }, value: this.formData.personal.identificationNumber, placeholder: "Ingrese nro de identificaci\u00F3n", onInput: this.handleInput('personal', 'identificationNumber') })), this.touched['identificationNumber'] && this.errors['identificationNumber'] && (index.h("span", { key: '75d67c2f616e6d5970a2b1aa362f5304c6c70823', class: "step-form__error" }, this.errors['identificationNumber']))), this.renderInput('Fecha de vencimiento', 'identificationExpiration', 'personal', this.formData.personal.identificationExpiration, {
            type: 'date',
            required: true,
        })), index.h("div", { key: 'f03be9d11723497799ab378c87d1a6bdcd47413c', class: "step-form__row" }, this.renderInput('Teléfono de contacto 1', 'phone1', 'personal', this.formData.personal.phone1, {
            type: 'tel',
            ...
            type: 'tel',
            placeholder: 'Ingrese nro de teléfono',
        }))), index.h("div", { key: '87a9b0398ba9c4224856d200a197226d57255918', class: "step-form__section" }, index.h("div", { key: '9770d7ad710c57d18f263c4b695dbc3fa63be6a4', class: "step-form__row" }, this.renderInput('Nombre del Negocio', 'businessName', 'business', this.formData.business.businessName, {
            ...
            required: true,
        }))), index.h("div", { key: 'fc2fbe5af446bb0a79d740d07ff5b79603067858', class: "step-form__section" }, index.h("div", { key: 'ae3a915ead0593648b439210e3a326afef56b168', class: "step-form__row" }, this.renderInput('Dirección', 'address', 'address', this.formData.address.address, {
            placeholder: 'Ingrese dirección',
            required: true,
        }), this.renderInput('Ciudad', 'city', 'address', this.formData.address.city, {
            placeholder: 'Ingrese ciudad',
            required: true,
        })), index.h("div", { key: 'acc57c7ac68cd4e8438c3ae2b86588b1047e63cc', class: "step-form__row" }, this.renderInput('Código postal', 'zipCode', 'address', this.formData.address.zipCode, {
            ...
            required: true,
        }))), index.h("div", { key: '901019bc2449e39fb8b4a628389f35b6b8d7707d', class: "step-form__section" }, index.h("div", { key: '58f88109a6cd3999dafe39e7af0f04fe4f9465a8', class: "step-form__field" }, index.h("label", { key: '7b8f2e23aeaf997ff117149de0da52cd938c381e', class: "step-form__label" }, "Cliente existente de Claro PR", index.h("span", { key: '066a2fc74bf8697fb142e7d73df4b21ba9a987dc', class: "step-form__required" }, "*")), index.h("div", { key: '563375d345281e8b6779e919712fec0de91bcd95', class: "step-form__radio-group step-form__radio-group--horizontal" }, index.h("label", { key: '5f30d44ac24d69df8897c24ebe5312470a1176bd', class: "step-form__radio" }, index.h("input", { key: '0ddf22b09292105c8774a388dac629379158e631', type: "radio", name: "existingCustomer", checked: this.formData.isExistingCustomer === true, onChange: () => this.handleRadioChange('isExistingCustomer', true) }), "S\u00ED"), index.h("label", { key: 'ee75c13d17cc3332a5638838f03dd7fa7f02062c', class: "step-form__radio" }, index.h("input", { key: '769e0760bcd14b7efef849d150c49025b4bbcfa9', type: "radio", name: "existingCustomer", checked: this.formData.isExistingCustomer === false, onChange: () => this.handleRadioChange('isExistingCustomer', false) }), "No")))), index.h("div", { key: 'b1bf9791c0839db0a3bcab0ed9487d51b36ec9af', class: "step-form__actions" }, index.h("button", { key: '4521a008fca97e087aadd8d7a00a4454ce4aeb04', type: "submit", class: "step-form__btn-submit" }, "Continuar"))))));
    }
};
...
const StepLocation = class {
    ...
    // ------------------------------------------
    render() {
        return (index.h(index.Host, { key: '4437f94dba31f3726dc5b809692a66178ffa6837' }, index.h("div", { key: '1b415cac1c65c3edeab788c316961bbc9fb8c9d0', class: "step-location" }, this.isValidating && (index.h("div", { key: '6023f4b3a277824ca60a0542181925493e611890', class: "step-location__validating-overlay" }, index.h("div", { key: '7df3fc32f8c4a43c7630b6ef4f1bbf6a0f4979fa', class: "step-location__validating-content" }, index.h("div", { key: 'd7904f1815c99e8ae4d38fbc8c4b5de54e268370', class: "step-location__validating-spinner" }), index.h("p", { key: '91a291b13095cd2fbb0ff253c2ff485c6c4e53e4', class: "step-location__validating-text" }, "Validando cobertura...")))), index.h("header", { key: 'c0d3df9929d16e92855bf89969d97990ecfed900', class: "step-location__header" }, index.h("h1", { key: '957fb9b4916bf255b765354000e3910084363a2f', class: "step-location__title" }, index.h("span", { key: '0794aecd47078c706467e8ae7b0f5011da133237', class: "step-location__title--highlight" }, "Servicio fijo empresarial"), ' ', "en tu \u00E1rea")), index.h("div", { key: '6464a3b447edb7b49d2a3415405f31c1eb374e17', class: "step-location__map-container" }, index.h("div", { key: '206a993ad029a57d86a84f948125595171f52bb6', class: "step-location__controls" }, index.h("div", { key: '21e3c7617bc6df7b6ec35f15839a151e6e2bd24f', class: "step-location__input-group" }, index.h("span", { key: 'dfba0e93ace9823d72011030802b335d92eb14bc', class: "step-location__input-icon" }, index.h("svg", { key: '85a2571ba6b9dd8201b3b6ae00a16382c1369640', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: 'e2ed4110193aa7ae16063ff45e0f75e5ab5be752', d: "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" }), index.h("circle", { key: 'a68bed46a5ab7c3ba41a7ba028f489266a98fe62', cx: "12", cy: "10", r: "3" }))), index.h("input", { key: '44f7f009b03f85dbef77e8aca256ab3dc4524df4', type: "text", class: "step-location__input", placeholder: "Ingrese su direcci\u00F3n", value: this.address, onInput: this.handleAddressChange, onKeyPress: this.handleKeyPress, ref: (el) => this.addressInput = el }), index.h("button", { key: 'dc96224cf6479bcce55e08371f98899b8648f6e3', class: {
                'step-location__btn-validate': true,
                'step-location__btn-validate--loading': this.isValidating,
            }, onClick: this.handleValidate, disabled: this.isValidating || (!this.address.trim() && !this.currentCoordinates) }, this.isValidating ? (index.h("span", { class: "step-location__btn-validate-content" }, index.h("span", { class: "step-location__btn-spinner" }), "Validando...")) : ('Validar'))), index.h("button", { key: '8095e3157fdd2de9565436a87d3af0be428496bb', class: "step-location__btn-location", onClick: this.handleUseCurrentLocation, disabled: this.isGettingLocation || this.isLoadingMap }, index.h("svg", { key: '048fb61f55e6e91ecc9b738e514e43e15e87c05d', class: "step-location__btn-location-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("circle", { key: 'f3ae5c0478f4c2fd66428f11140033340c010ee0', cx: "12", cy: "12", r: "10" }), index.h("circle", { key: '611a78c56df944d5f51bd51c649a1870b21add90', cx: "12", cy: "12", r: "3" }), index.h("line", { key: 'b54f19e0dafdf2eb40dfae9a15df109e89a64b06', x1: "12", y1: "2", x2: "12", y2: "6" }), index.h("line", { key: '37024a78191541aff3879f1453a92598c818bc90', x1: "12", y1: "18", x2: "12", y2: "22" }), index.h("line", { key: 'd15f3ec70193772335b4a7311d431f2d7d890c40', x1: "2", y1: "12", x2: "6", y2: "12" }), index.h("line", { key: 'fe8b6191ec2150805cd02148ffe889dd227ca6c1', x1: "18", y1: "12", x2: "22", y2: "12" })), this.isGettingLocation ? 'Obteniendo ubicación...' : 'Utilizar Ubicación Actual')), index.h("div", { key: 'a6f431074f4606e7f72b928f7500a16e1d931588', class: "step-location__map" }, this.isLoadingMap && !this.mapError && (index.h("div", { key: '2fa47417bf593b7b0106aae9fb06b57e38f69d36', class: "step-location__map-loading" }, index.h("div", { key: '2f686dcd318cf61d73fe552ecf9a54485c2de1bc', class: "step-location__spinner" }), index.h("p", { key: '9cb586fc653a2781218f966c4cb031dfe3268674' }, "Cargando mapa..."))), this.mapError && (index.h("div", { key: 'fd8410023faed497a2345412540b5dd088822aba', class: "step-location__map-error" }, index.h("p", { key: 'f1e4f1185e8cfe56fda5ed9d1db9c68c3d61d092' }, this.mapError), !this.googleMapsKey && (index.h("small", { key: '1bd24b7cd0f4a29b7d74ae487e38885e0ec5fb0f' }, "Configura la prop google-maps-key en el componente")))), index.h("div", { key: '742ff1891115c9cc099071d2adeed4daf34413e3', class: "step-location__map-canvas", ref: (el) => this.mapContainer = el, style: { display: this.mapError ? 'none' : 'block' } }))), this.showErrorModal && (index.h("div", { key: '10ebf6fde06bed19e3dcdbed0e855f4e285cb306', class: "step-location__modal-backdrop" }, index.h("div", { key: '23576e8c1f327e521ba8f4ca0aae25bcc295e425', class: "step-location__modal step-location__modal--error" }, index.h("button", { key: '6e3680f37a66739601695d3c1117aed68876cc1c', class: "step-location__modal-close", onClick: () => this.showErrorModal = false }, "\u00D7"), index.h("div", { key: '07f616666d8507474881ae79b19ec77fe12f61d9', class: "step-location__modal-error-bar" }, "Error"), index.h("p", { key: '0ca7463877338b6c2acb878e26dbcb47ca84327c', class: "step-location__modal-message" }, this.errorMessage), index.h("button", { key: 'c69b0713cc76eb0d73fb3eed45601d896513e3a1', class: "step-location__modal-btn", onClick: () => this.showErrorModal = false }, "Cerrar")))))));
    }
};
...
const StepOrderSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b2ec1785f21c9c35b36fa6d31fbdeb11b464e65e' }, index.h("div", { key: 'cb552177b74f1d602fa93bc610a13ce6af52805c', class: "step-order-summary" }, index.h("header", { key: 'b5a697e1f6808e66f3760e9299f84f2801430d78', class: "header" }, index.h("button", { key: 'e84200d29c18faa843ff384f221109d64bbc060c', class: "btn-back", onClick: this.onBack }, index.h("svg", { key: '2e28625d7070d769288d746b61b97a2e17cb7ec0', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: '1968e8385d820f5df38b704fc2abab5a01e96aff', d: "M19 12H5M12 19l-7-7 7-7" })), index.h("span", { key: 'fedeeef4a8b1b5b6927204312fa8625a239aafe1' }, "Regresar")), index.h("div", { key: '2917ed4718750946ff43203dadfd9961cf5b1a4a', class: "header__title-group" }, index.h("h1", { key: '93acee9959cb3b1a7bd946f33652cbaed97443b6', class: "title" }, "Resumen de tu orden"), hasItems && (index.h("span", { key: 'de58f045d7e22dc3502a648ebb6ca656c87e7140', class: "item-count" }, itemCount, " ", itemCount === 1 ? 'artículo' : 'artículos')))), this.isLoading && (index.h("div", { key: 'b9d96c48dd5107970a60042eff947178972e5934', class: "state-container" }, index.h("div", { key: '1438994b11f2b9c7713d73919fc989fd676eece0', class: "spinner" }), index.h("p", { key: '37d9e18591aa01629b3786a3ebd1d78f2f81e844' }, "Cargando tu carrito..."))), this.error && !this.isLoading && (index.h("div", { key: 'd221c3774f1b8cc8481234e54121204ef7f6adfc', class: "state-container state-container--error" }, index.h("svg", { key: 'bbd743f12e5598ab679be1b627cea45c4c03e005', class: "state-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.5" }, index.h("circle", { key: '51afad1d3b42c205b80682c33f03e177ccf09e5d', cx: "12", cy: "12", r: "10" }), index.h("line", { key: '70d5483837636b118c28a3b6256cf0bd53ea6b88', x1: "12", y1: "8", x2: "12", y2: "12" }), index.h("line", { key: 'c8c297af492a18cc059ef5c52b20afb40c3db396', x1: "12", y1: "16", x2: "12.01", y2: "16" })), index.h("p", { key: '11e2a19b976f00746334045d6dd079cb92d97361' }, this.error), index.h("button", { key: '84d00069547fc6f0e1c772258d857a8a70c0a5e3', class: "btn-retry", onClick: () => this.loadCart() }, "Reintentar"))), !this.isLoading && !this.error && !hasItems && (index.h("div", { key: 'bb41c96c5d54c70e0f1c92523bef00850623a2e5', class: "state-container state-container--empty" }, index.h("svg", { key: '25aa0769197935f67437e699d9144813cb58bbd3', class: "state-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.5" }, index.h("circle", { key: '786409612f5171f0cd305e024b489cf9bbb2b3ec', cx: "9", cy: "21", r: "1" }), index.h("circle", { key: 'be250ebcd4c603e36e0e3cc239442447dccc9261', cx: "20", cy: "21", r: "1" }), index.h("path", { key: '258da867de0fb9195c37c68a7a0ea626560e68a9', d: "M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6" })), index.h("h3", { key: '17d340458d0ed2a1de566a9fe82096c989d61724' }, "Tu carrito est\u00E1 vac\u00EDo"), index.h("p", { key: 'fa0891a2a328e4b6454369c4117028a7f69ef6b5' }, "Agrega productos para continuar con tu compra"), index.h("button", { key: '50e70ea224a3fbb8b7ea69ce724f32de3409652c', class: "btn-back-catalog", onClick: this.onBack }, "Ir al cat\u00E1logo"))), !this.isLoading && !this.error && hasItems && (index.h("div", { key: '32a5153e90bfab74638ff32a0eeea5a13d156245', class: "content-layout" }, index.h("div", { key: 'b32b4be6317516469e68afeb2a9cd9c988c8dd23', class: "products-column" }, equipmentItems.map((item, index) => this.renderEquipmentItem(item, index)), standalonePlans.map(plan => this.renderStandalonePlan(plan))), index.h("div", { key: '5a008f064bf26b937d616d2e33c612f75c91a953', class: "summary-column" }, this.renderPromoCode(), this.renderPaymentSummary(), this.renderTermsCheckbox(), index.h("button", { key: '1c95698ad466dd20c8099bd8e300716be4210266', class: {
                'btn-proceed': true,
                'disabled': !canProceed,
            }, onClick: this.handleProceed, disabled: !canProceed }, index.h("span", { key: '07865808884448a3309c11e038fe73e8db8bd800' }, "Procesar orden"), index.h("svg", { key: '0b892573558db7582e4892774feefce1ac757cd5', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: '753d264532f2ceecc53707e40a1c5edd9c72f08e', d: "M5 12h14M12 5l7 7-7 7" })))))))));
    }
};
...
const StepPayment = class {
    ...
    render() {
        return (index.h(index.Host, { key: '44154235d6e0c51f68086e9c8a954f779d7068e4' }, index.h("div", { key: 'da809c7b605455a5dd7efc2b28728c1767d5e48e', class: "step-payment" }, index.h("div", { key: 'cc23c00669a5f05e6c8486ab3920918cceab0c87', class: "header" }, this.screen !== 'processing' && this.screen !== 'success' && (index.h("button", { key: 'a73cf3b08d251a0bcbfdc55a8d83fbf5bad93dc1', class: "btn-back-nav", onClick: () => this.onBack?.() }, index.h("svg", { key: '6f194f901fdad89e39a8ad7c23381953ac937a37', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: 'e6187e8babfbcbcab83522c07f7cdffdfc9f8ebc', d: "M19 12H5M12 19l-7-7 7-7" })), "Regresar")), index.h("h1", { key: 'e72c0f65e18954f3af18d46f13fe2e85464206b4', class: "title" }, "Pago")), index.h("div", { key: '67ce4b79e0a0e7f7029e5cd3271592be219ea0dc', class: "content" }, this.screen === 'loading' && this.renderLoading(), this.screen === 'creating-order' && this.renderCreatingOrder(), this.screen === 'payment' && this.renderPaymentForm(), this.screen === 'processing' && this.renderProcessing(), this.screen === 'success' && this.renderSuccess(), this.screen === 'error' && this.renderError()))));
    }
};
...
const StepPlans = class {
    ...
    render() {
        ...
        const totalToday = 0;
        return (index.h(index.Host, { key: 'f90e6ba5821a28e4e5f983615adc5a3218868956' }, index.h("div", { key: '79a0c14ab238617c59f1ff5436dc6af44f3f0683', class: "step-plans" }, index.h("header", { key: 'b71d68973c440c41cd4592513d5d1bd6dae9c41b', class: "step-plans__header" }, index.h("h1", { key: '4770b64ac2afb94ca2b7b21337c55cd86bf6be7f', class: "step-plans__title" }, "Elige tu plan"), index.h("button", { key: '0ba38403d199f066c0944b6af089c2c51d42309e', class: "step-plans__btn-back", onClick: this.onBack }, "Regresar")), this.isLoading && (index.h("div", { key: '5d7e90e2419441027e3d4f0fa03cc2793c79730a', class: "step-plans__loading" }, index.h("div", { key: 'e48d4c41ee85dece546dd6740e639070bec33753', class: "step-plans__spinner" }), index.h("p", { key: 'a94f566bbdade38082f07ad8e2be62b22c09935f' }, "Cargando planes..."))), this.error && (index.h("div", { key: '1e4324ae465f14197fdfad41df685bb5eb12e457', class: "step-plans__error" }, index.h("p", { key: 'b5f8f80c34c2e79ed39c306c47b768ce5620a1d3' }, this.error), index.h("button", { key: '64dc9be6815138ce73bdb7b3b0f7cdc4191e48e2', onClick: () => this.loadPlans() }, "Reintentar"))), !this.isLoading && !this.error && this.plans.length > 0 && (index.h("div", { key: '934396bfe8daaf91fd8058b091c7213deadbfca4', class: "step-plans__carousel-container" }, index.h("ui-carousel", { key: '4efad9d0371be107f6e4cc53a606b3302385746e', totalItems: this.plans.length, gap: 24, showNavigation: true, showPagination: true, breakpoints: [
                { minWidth: 0, slidesPerView: 1 },
                { minWidth: 500, slidesPerView: 2 },
                { minWidth: 800, slidesPerView: 3 },
                { minWidth: 1100, slidesPerView: 4 },
            ] }, this.plans.map((plan) => this.renderPlanCard(plan))))), !this.isLoading && !this.error && this.plans.length === 0 && (index.h("div", { key: 'ef83deed8110a1e7813e3519f4be6c3e71503dd7', class: "step-plans__empty" }, index.h("p", { key: '5e59e9a93fc9183924c55562bec1a82cf470f627' }, "No hay planes disponibles para tu \u00E1rea."))), index.h("footer", { key: 'bb02536a909fbc93b517289a0081b4c58eb04e77', class: "step-plans__footer" }, index.h("div", { key: 'f07704ad52b838b02dd1aad4bd4c49790c5037ff', class: "step-plans__footer-left" }, index.h("div", { key: '14c7fda022c35e387cf64a7d4e9929d61c32a780', class: "step-plans__footer-info" }, index.h("div", { key: 'dc512c9cb011ea940939b18574ca9e7c127595be', class: "step-plans__footer-item" }, index.h("span", { key: '052b07f383750d4702c8afad52c261a95e2834ad', class: "step-plans__footer-label" }, "Pago mensual"), index.h("span", { key: 'a423f3beb6240da1231f0655cf5a292ea5a94a77', class: "step-plans__footer-value" }, formatPrice(monthlyPayment))), index.h("div", { key: '492dbd86cb3bb898b6de245a8ceb432577b14693', class: "step-plans__footer-item step-plans__footer-item--separator" }, index.h("span", { key: '24e67f197823f76b8c5e63b406597c52fb3c3ef3', class: "step-plans__footer-label" }, "Paga hoy"), index.h("span", { key: 'd24c732928300a3171b5aec04aa8918c6c15d13f', class: "step-plans__footer-value step-plans__footer-value--highlight" }, formatPrice(totalToday)))), index.h("p", { key: 'c15325575b62b2019afcbe8d3725668e8cf7cf40', class: "step-plans__footer-note" }, "Renta mensual aproximada no incluye cargos estatales, federales, ni otros impuestos.")), index.h("button", { key: 'c448e3ec1492120118234e259513a92b981d49e0', class: "step-plans__footer-btn", onClick: this.handleContinue, disabled: !this.selectedPlan || this.isAddingToCart }, this.isAddingToCart ? 'Procesando...' : 'Continuar')))));
    }
};
...
const StepProductDetail = class {
    ...
    // ------------------------------------------
    render() {
        return (index.h(index.Host, { key: 'f6f5da2204bacc3f2e22e166e904a942a34b49a1' }, index.h("div", { key: 'fb8e8a53343364958196cc8fdb35ec6da995431e', class: "step-product-detail" }, this.renderUnavailableAlert(), this.isLoading && (index.h("div", { key: 'cec8da757327a32af784b3fa4690d0aae8d275b8', class: "loading-container" }, index.h("div", { key: 'd9345339f269a0cae7b7c98235bd46c679a5173a', class: "spinner" }), index.h("p", { key: '5a5a3e5a9d7498a61acfa8705141f939e64678ac' }, "Cargando producto..."))), this.error && !this.isLoading && (index.h("div", { key: 'cfabad9e3e962e180d25b56211a6e2b3a02b6952', class: "error-container" }, index.h("p", { key: '2310f44a366658042f5f73b960680257d8c6f6c8' }, this.error), index.h("button", { key: '5936dacf538439957fd959094025563e535d13d4', class: "btn-retry", onClick: () => this.loadProductDetail() }, "Reintentar"), index.h("button", { key: 'e79e30d0eb8fbe794b84006c022da93c1cbb9e19', class: "btn-back", onClick: this.onBack }, "Volver al cat\u00E1logo"))), !this.isLoading && !this.error && this.product && (index.h("div", { key: 'ad4dff462c0c38b35d57ee7fc61baeb54e09f3fb', class: "product-container" }, this.renderBreadcrumb(), index.h("div", { key: 'f15d19d5700a7b7f7877535189d529fe82201f80', class: "product-grid" }, index.h("div", { key: 'a79b4402d66696c05fc1a77003d5964889868861', class: "product-image-section" }, index.h("ui-image-carousel", { key: '2574169af64849beae90eb982b0ba1b13a63d6a7', images: this.productImages, loop: true, showNavigation: this.productImages.length > 1, showIndicators: this.productImages.length > 1, autoplayInterval: 0 })), index.h("div", { key: 'ce58350892cc2d0c595ad56f1a6b3ae986ee892f', class: "product-details-section" }, this.product.brandName && (index.h("span", { key: 'c9dbc2ae620998d47c1b46645690868c336d7102', class: "brand-name" }, this.product.brandName)), index.h("h1", { key: '4447a1888895e7846bd64dae3259a26e7558b8ee', class: "product-name" }, this.product.productName), this.product.shortDescription && (index.h("p", { key: 'f99de4112c2104e652c62fce0f47f3f2c6290d99', class: "product-description" }, productService.cleanDescription(this.product.shortDescription))), this.renderAvailabilityStatus(), this.renderColorSelector(), this.renderStorageSelector(), this.renderInstallmentSelector(), this.renderQuantitySelector(), this.renderPriceSection(), index.h("button", { key: '2a0fb17ffb42e9e23bfdb7a2440abb2d7046c530', class: {
                'btn-add-to-cart': true,
                'loading': this.isAddingToCart,
                'disabled': !this.isAvailable,
            }, onClick: this.handleAddToCart, disabled: this.isAddingToCart || !this.isAvailable }, this.isAddingToCart ? (index.h("span", { class: "loading-text" }, index.h("span", { class: "spinner-small" }), "Agregando...")) : !this.isAvailable ? ('No disponible') : ('Continuar')), index.h("button", { key: 'e4d48537e4eff5d7fb4fbd537360335b7f96f392', class: "btn-back-link", onClick: this.onBack }, "\u2190 Volver al cat\u00E1logo"))), this.product.features && this.product.features.length > 0 && (index.h("div", { key: '4068563e46d85763eea9b0722728a1be6cc67975', class: "features-section" }, index.h("h3", { key: '610bcb5243c5b59f99ae8dc49267c981421e9dda', class: "features-title" }, "Caracter\u00EDsticas"), index.h("ul", { key: '7c205b947fabb39342fae99bf635dc4610158718', class: "features-list" }, this.product.features.map(feature => (index.h("li", { class: "feature-item" }, feature)))))), this.product.specifications && this.product.specifications.length > 0 && (index.h("div", { key: '2dc48d0f8ddd2daa8558a905103f1fd80ab9206c', class: "specs-section" }, index.h("h3", { key: 'b7168f6107e3eb1c01921df3b052905cad91beec', class: "specs-title" }, "Especificaciones"), index.h("div", { key: 'd3f4fb10926e83262f18632db967086e0c12b31f', class: "specs-grid" }, this.product.specifications.map((spec) => (index.h("div", { class: "spec-item" }, index.h("span", { class: "spec-label" }, spec.name), index.h("span", { class: "spec-value" }, spec.value))))))))))));
    }
};
...
const StepShipping = class {
    ...
    // ------------------------------------------
    render() {
        return (index.h(index.Host, { key: '7ae7bebbb3e13d31265012fdf1d0007a58ccc549' }, index.h("div", { key: 'f066b9f78003b4258a216e967babf70875c34b7c', class: "step-shipping" }, index.h("p", { key: '8c695e5687cd17c583a7e97ceac601f8b6979994', class: "info-message" }, "Por favor, ingresa la informaci\u00F3n personal solicitada. Su nombre y apellido deben ser iguales a su identificaci\u00F3n de gobierno."), this.error && (index.h("div", { key: '45e0af3f13e97a0198cf137b156f14912b156186', class: "error-alert" }, index.h("svg", { key: 'cae16b40569a38151eecf91e3e8bc2fa8700dbd1', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("circle", { key: 'b8f331848eeb1b0fd5023e98bbe7908cf8a5fedf', cx: "12", cy: "12", r: "10" }), index.h("line", { key: '75b258a0c98e884c39bc0f39d80a7f69c7c6836b', x1: "12", y1: "8", x2: "12", y2: "12" }), index.h("line", { key: '774cca2fac86dc19a44a94070945f25bba002a53', x1: "12", y1: "16", x2: "12.01", y2: "16" })), index.h("span", { key: '24dd26e600ecafd36b87e6098a165b8fb93d2b48' }, this.error))), index.h("div", { key: '86453f1110b995cf95be698da80ba6b350cde36c', class: "form-container" }, index.h("div", { key: '1337c15029ef62ecaaae17ed5c76b0b474d944ba', class: "form-row" }, index.h("div", { key: 'c2c0440e02e1576eb32f4a44ced18ccd5392ee0e', class: "form-group" }, index.h("label", { key: 'cd7e142575dc19cd01d3a53452a77ed4108a19cc', class: "form-label" }, index.h("span", { key: 'cb6791589c6bedf4ec4dd49a90c6818ebc9b0af0', class: "required" }, "*"), "Nombre:"), index.h("input", { key: '7c7f6bb56d58cc613dedd42f7bb5adeed98ac7cd', type: "text", class: { 'form-input': true, error: this.touched.name && !!this.formErrors.name }, value: this.name, onInput: this.handleInputChange('name'), placeholder: "Ingresar nombre" }), this.touched.name && this.formErrors.name && index.h("span", { key: 'b11ec748d53b4d4362505b5a0eece2410160f135', class: "error-message" }, this.formErrors.name)), index.h("div", { key: '496739bac23e60c715b318e87de60462d773d4fb', class: "form-group" }, index.h("label", { key: '2bd5afa3a5a16eba18c6e691630920461c5aca38', class: "form-label" }, "Segundo nombre:"), index.h("input", { key: '5cd35e05777bfb2378c9330d6f23fe67f4db5350', type: "text", class: "form-input", value: this.secondName, onInput: this.handleInputChange('secondName'), placeholder: "Ingresar segundo nombre (Opcional)" }))), index.h("div", { key: '8811ecafcce92d5f2c50c6a16fff637844806571', class: "form-row" }, index.h("div", { key: '0642b4e824009299d108a85ecd63ed56ea897145', class: "form-group" }, index.h("label", { key: '6affa3bde930d01c3e53213404e9e3cb3161ec0b', class: "form-label" }, index.h("span", { key: '312a964f1c56afc5085bf4481cc5f877682ed8e0', class: "required" }, "*"), "Apellido:"), index.h("input", { key: 'af8d81aa3dce7d5ffcef342c375bc6226e09ce25', type: "text", class: { 'form-input': true, error: this.touched.lastname && !!this.formErrors.lastname }, value: this.lastname, onInput: this.handleInputChange('lastname'), placeholder: "Ingresar apellido" }), this.touched.lastname && this.formErrors.lastname && index.h("span", { key: '6ddd4e10b4e772a0b957306e034a7e6619fd8f30', class: "error-message" }, this.formErrors.lastname)), index.h("div", { key: '26fcf42cb306506823d12836350d1ccf1f9f0a3e', class: "form-group" }, index.h("label", { key: 'd5afc6f663e81951e9011364de82d1f1e2c04abb', class: "form-label" }, index.h("span", { key: '072ccacda1555a2043ff6b0f3c3eba951602de24', class: "required" }, "*"), "Segundo apellido:"), index.h("input", { key: 'eb014bd7177ea3465600e8f37ab537c3d9fba78a', type: "text", class: { 'form-input': true, error: this.touched.secondLastname && !!this.formErrors.secondLastname }, value: this.secondLastname, onInput: this.handleInputChange('secondLastname'), placeholder: "Ingresar segundo apellido" }), this.touched.secondLastname && this.formErrors.secondLastname && index.h("span", { key: '65f296fad407839bdea2d890339a93d56941a661', class: "error-message" }, this.formErrors.secondLastname))), index.h("div", { key: '9b1491d42acf45a8f74c7ba661cc4c1432bf9726', class: "form-row" }, index.h("div", { key: 'a23a636f4e8da464edab56a4ae8416fab184c0d8', class: "form-group" }, index.h("label", { key: 'c88823048a64f456cba72feb0d9938019b54620e', class: "form-label" }, index.h("span", { key: 'a7b1b2011cd618e8163d9d44bc5381bfd79706c6', class: "required" }, "*"), "Identificaci\u00F3n:"), index.h("div", { key: 'c978d3b5795a62479a951aa17bd23f2330121b51', class: "id-field" }, index.h("div", { key: 'a8d06dc73cea607435ab41e3874917ff8cb8e538', class: "radio-group" }, index.h("label", { key: '823a2f5fb88a02ef222bc21837e23b4f51ccb23a', class: "radio-label" }, index.h("input", { key: '190b095513a09becbd9afcb6701bb4ae82d9ea2d', type: "radio", name: "idType", checked: this.idType === 'license', onChange: this.handleRadioChange('idType', 'license') }), index.h("span", { key: '4e5f43b042d2421f33af32295dcb697283bf3221', class: "radio-custom" }), index.h("span", { key: '2ff76995b3ea2a91f38c5f576f1e8e9e3e3b8631', class: "radio-text" }, "Licencia de conducir")), index.h("label", { key: '83cda857f71d2e57235c7db23a33278f8e27a47e', class: "radio-label" }, index.h("input", { key: 'c941b00e6c0424f7f757809c7a8487b968fa9b7c', type: "radio", name: "idType", checked: this.idType === 'passport', onChange: this.handleRadioChange('idType', 'passport') }), index.h("span", { key: 'b9bf3cf45f6a7edda73847faf28451945d043e28', class: "radio-custom" }), index.h("span", { key: 'ff8c1a8cb167efb254bb980ffbbe24ed99b6cdd3', class: "radio-text" }, "Pasaporte"))), index.h("input", { key: '9e706b1c08c3be90654a22f830da2581dc7e2a69', type: "text", class: { 'form-input': true, 'id-input': true, error: this.touched.idNumber && !!this.formErrors.idNumber }, value: this.idNumber, onInput: this.handleInputChange('idNumber'), placeholder: "Ingresar nro de identificaci\u00F3n" })), this.touched.idType && this.formErrors.idType && index.h("span", { key: '7dec316ea77a2887e8236f5c62dc07e5329f3d81', class: "error-message" }, this.formErrors.idType), this.touched.idNumber && this.formErrors.idNumber && index.h("span", { key: 'ace10559a4beade529a1d7d3524929239979978c', class: "error-message" }, this.formErrors.idNumber)), index.h("div", { key: '5b33f615e67feabab7028f4af6b0aa4eabba0bcd', class: "form-group" }, index.h("label", { key: 'b56ca9a6e43259a6ee976a26125345e34a983e64', class: "form-label" }, index.h("span", { key: 'fe80746dd75dabfcc7cc8d4c0a2ad2d17c4e5400', class: "required" }, "*"), "Fecha de vencimiento:"), index.h("div", { key: '81e26202ef03fbeea5aec79721ec8c7118628ff1', class: "date-input-wrapper" }, index.h("input", { key: 'db2149d07a0bff3f0e637b9cc6d651d06f503f1b', type: "date", class: { 'form-input': true, error: this.touched.expirationDate && !!this.formErrors.expirationDate }, value: this.expirationDate, onInput: this.handleInputChange('expirationDate'), placeholder: "Seleccionar" })), this.touched.expirationDate && this.formErrors.expirationDate && index.h("span", { key: 'c9a806a8fbbd89180cf9900207a2b3f1d4f02e80', class: "error-message" }, this.formErrors.expirationDate))), index.h("div", { key: '40bb0adc01fd7591bfa094c1dac80eda17512281', class: "form-row" }, index.h("div", { key: 'a9eb8eaf0761e9f2f3ab7ea81dc23c7e7cbe480b', class: "form-group" }, index.h("label", { key: 'cd16cd0746541416e86740b969e370f6cac9dfad', class: "form-label" }, index.h("span", { key: '85ec660a4c26378dd7ebc6c3518be92341a125a9', class: "required" }, "*"), "Tel\u00E9fono de contacto 1:"), index.h("input", { key: '365d37fdb282b8376542da16fc2913ce12813877', type: "tel", class: { 'form-input': true, error: this.touched.phone && !!this.formErrors.phone }, value: this.phone, onInput: this.handleInputChange('phone'), placeholder: "Ingresar nro de tel\u00E9fono" }), this.touched.phone && this.formErrors.phone && index.h("span", { key: 'ce786b52e786957af6c153c255c1e78e38bb22a7', class: "error-message" }, this.formErrors.phone)), index.h("div", { key: '53dcfb2c8a47fa4b89ab23aa81707a563e08ffd3', class: "form-group" }, index.h("label", { key: '2c8c267b276d9a3be5a276533492aace19c6d8b9', class: "form-label" }, "Tel\u00E9fono de contacto 2:"), index.h("input", { key: '2ee5ac14a47ce62baf7dd70e98359ba0d61578fd', type: "tel", class: "form-input", value: this.phone2, onInput: this.handleInputChange('phone2'), placeholder: "Ingresar nro de tel\u00E9fono" }))), index.h("div", { key: '9109a6a374b5f018ab50910607ba70fd8bb367b5', class: "form-row" }, index.h("div", { key: '46f4c3d535f668630abd62d1e82c9830842955f8', class: "form-group" }, index.h("label", { key: 'a0f5a9abd1dc8f6f55c041b9ddd5602410d8de1d', class: "form-label" }, index.h("span", { key: 'd7cdd6fca00dba0b402137c39babb3bb0e80072e', class: "required" }, "*"), "Nombre del Negocio:"), index.h("input", { key: '01266ede5d55ba433117dd69c086223e60915aa9', type: "text", class: { 'form-input': true, error: this.touched.businessName && !!this.formErrors.businessName }, value: this.businessName, onInput: this.handleInputChange('businessName'), placeholder: "Ingresar nombre del negocio" }), this.touched.businessName && this.formErrors.businessName && index.h("span", { key: '0930d1939f86552449e03d11cc1ee1b27ba8a369', class: "error-message" }, this.formErrors.businessName)), index.h("div", { key: '672a655b281a976db731fe7ecafd7b060140b190', class: "form-group" }, index.h("label", { key: '6bde70537ea0af996539eb48bdd69f1df25d567c', class: "form-label" }, index.h("span", { key: 'f6ac8f9932bb9f50096768474c686905f4c2d267', class: "required" }, "*"), "Posici\u00F3n en la Empresa:"), index.h("input", { key: '68a45ae95232a17bd6a05927ddb3878a06f65f88', type: "text", class: { 'form-input': true, error: this.touched.position && !!this.formErrors.position }, value: this.position, onInput: this.handleInputChange('position'), placeholder: "Ingresar posici\u00F3n actual" }), this.touched.position && this.formErrors.position && index.h("span", { key: 'cb4bea9d7785680f39a3b867550153cffbf7cf43', class: "error-message" }, this.formErrors.position))), index.h("div", { key: '1c2c2012328c63a9fc3dfea778a1df84d8b44bb1', class: "form-row" }, index.h("div", { key: '6bf3b1bd88ac311bddadb53f243f2b3e0627b677', class: "form-group" }, index.h("label", { key: '334a6edc7a9c49694932b1c7ebdce0d45a82990c', class: "form-label" }, index.h("span", { key: '3a28dfac7dacee1d7a88de91db81b9835af03455', class: "required" }, "*"), "Direcci\u00F3n:"), index.h("input", { key: '2b2535ee98ad8ead3fc164ff8a6f62320e856800', type: "text", class: { 'form-input': true, error: this.touched.address && !!this.formErrors.address }, value: this.address, onInput: this.handleInputChange('address'), placeholder: "Ingresar direcci\u00F3n" }), this.touched.address && this.formErrors.address && index.h("span", { key: 'd5df9464446c21ff791b6dc78b8dff01f30e138b', class: "error-message" }, this.formErrors.address)), index.h("div", { key: 'd948573bfc7bfda7c569f6d640ca5bbe2d25862f', class: "form-group" }, index.h("label", { key: '5b844b6e991312a1c9d18bb6e3b75b2f4f4b7783', class: "form-label" }, index.h("span", { key: '3efa4f922cf5b11e91ece600003aff619d37c3a4', class: "required" }, "*"), "Ciudad:"), index.h("input", { key: '2733c88c2ce9a6b9b296c13fdf1841ac4695d097', type: "text", class: { 'form-input': true, error: this.touched.city && !!this.formErrors.city }, value: this.city, onInput: this.handleInputChange('city'), placeholder: "Ingresar ciudad" }), this.touched.city && this.formErrors.city && index.h("span", { key: 'ffb55325d480121c42cb5ded4568477af6c167e3', class: "error-message" }, this.formErrors.city))), index.h("div", { key: '7209f9417c681860f688c1abb0b6c86ffb18f084', class: "form-row" }, index.h("div", { key: '21dff49c47d67c0e34b802eae167fa71c415a47a', class: "form-group" }, index.h("label", { key: '3e3421aa50ac2fdc8c61a6a20025da2f051ee301', class: "form-label" }, index.h("span", { key: '447b16da22440ce8960f3f4af090d994b8e367b2', class: "required" }, "*"), "C\u00F3digo postal"), index.h("input", { key: '637b0cd9b9ef6a74b7c297db23c33dafe5e45745', type: "text", class: { 'form-input': true, error: this.touched.zipcode && !!this.formErrors.zipcode }, value: this.zipcode, onInput: this.handleInputChange('zipcode'), placeholder: "Ingresar c\u00F3digo postal", maxLength: 5 }), this.touched.zipcode && this.formErrors.zipcode && index.h("span", { key: 'f2b780128a1cd722ece53145dcd89b3283d45cb8', class: "error-message" }, this.formErrors.zipcode)), index.h("div", { key: 'e2119f2a49006a55ec8f6c531d36f36195dd8cb5', class: "form-group" }, index.h("label", { key: '4752cfae5f5584e37d258bafce1da8169b72027c', class: "form-label" }, index.h("span", { key: 'd48f17fe4de363a55e3c33744daa11700f715a23', class: "required" }, "*"), "Correo electr\u00F3nico:"), index.h("input", { key: '735ac9a4774e60a49bf8f697307254175045bdba', type: "email", class: { 'form-input': true, error: this.touched.email && !!this.formErrors.email }, value: this.email, onInput: this.handleInputChange('email'), placeholder: "Ingresar Correo electr\u00F3nico" }), this.touched.email && this.formErrors.email && index.h("span", { key: '33b80978f310afb802bfd6970a4de7aacebce137', class: "error-message" }, this.formErrors.email))), index.h("div", { key: '60795c5c644d4032f0be294dd2a0442ace2ce847', class: "form-group existing-customer" }, index.h("label", { key: '8545bb07e5946b099563e3309f896abe5555d8e3', class: "form-label" }, index.h("span", { key: '133b8ff2339a48aa745b33dc1f6fb554af15920e', class: "required" }, "*"), "Cliente existente de Claro PR:"), index.h("div", { key: '5469554e900b063f4d9f6b04981b2bce6f39ac3c', class: "radio-group horizontal" }, index.h("label", { key: 'f7d6687aca7e88c348063114d71f26d868544a51', class: "radio-label" }, index.h("input", { key: '42278570f7941f88f3020447840ee0bc8e1bf7a3', type: "radio", name: "existingCustomer", checked: this.existingCustomer === 'yes', onChange: this.handleRadioChange('existingCustomer', 'yes') }), index.h("span", { key: 'ceaad1ec03f423f5a4a69824f0a51dd8aa7eb1ef', class: "radio-custom" }), index.h("span", { key: '4ba95da48683351250bd97fab29978828d456035', class: "radio-text" }, "S\u00ED")), index.h("label", { key: '270fa045386f0df39680e6e64480cdbe59818ab7', class: "radio-label" }, index.h("input", { key: 'd0667ace3221016a304af893bac31d120ab0e0c5', type: "radio", name: "existingCustomer", checked: this.existingCustomer === 'no', onChange: this.handleRadioChange('existingCustomer', 'no') }), index.h("span", { key: 'afaee58bb1e820aa109a05b2681e291ee2c4e3d8', class: "radio-custom" }), index.h("span", { key: 'e4310b9b40f4736635316e4a99b69cb607980e31', class: "radio-text" }, "No"))), this.touched.existingCustomer && this.formErrors.existingCustomer && (index.h("span", { key: 'ca5c224511a1e8788d07a5434f2ffab43da830d5', class: "error-message" }, this.formErrors.existingCustomer))), index.h("div", { key: 'c58c51d0ea1ff520b17e4e549b32ad8cc7702b1e', class: "btn-container" }, index.h("button", { key: '1344359cc5b9fb127f6b8aa77b4af132b88f06ee', class: { 'btn-submit': true, loading: this.isLoading }, onClick: this.handleSubmit, disabled: this.isLoading }, this.isLoading ? (index.h("span", { class: "btn-loading" }, index.h("span", { class: "spinner" }), "Procesando...")) : ('Continuar')))))));
    }
};
...
//# sourceMappingURL=fixed-service-flow.step-catalogue.step-confirmation.step-contract.step-form.step-location.step-order-summary.step-payment.step-plans.step-product-detail.step-shipping.ui-carousel.ui-image-carousel.entry.cjs.js.map
