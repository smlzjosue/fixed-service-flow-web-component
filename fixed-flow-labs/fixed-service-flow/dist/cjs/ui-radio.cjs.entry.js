...
const UiRadio = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f3c2c478a8e59e1935e669acbe34bdd4a882a8d5' }, index.h("label", { key: '16de1962b2757bcf39116ae8813b1edff00af254', class: classes }, index.h("input", { key: 'f172ac0d8aafe05b922ab3bd72ebad306dfb879d', type: "radio", class: "ui-radio__input", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, onChange: this.handleChange }), index.h("span", { key: '0bddc8be027865b8275c198b1ecf626ee6f87266', class: "ui-radio__indicator" }), this.label && index.h("span", { key: '3030473e7903f7776e5fa3907b4f04b6de4fc709', class: "ui-radio__label" }, this.label), index.h("slot", { key: '7019c117411ee55489631b79a88e9089536205ac' }))));
    }
};
