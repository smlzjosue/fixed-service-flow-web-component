...
const UiDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1ff83d6a4d4d1bfcd80bfd7a96e794c3df583625' }, index.h("div", { key: 'e09be65859660304026176a1426c23ae415104a0', class: containerClasses }, this.label && (index.h("label", { key: 'ba48c1e1d06e3b875bca13ed4bc8333abe138f3d', class: "ui-date-picker__label", htmlFor: this.name }, this.label, this.required && index.h("span", { key: '4d31186d74613b69392d8b48e245281cc8da8aff', class: "ui-date-picker__required" }, "*"))), index.h("div", { key: '55d2cd0cb1cfb1b89156b266057f73d58b86fc99', class: "ui-date-picker__wrapper" }, index.h("input", { key: '3d1ba9b16cababf76776752cb5ffd800602cd135', type: "date", class: "ui-date-picker__field", id: this.name, name: this.name, value: this.value, min: this.min, max: this.max, placeholder: this.placeholder, disabled: this.disabled, readOnly: this.readonly, required: this.required, onInput: this.handleInput, onFocus: this.handleFocus, onBlur: this.handleBlur }), index.h("div", { key: 'bb658a471429cadf1a221c1303921b8c45fab2ef', class: "ui-date-picker__icon" }, index.h("svg", { key: 'b75ada365470d1afb797d04009f975c85030de61', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("rect", { key: '7a7e763db700d8458a5e3f388513feeef0bff88f', x: "3", y: "4", width: "18", height: "18", rx: "2", ry: "2" }), index.h("line", { key: 'c1e7bafc0cd3448f8fa2569b0e9f3e600dd16aba', x1: "16", y1: "2", x2: "16", y2: "6" }), index.h("line", { key: '5eceaf7a81d05fabb115a92fc71d197181746884', x1: "8", y1: "2", x2: "8", y2: "6" }), index.h("line", { key: 'd2e5fc762406bde8f799d8e9f425c0ac18001de8', x1: "3", y1: "10", x2: "21", y2: "10" })))), (hasError || this.helperText) && (index.h("div", { key: '04c03e38d957f8535dc2adfe245b4babe54eaa2e', class: { 'ui-date-picker__message': true, 'ui-date-picker__message--error': hasError } }, hasError ? this.error : this.helperText)))));
    }
