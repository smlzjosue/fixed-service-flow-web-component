...
const UiDatePicker = class {
    constructor(hostRef) {
        ...
        this.dateFocus = index.createEvent(this, "dateFocus");
        this.dateBlur = index.createEvent(this, "dateBlur");
    }
    // ------------------------------------------
    // PROPS
    // ------------------------------------------
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f881a3fdfa30d613ccd07242ad1acd03a6177ee9' }, index.h("div", { key: 'd2019b97e77a707f2c0e77f910db2bded097fca6', class: containerClasses }, this.label && (index.h("label", { key: '8283f1183c631ff17ddf82fd1404ea80afed3235', class: "ui-date-picker__label", htmlFor: this.name }, this.label, this.required && index.h("span", { key: '6086da90df959f30aaec6265d3212b626beba955', class: "ui-date-picker__required" }, "*"))), index.h("div", { key: '86d707025650f633e1dd43c8a1b0e58f4e0457df', class: "ui-date-picker__wrapper" }, index.h("input", { key: '3914d3e7e693863e8f5705ceb90865df29d7ce83', type: "date", class: "ui-date-picker__field", id: this.name, name: this.name, value: this.value, min: this.min, max: this.max, placeholder: this.placeholder, disabled: this.disabled, readOnly: this.readonly, required: this.required, onInput: this.handleInput, onFocus: this.handleFocus, onBlur: this.handleBlur }), index.h("div", { key: '3f7cca8e46f2bb03b3af3ed9d9135a208dab2c9f', class: "ui-date-picker__icon" }, index.h("svg", { key: '1117ff0b3b893d280bcefae043223427003cb5cc', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("rect", { key: 'e905dcd8e74c433b32cc6522c8a9d6542dc56b70', x: "3", y: "4", width: "18", height: "18", rx: "2", ry: "2" }), index.h("line", { key: '6ad76c13dc56b7f1532919f8d11b280db507d7f2', x1: "16", y1: "2", x2: "16", y2: "6" }), index.h("line", { key: 'e50583c6934cfe75bf2c0e475c894d4da5aeb085', x1: "8", y1: "2", x2: "8", y2: "6" }), index.h("line", { key: 'a99893ebd1fed7a13eb827361521f6b977aececf', x1: "3", y1: "10", x2: "21", y2: "10" })))), (hasError || this.helperText) && (index.h("div", { key: '0cd9d9dee65596addc7f159b822fa28f85cb9bae', class: { 'ui-date-picker__message': true, 'ui-date-picker__message--error': hasError } }, hasError ? this.error : this.helperText)))));
    }
...
//# sourceMappingURL=ui-date-picker.entry.cjs.js.map
