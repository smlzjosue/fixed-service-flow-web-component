...
const UiDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8f00683c0e8d5a705aa11994b5668d59da4f85d0' }, index.h("div", { key: '6f0e0d6854a86ed7b1130efe5c4ee116814da3fa', class: containerClasses }, this.label && (index.h("label", { key: '9408917aef00bce929a65ac560c11803b3ece125', class: "ui-date-picker__label", htmlFor: this.name }, this.label, this.required && index.h("span", { key: '4113451e3b30c061517be2bbe370c8694dcf0c0a', class: "ui-date-picker__required" }, "*"))), index.h("div", { key: 'a805d3d30ff0bc50971ee63b9b0cee48d1172941', class: "ui-date-picker__wrapper" }, index.h("input", { key: '86bceed35eb907d3ff3bbeb2fdb101e47c4abf87', type: "date", class: "ui-date-picker__field", id: this.name, name: this.name, value: this.value, min: this.min, max: this.max, placeholder: this.placeholder, disabled: this.disabled, readOnly: this.readonly, required: this.required, onInput: this.handleInput, onFocus: this.handleFocus, onBlur: this.handleBlur }), index.h("div", { key: '87b02ece272f3cc51261c0222733c49d8eb92c1d', class: "ui-date-picker__icon" }, index.h("svg", { key: 'a2e2587630df969406d5f1b1758bb23c82f7f195', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("rect", { key: '0354df53ff3ca4197859f95e9036a53f2a78a479', x: "3", y: "4", width: "18", height: "18", rx: "2", ry: "2" }), index.h("line", { key: 'c5a4767b65bb0ffbec6278e42cfc564ac2b44107', x1: "16", y1: "2", x2: "16", y2: "6" }), index.h("line", { key: 'b5c6442f5f24d9c294b891a0be70a98ddc872dc9', x1: "8", y1: "2", x2: "8", y2: "6" }), index.h("line", { key: '519b20fcab6e9a01e71ce4d78a63d92df932013f', x1: "3", y1: "10", x2: "21", y2: "10" })))), (hasError || this.helperText) && (index.h("div", { key: 'e5828bc347b125671ecce0da97defbc77ff3a142', class: { 'ui-date-picker__message': true, 'ui-date-picker__message--error': hasError } }, hasError ? this.error : this.helperText)))));
    }
