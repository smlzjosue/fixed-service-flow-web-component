...
const UiDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2fba44933f6b6d4ee1a07ff6114d1af3a5b91cf4' }, index.h("div", { key: 'd21ae40556104f3ef06deed152199011561a6f9a', class: containerClasses }, this.label && (index.h("label", { key: 'aab8eb673e662af570a0181f5b97a0327db8477c', class: "ui-date-picker__label", htmlFor: this.name }, this.label, this.required && index.h("span", { key: '1a1c0933bba94aadd150ac71f8a32f1fe5597089', class: "ui-date-picker__required" }, "*"))), index.h("div", { key: 'a80f81f1efc8de0af8d486de7d8ca7e33a8df152', class: "ui-date-picker__wrapper" }, index.h("input", { key: '355db9746255733934d1c4c9290d69c71da54a37', type: "date", class: "ui-date-picker__field", id: this.name, name: this.name, value: this.value, min: this.min, max: this.max, placeholder: this.placeholder, disabled: this.disabled, readOnly: this.readonly, required: this.required, onInput: this.handleInput, onFocus: this.handleFocus, onBlur: this.handleBlur }), index.h("div", { key: '9700ceb04de257615b09b87d9b8347b7b51ef584', class: "ui-date-picker__icon" }, index.h("svg", { key: '7a0b88a98333d1602e0c8753989a612e5c20e0a2', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("rect", { key: 'eaaf0d7867082e1efedfd6a82acf29bf0e4a12a9', x: "3", y: "4", width: "18", height: "18", rx: "2", ry: "2" }), index.h("line", { key: '122b7e60f119e86b095dede2b23a396946965ef0', x1: "16", y1: "2", x2: "16", y2: "6" }), index.h("line", { key: 'c2748b00ce2df1bf0058918f9d017ab0f8e75190', x1: "8", y1: "2", x2: "8", y2: "6" }), index.h("line", { key: '0881da40b8c0bf715abd0e4300945102cafd6681', x1: "3", y1: "10", x2: "21", y2: "10" })))), (hasError || this.helperText) && (index.h("div", { key: '2330a2dafb49a3da390b393648e12b1e0c74152f', class: { 'ui-date-picker__message': true, 'ui-date-picker__message--error': hasError } }, hasError ? this.error : this.helperText)))));
    }
