...
const StepPayment = class {
    ...
    render() {
        return (index.h(index.Host, { key: '21fbece589666712eebf1c6ce301d2f06e93632a' }, index.h("div", { key: '40b21d6f072b7c6114cdc40ccd062c9e64219f21', class: "step-payment" }, index.h("div", { key: 'a820b9ae6b8e56cd94c71be976b95f7ea3af5428', class: "header" }, this.screen !== 'processing' && this.screen !== 'success' && (index.h("button", { key: '7dfc9a52346488553e88e191ddcd1bd04a406c9c', class: "btn-back-nav", onClick: () => this.onBack?.() }, index.h("svg", { key: '3ed1b06f438a1714cbc4448093861d3966e83bca', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: 'f9a83b2a85f15c439e8e4d2f2a3792afb9919538', d: "M19 12H5M12 19l-7-7 7-7" })), "Regresar")), index.h("h1", { key: 'ac4e4feecd04bc7d5636ab1002f1c83d9ec38c3b', class: "title" }, "Pago")), index.h("div", { key: '369e171e812267ea50349dd08389cb1ee14b313b', class: "content" }, this.screen === 'loading' && this.renderLoading(), this.screen === 'creating-order' && this.renderCreatingOrder(), this.screen === 'payment' && this.renderPaymentForm(), this.screen === 'processing' && this.renderProcessing(), this.screen === 'success' && this.renderSuccess(), this.screen === 'error' && this.renderError()))));
    }
};
