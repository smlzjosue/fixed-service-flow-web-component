...
const UiCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2258b4edfcf378772d54c145030bd69d2625c3af' }, index.h("label", { key: '3ea89aa5c086347916ab6cb628e9172f1cf171f6', class: {
                'checkbox-container': true,
                'checkbox-container--disabled': this.disabled,
                'checkbox-container--error': this.hasError,
            } }, index.h("input", { key: 'ddca360cc6b052af7af15a085a508c291edd234c', type: "checkbox", name: this.name, checked: this.checked, disabled: this.disabled, onChange: this.handleChange, class: "checkbox-input" }), index.h("span", { key: '2bf9142189948c9a8e5a189869d5c249638feb1e', class: "checkbox-checkmark" }, index.h("svg", { key: '4e8c45e916e6db1ef84c19db45f95f67076ecb3b', class: "checkbox-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "3", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("polyline", { key: 'd28b87e70f7a05cd4627d6b44b33f5820b0e761f', points: "20 6 9 17 4 12" }))), this.label && index.h("span", { key: '70d19cba208f02e86d0303cf13eecb8607a2c555', class: "checkbox-label" }, this.label)), this.hasError && this.errorMessage && (index.h("span", { key: '19d7da4c07feb0f80281779226b77ba603e75b88', class: "checkbox-error" }, this.errorMessage))));
    }
};
