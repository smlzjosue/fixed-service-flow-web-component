...
const UiCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ff5968bb6e59836932b8204b034937339d9b6b6b' }, index.h("label", { key: 'c32b386ccee6f0e87f7fdabcdd5a5c5c49426018', class: {
                'checkbox-container': true,
                'checkbox-container--disabled': this.disabled,
                'checkbox-container--error': this.hasError,
            } }, index.h("input", { key: '815aa71c5b0f684bb5486883183da9c18b34aa7a', type: "checkbox", name: this.name, checked: this.checked, disabled: this.disabled, onChange: this.handleChange, class: "checkbox-input" }), index.h("span", { key: 'b6cc09e864d6f7deb1c2ed54c3b3ab7586436466', class: "checkbox-checkmark" }, index.h("svg", { key: '441e30e7177119c46852af30e889b30148b90b53', class: "checkbox-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "3", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("polyline", { key: '220e428b4f0558fd407037cae97df00ba4fdee5c', points: "20 6 9 17 4 12" }))), this.label && index.h("span", { key: '5602fd774fbb215629363528499db3e8f201249b', class: "checkbox-label" }, this.label)), this.hasError && this.errorMessage && (index.h("span", { key: 'f76c3e7ca98aa262b05ca29bbf100e04d3af5dfd', class: "checkbox-error" }, this.errorMessage))));
    }
};
