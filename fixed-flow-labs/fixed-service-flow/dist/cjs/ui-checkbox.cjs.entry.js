...
const UiCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dc61beb573271c7c9a6af4e1d1ddf05ca1916455' }, index.h("label", { key: '6daa7cfa5988f44234ca04897e1431940c47feae', class: {
                'checkbox-container': true,
                'checkbox-container--disabled': this.disabled,
                'checkbox-container--error': this.hasError,
            } }, index.h("input", { key: 'fbfa3c6b7473a95c12760449b12a3c5c856902c9', type: "checkbox", name: this.name, checked: this.checked, disabled: this.disabled, onChange: this.handleChange, class: "checkbox-input" }), index.h("span", { key: '188252e7fef671e73d78d4ec1f6d6dfeb7ef2f09', class: "checkbox-checkmark" }, index.h("svg", { key: '24acebac0e82446afe0ba1844a137cebd361f492', class: "checkbox-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "3", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("polyline", { key: '5926de8b6a40a68666124c17e19d6c92e0b24de3', points: "20 6 9 17 4 12" }))), this.label && index.h("span", { key: '7687747060bb4a799ddbfebd990a83a7fdd08ca2', class: "checkbox-label" }, this.label)), this.hasError && this.errorMessage && (index.h("span", { key: '8fda44bec8f8f8d627787fb27ee52dae69e58e9a', class: "checkbox-error" }, this.errorMessage))));
    }
};
