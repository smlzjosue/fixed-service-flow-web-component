...
const StepOrderSummary = class {
    ...
    async loadCart() {
        ...
        this.error = null;
        try {
            const response = await cart_service.cartService.getCart();
    ...
    handleApplyPromo = async () => {
        ...
        this.promoSuccess = false;
        try {
            cart_service.cartService.storeDiscountCoupon(this.promoCode);
            const response = await cart_service.cartService.getCart(this.promoCode);
            if (response.hasError) {
                this.promoError = 'Código promocional inválido';
                cart_service.cartService.clearDiscountCoupon();
                return;
            }
            this.cart = response;
    ...
    handleRemoveItem = async (item) => {
        ...
        try {
            const result = await cart_service.cartService.deleteItem(item.cartId, item.productId);
            if (result.hasError) {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3abe1887588a3e4f97cbf4c679e20f0a3ba44fff' }, index.h("div", { key: 'ca41bf751a7675eb7aba559857de4b7b4c3fbd93', class: "step-order-summary" }, index.h("header", { key: '5a0853a4941d0f9ebd1de7c9610e983e8c2a3baa', class: "header" }, index.h("button", { key: '81a16fd16c4f54778a402887eef0681a738516ae', class: "btn-back", onClick: this.onBack }, index.h("svg", { key: 'dd9de340f67043dbcf54d4645d28afd5b1bb1041', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: '52cf802777248dbd44beeb34ef5853cad602125c', d: "M19 12H5M12 19l-7-7 7-7" })), index.h("span", { key: '557cd0a660acabc115c5edf8e7361fb193fc1d80' }, "Regresar")), index.h("div", { key: 'b61a21c52a71c22ecb91fb9f3005d8e63f8d0c46', class: "header__title-group" }, index.h("h1", { key: '693146eb5adf4f8972f3e69511a82197ec2e61fd', class: "title" }, "Resumen de tu orden"), hasItems && (index.h("span", { key: 'bc071f4fd5450e83391767f8d82df06dd39410e5', class: "item-count" }, itemCount, " ", itemCount === 1 ? 'artículo' : 'artículos')))), this.isLoading && (index.h("div", { key: '5ca8dfe50c75bb9bc3c4472a9040b9b0265a3a1c', class: "state-container" }, index.h("div", { key: 'a30fdb1c5f5d55c03496f04f813b74551b72d900', class: "spinner" }), index.h("p", { key: '6dd891d6fbdc9ba956ea6651b58629fb2a9dae57' }, "Cargando tu carrito..."))), this.error && !this.isLoading && (index.h("div", { key: '85367ba7a43237c4a6f8ad255d791887adde1d8b', class: "state-container state-container--error" }, index.h("svg", { key: 'ef6da962735ee70f4e347c750c82e16b4c0760c7', class: "state-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.5" }, index.h("circle", { key: '66e48bf406df05c2bb86acc267b41fe1b62f8128', cx: "12", cy: "12", r: "10" }), index.h("line", { key: '3c843382840baf6ccec0447189b5649ed097d616', x1: "12", y1: "8", x2: "12", y2: "12" }), index.h("line", { key: 'df6c205a4f02f1605a16163fa2942aeab5852157', x1: "12", y1: "16", x2: "12.01", y2: "16" })), index.h("p", { key: '666d65f1fe4ee6dccd230a9cdee4ed53dd45c7c7' }, this.error), index.h("button", { key: 'c1cd746f8df35bc1f4865bacb09bab35bd78941d', class: "btn-retry", onClick: () => this.loadCart() }, "Reintentar"))), !this.isLoading && !this.error && !hasItems && (index.h("div", { key: '97333ec4be4f45595d50ecd5a41f1959ab3bb1e5', class: "state-container state-container--empty" }, index.h("svg", { key: '629da836e8993681141ea3ad4137ba3fd4d50a35', class: "state-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.5" }, index.h("circle", { key: 'd16b18a377122582a6a88af1954ca9f38d1fa897', cx: "9", cy: "21", r: "1" }), index.h("circle", { key: '7205ee49e236e262b93aff3a4c8b8b81b1e7b165', cx: "20", cy: "21", r: "1" }), index.h("path", { key: 'ef61bd1b64220ea0dc90187638f7f312ef6864a7', d: "M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6" })), index.h("h3", { key: '13f094957dedd6126c2eebb1ed3c0df5c77ba8b9' }, "Tu carrito est\u00E1 vac\u00EDo"), index.h("p", { key: '8020712484c96ff6cadb2e1b5fad083ee2bb3600' }, "Agrega productos para continuar con tu compra"), index.h("button", { key: '9f8def2d955c46a177814e44512106ae62512f26', class: "btn-back-catalog", onClick: this.onBack }, "Ir al cat\u00E1logo"))), !this.isLoading && !this.error && hasItems && (index.h("div", { key: '4a19998535b9589b27be6efc33ea7c6d9c7d58cc', class: "content-layout" }, index.h("div", { key: '0d7a55c43ba23de3378b8e3712948071b7837dbb', class: "products-column" }, equipmentItems.map((item, index) => this.renderEquipmentItem(item, index)), standalonePlans.map(plan => this.renderStandalonePlan(plan))), index.h("div", { key: '29bd1e001a1dcd73426eecabc7473c733ef5ac6d', class: "summary-column" }, this.renderPromoCode(), this.renderPaymentSummary(), this.renderTermsCheckbox(), index.h("button", { key: 'f61ed09edb1efc58e0dc4cf528b4cb78578c781d', class: {
                'btn-proceed': true,
                'disabled': !canProceed,
            }, onClick: this.handleProceed, disabled: !canProceed }, index.h("span", { key: 'f54947b1d65d3aef58d570b66b4792d5fa5db24c' }, "Procesar orden"), index.h("svg", { key: '4fd90a8198d4906719b46b65190e459bb5530d59', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: '188e38697b0522cc861acb4d3a8f25c7d7440805', d: "M5 12h14M12 5l7 7-7 7" })))))))));
    }
};
StepOrderSummary.style = stepOrderSummaryCss();

exports.step_order_summary = StepOrderSummary;
//# sourceMappingURL=step-order-summary.entry.cjs.js.map
