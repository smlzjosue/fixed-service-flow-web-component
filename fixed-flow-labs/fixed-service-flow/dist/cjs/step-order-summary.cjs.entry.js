...
const StepOrderSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9614e159a2bfb46ceed28c07e66de3fd47b713ed' }, index.h("div", { key: '15299eb922ae18c48e23ac14d66ddb2c40846767', class: "step-order-summary" }, index.h("header", { key: '02a8d4014f14ff0b1f9977b8f010ae8824c98720', class: "header" }, index.h("button", { key: '4bf06c28482591451c9d34cb9d610bf315594d5c', class: "btn-back", onClick: this.onBack }, index.h("svg", { key: '71bc95de67c0fc57987cc645bc6ac729ce52536f', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: '611ab54656950f19ef2d7d5af4f1536541050915', d: "M19 12H5M12 19l-7-7 7-7" })), index.h("span", { key: '4ffb39437d353b476d98fdac3b12f30751d05809' }, "Regresar")), index.h("div", { key: 'cdbd92edc088363ef99d72fbbc0f6ffa2f0fcfbe', class: "header__title-group" }, index.h("h1", { key: '977616ef345d4401ba9693cca07258287c2fc63f', class: "title" }, "Resumen de tu orden"), hasItems && (index.h("span", { key: '1365e75678f16be7641b1725d7796ba6062c1545', class: "item-count" }, itemCount, " ", itemCount === 1 ? 'artículo' : 'artículos')))), this.isLoading && (index.h("div", { key: '17b68ab5561e6b9e783257828eba442fbea659e7', class: "state-container" }, index.h("div", { key: '89b1cd7c43f836e430627dbb46b59b769a0ebc78', class: "spinner" }), index.h("p", { key: 'b87bf40a084c8bc036374635466325109cc4662c' }, "Cargando tu carrito..."))), this.error && !this.isLoading && (index.h("div", { key: 'bbb497f4e9b0d0ab3a3a9accd576cf96b29f49c7', class: "state-container state-container--error" }, index.h("svg", { key: '5da3e3cb79f017040f0efe0c56eea833599fd3ba', class: "state-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.5" }, index.h("circle", { key: '6e038083f3e860c38f2c53d109187e5d3d3ecdb5', cx: "12", cy: "12", r: "10" }), index.h("line", { key: '4b73c04bcffcf95b9ace631cda0f9677a36a16e1', x1: "12", y1: "8", x2: "12", y2: "12" }), index.h("line", { key: 'f65dfcbabf7e4d60fcb9b67daf2347a51513c414', x1: "12", y1: "16", x2: "12.01", y2: "16" })), index.h("p", { key: 'c8d4d434ca976511dec8eaf00b194b13d1522b68' }, this.error), index.h("button", { key: '59373e78f7b6aa6ffb1bfa72db9438975a0915b6', class: "btn-retry", onClick: () => this.loadCart() }, "Reintentar"))), !this.isLoading && !this.error && !hasItems && (index.h("div", { key: 'bc3500a0c3c9fdde789eae2019d2c4a25f32fc9f', class: "state-container state-container--empty" }, index.h("svg", { key: '54126c49fa9c35fe816c31d64cabe6ec692ac4bc', class: "state-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.5" }, index.h("circle", { key: 'dea38322dc7db5b55a6fc877388233865be28108', cx: "9", cy: "21", r: "1" }), index.h("circle", { key: '8d24e9d8ad8226700ea7969b5ec846e40bff90bb', cx: "20", cy: "21", r: "1" }), index.h("path", { key: '740a1fb18a4c422e6f69642f94c892f3ba8eb52f', d: "M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6" })), index.h("h3", { key: 'df4ef82120a9e17bb87bb3024d873d15e9e001f9' }, "Tu carrito est\u00E1 vac\u00EDo"), index.h("p", { key: 'bf84456e737ec81909446d41c69c5a521f251f0e' }, "Agrega productos para continuar con tu compra"), index.h("button", { key: '702c9595ee1cadfc7fd48ad54848e0677c6ae1e7', class: "btn-back-catalog", onClick: this.onBack }, "Ir al cat\u00E1logo"))), !this.isLoading && !this.error && hasItems && (index.h("div", { key: 'cb970226bc10eee95d9dac59b7f61f413ed6e8b8', class: "content-layout" }, index.h("div", { key: 'b0552ac3dc01384823a77b5c9b9aabdc0143c764', class: "products-column" }, equipmentItems.map((item, index) => this.renderEquipmentItem(item, index)), standalonePlans.map(plan => this.renderStandalonePlan(plan))), index.h("div", { key: 'b73ebc773e9aeac31363c558d8ee20d031c66bbd', class: "summary-column" }, this.renderPromoCode(), this.renderPaymentSummary(), this.renderTermsCheckbox(), index.h("button", { key: '48458259d95dbbb57217c12015ca516d1caa4291', class: {
                'btn-proceed': true,
                'disabled': !canProceed,
            }, onClick: this.handleProceed, disabled: !canProceed }, index.h("span", { key: 'f87be689d6312c9a00c59d95e4a4cf1506d9eecd' }, "Procesar orden"), index.h("svg", { key: 'b60b71386db6efcdae1a94d20b69c42ab491e2a4', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: '5f959249b2c17428f92fca5f6551c74968115f5a', d: "M5 12h14M12 5l7 7-7 7" })))))))));
    }
};
