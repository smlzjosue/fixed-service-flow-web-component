...
const StepProductDetail = class {
    ...
    // ------------------------------------------
    render() {
        return (index.h(index.Host, { key: '4e6ff43794cf7f7e0e0bdcbb1ad3fe366c2b3a50' }, index.h("div", { key: '63d05ce6100b6a5bd784aa083e7eb8e091e87d0f', class: "step-product-detail" }, this.renderUnavailableAlert(), this.isLoading && (index.h("div", { key: '8ea95971943cb63482b24713fe65ddd4b5ea8965', class: "loading-container" }, index.h("div", { key: '464898fe763510b8a20ce41236a776c3cda5ce60', class: "spinner" }), index.h("p", { key: '7f38c77361ee944a6d4157ed9ac00efacc4d03fd' }, "Cargando producto..."))), this.error && !this.isLoading && (index.h("div", { key: '2ad5beb09469b63a0b7adae4f9e9dbc849e2df5b', class: "error-container" }, index.h("p", { key: '9ee4618fd1f7e8f72c093e504c49170903950992' }, this.error), index.h("button", { key: '0d8627b282602724b7ac69d60badf57ccd51ea9e', class: "btn-retry", onClick: () => this.loadProductDetail() }, "Reintentar"), index.h("button", { key: 'fef95e430122c3ece7d055abf1ec61ec4835da16', class: "btn-back", onClick: this.onBack }, "Volver al cat\u00E1logo"))), !this.isLoading && !this.error && this.product && (index.h("div", { key: '1bca57e94f7d2973f091767d981da62e1ad8d262', class: "product-container" }, this.renderBreadcrumb(), index.h("div", { key: 'c10912a8856ca1170252d1ce78c87b0c54552e45', class: "product-grid" }, index.h("div", { key: 'd0c92714cac386162f5f6d81f21aa7f3ce320ebb', class: "product-image-section" }, index.h("ui-image-carousel", { key: 'd51bdd88123345dd1ecabb5ae19d0a2d07ebb928', images: this.productImages, loop: true, showNavigation: this.productImages.length > 1, showIndicators: this.productImages.length > 1, autoplayInterval: 0 })), index.h("div", { key: '3be00df0cc32c2f4f257fd8dd7497c7bb6afaa5f', class: "product-details-section" }, this.product.brandName && (index.h("span", { key: 'd82bccd0c93a4c4ce233baff503cecaa6364f7c6', class: "brand-name" }, this.product.brandName)), index.h("h1", { key: 'c77f15d14d751b90950599412bc2b8d72a370423', class: "product-name" }, this.product.productName), this.product.shortDescription && (index.h("p", { key: 'e0bc24042bc488662d1b2e40cdd609d782fbbeb6', class: "product-description" }, product_service.productService.cleanDescription(this.product.shortDescription))), this.renderAvailabilityStatus(), this.renderColorSelector(), this.renderStorageSelector(), this.renderInstallmentSelector(), this.renderQuantitySelector(), this.renderPriceSection(), index.h("button", { key: '01e5b4170dd7366411c7895bd0e0d989ff7e066f', class: {
                'btn-add-to-cart': true,
                'loading': this.isAddingToCart,
                'disabled': !this.isAvailable,
            }, onClick: this.handleAddToCart, disabled: this.isAddingToCart || !this.isAvailable }, this.isAddingToCart ? (index.h("span", { class: "loading-text" }, index.h("span", { class: "spinner-small" }), "Agregando...")) : !this.isAvailable ? ('No disponible') : ('Continuar')), index.h("button", { key: '780721fbdfd8ffb44b74be51e804459737d1feff', class: "btn-back-link", onClick: this.onBack }, "\u2190 Volver al cat\u00E1logo"))), this.product.features && this.product.features.length > 0 && (index.h("div", { key: 'd235e0de16238f18a7a89e2b332f62ffbbbaff71', class: "features-section" }, index.h("h3", { key: 'c5248026fe7d81f25269579d807a4f9d2066d8ee', class: "features-title" }, "Caracter\u00EDsticas"), index.h("ul", { key: '4a17160dee4ea3e941bb2dce10807b0e12a69b0d', class: "features-list" }, this.product.features.map(feature => (index.h("li", { class: "feature-item" }, feature)))))), this.product.specifications && this.product.specifications.length > 0 && (index.h("div", { key: 'a78c04836047284e57da56afef4690ff6c7ca1bb', class: "specs-section" }, index.h("h3", { key: '91cc6b399c022c97e319301a0140bb1fc093da44', class: "specs-title" }, "Especificaciones"), index.h("div", { key: '4275176df1eda31758838a87a9b0cae2158ad8b0', class: "specs-grid" }, this.product.specifications.map((spec) => (index.h("div", { class: "spec-item" }, index.h("span", { class: "spec-label" }, spec.name), index.h("span", { class: "spec-value" }, spec.value))))))))))));
    }
};
