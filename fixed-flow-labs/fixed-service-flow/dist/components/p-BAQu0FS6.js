...
const UiStepper = /*@__PURE__*/ proxyCustomElement(class UiStepper extends H {
    ...
    static get style() { return uiStepperCss(); }
}, [769, "ui-stepper", {
        "steps": [16],
...
function defineCustomElement() {
    ...
    const components = ["ui-stepper"];
    components.forEach(tagName => { switch (tagName) {
        case "ui-stepper":
            if (!customElements.get(transformTag(tagName))) {
                customElements.define(transformTag(tagName), UiStepper);
            }
            break;
    } });
}
...
export { UiStepper as U, defineCustomElement as d };
//# sourceMappingURL=p-BAQu0FS6.js.map
