...
const StepOrderSummary$1 = /*@__PURE__*/ proxyCustomElement(class StepOrderSummary extends H {
    ...
    components.forEach(tagName => { switch (tagName) {
        case "step-order-summary":
            if (!customElements.get(transformTag(tagName))) {
                customElements.define(transformTag(tagName), StepOrderSummary$1);
            }
            break;
    } });
}
...
export { StepOrderSummary, defineCustomElement };
