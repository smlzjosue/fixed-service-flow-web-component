...
const UiInput$1 = /*@__PURE__*/ proxyCustomElement(class UiInput extends H {
    constructor(registerHost) {
        ...
        this.inputEvent = createEvent(this, "inputEvent");
...
function defineCustomElement$1() {
    ...
    const components = ["ui-input"];
    components.forEach(tagName => { switch (tagName) {
        case "ui-input":
            if (!customElements.get(transformTag(tagName))) {
                customElements.define(transformTag(tagName), UiInput$1);
            }
            break;
    } });
}
...
const UiInput = UiInput$1;
const defineCustomElement = defineCustomElement$1;

export { UiInput, defineCustomElement };
