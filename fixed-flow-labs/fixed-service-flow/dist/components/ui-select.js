...
const UiSelect$1 = /*@__PURE__*/ proxyCustomElement(class UiSelect extends H {
    ...
    static get style() { return uiSelectCss(); }
}, [769, "ui-select", {
        "label": [1],
        "name": [1],
        "value": [1025],
...
function defineCustomElement$1() {
    ...
    const components = ["ui-select"];
    components.forEach(tagName => { switch (tagName) {
        case "ui-select":
            if (!customElements.get(transformTag(tagName))) {
                customElements.define(transformTag(tagName), UiSelect$1);
            }
            break;
    } });
}
...
const UiSelect = UiSelect$1;
const defineCustomElement = defineCustomElement$1;

export { UiSelect, defineCustomElement };
