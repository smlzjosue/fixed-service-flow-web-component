...
import { p as paymentService } from './p-BkWfZYuz.js';
...
const StepPayment = /*@__PURE__*/ proxyCustomElement(class StepPayment extends H {
    ...
    render() {
        return (h(Host, { key: '44154235d6e0c51f68086e9c8a954f779d7068e4' }, h("div", { key: 'da809c7b605455a5dd7efc2b28728c1767d5e48e', class: "step-payment" }, h("div", { key: 'cc23c00669a5f05e6c8486ab3920918cceab0c87', class: "header" }, this.screen !== 'processing' && this.screen !== 'success' && (h("button", { key: 'a73cf3b08d251a0bcbfdc55a8d83fbf5bad93dc1', class: "btn-back-nav", onClick: () => this.onBack?.() }, h("svg", { key: '6f194f901fdad89e39a8ad7c23381953ac937a37', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, h("path", { key: 'e6187e8babfbcbcab83522c07f7cdffdfc9f8ebc', d: "M19 12H5M12 19l-7-7 7-7" })), "Regresar")), h("h1", { key: 'e72c0f65e18954f3af18d46f13fe2e85464206b4', class: "title" }, "Pago")), h("div", { key: '67ce4b79e0a0e7f7029e5cd3271592be219ea0dc', class: "content" }, this.screen === 'loading' && this.renderLoading(), this.screen === 'creating-order' && this.renderCreatingOrder(), this.screen === 'payment' && this.renderPaymentForm(), this.screen === 'processing' && this.renderProcessing(), this.screen === 'success' && this.renderSuccess(), this.screen === 'error' && this.renderError()))));
    }
...
//# sourceMappingURL=p-CZBCEyNV.js.map
