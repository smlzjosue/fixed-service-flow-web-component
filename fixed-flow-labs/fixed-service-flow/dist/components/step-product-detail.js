...
import { d as defineCustomElement$2 } from './p-BaH52zdS.js';
...
const StepProductDetail$1 = /*@__PURE__*/ proxyCustomElement(class StepProductDetail extends H {
    ...
    // ------------------------------------------
    render() {
        return (h(Host, { key: 'a448cf5392003a14812ac33028caabd59a4fad25' }, h("div", { key: 'e97f6adbfe1e888df01a5aa4044813ed63254a34', class: "step-product-detail" }, this.renderUnavailableAlert(), this.isLoading && (h("div", { key: 'acd10d1ca5d2cd32ec2658a68e9f1c7fa38a8073', class: "loading-container" }, h("div", { key: 'e4715b2bca39e232420fcf4a607554e1e5d84eca', class: "spinner" }), h("p", { key: 'dd86779545a8d8ef2c05eba40df456bf4fbfd2ac' }, "Cargando producto..."))), this.error && !this.isLoading && (h("div", { key: 'e72e720e372140d6022014402aa4fe6d3d5cf9b5', class: "error-container" }, h("p", { key: '5595b9fdffcb3be92f1f72e94896ed3f4c2300f9' }, this.error), h("button", { key: 'a002e91efc3e04516f88c0d1bf5a4fc27d012a5c', class: "btn-retry", onClick: () => this.loadProductDetail() }, "Reintentar"), h("button", { key: 'b1ac1878161e080899f32e0220249f110b5fe152', class: "btn-back", onClick: this.onBack }, "Volver al cat\u00E1logo"))), !this.isLoading && !this.error && this.product && (h("div", { key: 'f6867216549a19d5022c9ad8b5a2808ba8b14078', class: "product-container" }, this.renderBreadcrumb(), h("div", { key: 'ea01d34aa41a8b8cd7a5025cefb4264bbe251f1d', class: "product-grid" }, h("div", { key: '77ecbd357dcd1508440a189d1a6b50a02c7127b9', class: "product-image-section" }, h("ui-image-carousel", { key: '36c32a9e91525eb6bd57c85777f5f7b21e930a4a', images: this.productImages, loop: true, showNavigation: this.productImages.length > 1, showIndicators: this.productImages.length > 1, autoplayInterval: 0 })), h("div", { key: '9c37dad63658ad336c419d37a6b06d4435e260c3', class: "product-details-section" }, this.product.brandName && (h("span", { key: '25d5a79b3d327f06ad114f3cc78be1451ec21daa', class: "brand-name" }, this.product.brandName)), h("h1", { key: 'b2199ec13a366a503889dbddb53103cb3a496219', class: "product-name" }, this.product.productName), this.product.shortDescription && (h("p", { key: '576ecd16f0e7bf0b6e81e1479e5b7d2e5c683376', class: "product-description" }, productService.cleanDescription(this.product.shortDescription))), this.renderAvailabilityStatus(), this.renderColorSelector(), this.renderStorageSelector(), this.renderInstallmentSelector(), this.renderQuantitySelector(), this.renderPriceSection(), h("button", { key: '56861f841e02e64b1114904dfde16ab6fb9e93f6', class: {
                'btn-add-to-cart': true,
                'loading': this.isAddingToCart,
                'disabled': !this.isAvailable,
            }, onClick: this.handleAddToCart, disabled: this.isAddingToCart || !this.isAvailable }, this.isAddingToCart ? (h("span", { class: "loading-text" }, h("span", { class: "spinner-small" }), "Agregando...")) : !this.isAvailable ? ('No disponible') : ('Continuar')), h("button", { key: 'be00a3edab85ab112a01a4cd666ebe8734f0acf0', class: "btn-back-link", onClick: this.onBack }, "\u2190 Volver al cat\u00E1logo"))), this.product.features && this.product.features.length > 0 && (h("div", { key: 'b69502c45bff8afc44e33b98ce63831de88f85d6', class: "features-section" }, h("h3", { key: 'dd449a7c281d2d06c1375615a10cef83fe94ffff', class: "features-title" }, "Caracter\u00EDsticas"), h("ul", { key: '485cb3b91f06c81d58bd9da3658995ad38c74474', class: "features-list" }, this.product.features.map(feature => (h("li", { class: "feature-item" }, feature)))))), this.product.specifications && this.product.specifications.length > 0 && (h("div", { key: '7460ba5445fed1e5c4d2ffeae70334b96502259f', class: "specs-section" }, h("h3", { key: '3b59a830d396492fb5afe5d6078788ad453e5325', class: "specs-title" }, "Especificaciones"), h("div", { key: 'd1f09035e530060a4015844e05aeb317c89b97bc', class: "specs-grid" }, this.product.specifications.map((spec) => (h("div", { class: "spec-item" }, h("span", { class: "spec-label" }, spec.name), h("span", { class: "spec-value" }, spec.value))))))))))));
    }
    ...
    components.forEach(tagName => { switch (tagName) {
        case "step-product-detail":
            if (!customElements.get(transformTag(tagName))) {
                customElements.define(transformTag(tagName), StepProductDetail$1);
            }
            break;
...
const StepProductDetail = StepProductDetail$1;
const defineCustomElement = defineCustomElement$1;

export { StepProductDetail, defineCustomElement };
