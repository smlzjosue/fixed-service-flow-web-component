...
import { p as paymentService } from './payment.service-BjkEFOi4.js';
import { c as cartService } from './cart.service-C3FR8Gpo.js';
import { s as shippingService } from './shipping.service-Cs5hFbUT.js';
...
const StepPayment = class {
    ...
    render() {
        return (h(Host, { key: '81447a21d44b94f3ac37562b5c13a1ef803ebf22' }, h("div", { key: '52cc1c6b59084e47a5fc7e4bad1ae0d5cc40317c', class: "step-payment" }, h("div", { key: 'e69b6562354faebebb5e2ca2bca419643d345ccc', class: "header" }, this.screen !== 'processing' && this.screen !== 'success' && (h("button", { key: '22e833ea4d38ee57900c1e1255f58471d2fbb024', class: "btn-back-nav", onClick: () => this.onBack?.() }, h("svg", { key: 'c48e1058be956101408f42cc044ceb128c2b7a30', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, h("path", { key: '682a4f2d7c613330a925ba790a1bdd1f8079b901', d: "M19 12H5M12 19l-7-7 7-7" })), "Regresar")), h("h1", { key: 'e02d9349bb86dba37f45c6411b95781220141833', class: "title" }, "Pago")), h("div", { key: 'e504235a4d0a65fb5dbec45da1865f16d3ae83ad', class: "content" }, this.screen === 'loading' && this.renderLoading(), this.screen === 'creating-order' && this.renderCreatingOrder(), this.screen === 'payment' && this.renderPaymentForm(), this.screen === 'processing' && this.renderProcessing(), this.screen === 'success' && this.renderSuccess(), this.screen === 'error' && this.renderError()))));
    }
};
StepPayment.style = stepPaymentCss();

export { StepPayment as step_payment };
//# sourceMappingURL=step-payment.entry.esm.js.map
