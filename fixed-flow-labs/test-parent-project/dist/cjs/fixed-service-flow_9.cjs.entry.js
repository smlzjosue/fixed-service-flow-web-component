...
const StepLocation = class {
    ...
    // ------------------------------------------
    render() {
        return (index.h(index.Host, { key: '9f00def9ccc346b50dd0092b34d33d0afc7d4272' }, index.h("div", { key: '43c8a619905081a65d3c67b8b6663ed28259feb3', class: "step-location" }, this.isValidating && (index.h("div", { key: '0195458030f10d73d5cef3a963aed32da7386665', class: "step-location__validating-overlay" }, index.h("div", { key: '665fe951b2d78542afbce22bc1b2f19add1f446c', class: "step-location__validating-content" }, index.h("div", { key: 'f5504f2ebb709665259abedad0fc5d0ae9b0044a', class: "step-location__validating-spinner" }), index.h("p", { key: '9652b97b4f7b9f8d464a426bcd421eb213bbab69', class: "step-location__validating-text" }, "Validando cobertura...")))), index.h("header", { key: 'f78638177af520939d36b1f70314df4a6f596810', class: "step-location__header" }, index.h("h1", { key: '87bc6ffcdd7e7daccb547ee30c8e4a855e054a26', class: "step-location__title" }, index.h("span", { key: 'a021255a23f70de52af5b353018da87ebf6393da', class: "step-location__title--highlight" }, "Servicio fijo empresarial"), ' ', "en tu \u00E1rea")), index.h("div", { key: 'eaf39af8b1dd929bf0b813b81cfcff7e0876b0c8', class: "step-location__map-container" }, index.h("div", { key: '59848c139c6faec39804d81f285a8865608f0a5f', class: "step-location__controls" }, index.h("div", { key: '67f5f4153d6466392853b94c4e2c262566f34efe', class: "step-location__input-group" }, index.h("span", { key: '30afbcbc962a7a35a66151d0c2a2d39ade23a5eb', class: "step-location__input-icon" }, index.h("svg", { key: '2240de42e3fdcde78accf64c6be949a49121b2da', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("path", { key: '91a969294f1682a4f89c06fdf28ad17efeb5c707', d: "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" }), index.h("circle", { key: '90bd9b6df6c45741d665e877173fd763dfbb5c7b', cx: "12", cy: "10", r: "3" }))), index.h("input", { key: 'aaeeb190efb97d1d482456c72162833866553e7f', type: "text", class: "step-location__input", placeholder: "Ingrese su direcci\u00F3n", value: this.address, onInput: this.handleAddressChange, onKeyPress: this.handleKeyPress, ref: (el) => this.addressInput = el }), index.h("button", { key: 'dd78c6832ca5f10716c46acde8a74f75b9048576', class: {
                'step-location__btn-validate': true,
                'step-location__btn-validate--loading': this.isValidating,
            }, onClick: this.handleValidate, disabled: this.isValidating || (!this.address.trim() && !this.currentCoordinates) }, this.isValidating ? (index.h("span", { class: "step-location__btn-validate-content" }, index.h("span", { class: "step-location__btn-spinner" }), "Validando...")) : ('Validar'))), index.h("div", { key: '8e9b6b132633af9aff0f1a837582c42a7a0d7ccb', class: "step-location__location-container" }, index.h("button", { key: 'a00bc9825e8fc1ac58d5fa28648a0940b733de88', class: "step-location__btn-location", onClick: this.handleUseCurrentLocation, disabled: this.isGettingLocation || this.isLoadingMap }, index.h("svg", { key: 'e5af86f3be07afc4f97712929ca380fea34091c7', class: "step-location__btn-location-icon", viewBox: "0 0 24 24", fill: "currentColor", stroke: "none" }, index.h("path", { key: '2eb697175b76a087b3e5e12f8048a449517c3ea1', d: "M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" })), this.isGettingLocation ? 'Obteniendo ubicación...' : 'Utilizar Ubicación Actual'))), index.h("div", { key: 'b4b08d3fe6cc830ddfab4aa1789d7a1a05901d2e', class: "step-location__map" }, this.isLoadingMap && !this.mapError && (index.h("div", { key: '2659f19175fb0d23ae1e267b751bde41ad5aa800', class: "step-location__map-loading" }, index.h("div", { key: '429a190be63c7b3c6cbd3f1be6ab99914da0e06c', class: "step-location__spinner" }), index.h("p", { key: 'ffc6ab435a50c7f0678c54ea3a2b20a69bf87cd2' }, "Cargando mapa..."))), this.mapError && (index.h("div", { key: 'd25ed7b6f0292bf85c979c43683c60d7aba954cb', class: "step-location__map-error" }, index.h("p", { key: '944f5296e4a0770a6f111da14a54053d184971b5' }, this.mapError), !this.googleMapsKey && (index.h("small", { key: '274ba996d5e94834368836bbb7817475c5aa64ee' }, "Configura la prop google-maps-key en el componente")))), index.h("div", { key: '288374c3ccab67a4ad9b0c46ea20aeb71835adf8', class: "step-location__map-canvas", ref: (el) => this.mapContainer = el, style: { display: this.mapError ? 'none' : 'block' } }))), this.showErrorModal && (index.h("div", { key: 'f0a9869b42a1efce9f2758814a30c320a3260e48', class: "step-location__modal-backdrop" }, index.h("div", { key: '5ae852cb63dd660c4175a11718b3847d458ece2c', class: "step-location__modal step-location__modal--error" }, index.h("button", { key: 'ee317e1a56f6583f6e789eda000a170248dd6b84', class: "step-location__modal-close", onClick: () => this.showErrorModal = false }, "\u00D7"), index.h("div", { key: '72dde675ffb4cb725bae7184388bb24641bad286', class: "step-location__modal-error-bar" }, "Error"), index.h("p", { key: 'c653f42dd5c63fd6b9b193c4f2424f011e6d2c34', class: "step-location__modal-message" }, this.errorMessage), index.h("button", { key: '4eb8f7a55456e4e944498152b6500f0d03394311', class: "step-location__modal-btn", onClick: () => this.showErrorModal = false }, "Cerrar")))))));
    }
};
