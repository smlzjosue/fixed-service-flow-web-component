...
const UiRadioCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e457f468d609daef802a898e93bcaefd55fa6f95' }, index.h("div", { key: 'dd576de5abe3b43d83a718d71a276fab2c75451e', class: classes, role: "radio", "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: this.disabled ? -1 : 0, onClick: this.handleSelect, onKeyDown: this.handleKeyDown }, index.h("input", { key: 'a9d9718ac6614ae60fea1eb78bf16a1a44147625', type: "radio", class: "ui-radio-card__input", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, tabIndex: -1 }), this.badge && (index.h("span", { key: '2a02a6f0877b12f29b50a39efeee7eb3a663cd49', class: "ui-radio-card__badge" }, this.badge)), index.h("div", { key: 'b4e0b2282af44da7ff1a4c23cfc78a1492f4d967', class: "ui-radio-card__indicator" }, index.h("span", { key: '519c1979747352e12d0d27e2020076caa4ab8ce1', class: "ui-radio-card__indicator-dot" })), index.h("div", { key: '573faad7b661cc3322f8d0ef3a195eb4d0ed3129', class: "ui-radio-card__content" }, this.icon && (index.h("div", { key: '88113ae6e04aad0b91dbdb7b46e12bc8198fe283', class: "ui-radio-card__icon" }, index.h("slot", { key: '1ffb87e585c7ae96380ea0e50a3e76be8bdfd3b7', name: "icon" }, index.h("img", { key: '6015e1a2e34869b887f134c63fe94dd5eba90c9c', src: this.icon, alt: "" })))), index.h("div", { key: '2cc7ba6ec3ad0480f7a0024c3ef2d2744a107bf3', class: "ui-radio-card__text" }, this.cardTitle && (index.h("h4", { key: '89a26511d7858f1c2d44069ef035593dbdbb6734', class: "ui-radio-card__title" }, this.cardTitle)), this.description && (index.h("p", { key: 'edd5a1697902e4428fa2116b39bbf8be89bf1771', class: "ui-radio-card__description" }, this.description)), index.h("slot", { key: '0cc5a11dcc7f7a8b18e759c130cae2ceafa83038' })), this.price && (index.h("div", { key: 'e731fa721159342bea1c57fd098e627cb3b440da', class: "ui-radio-card__price" }, this.price))))));
    }
};
