...
const UiDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '68f78191c4e982e6946ba9384578a42a9e68c02b' }, index.h("div", { key: 'bddb451c4b7f95e200644b0c311878b53dc0cda5', class: containerClasses }, this.label && (index.h("label", { key: '9f9a20412a307026fb66172f73158170361915f8', class: "ui-date-picker__label", htmlFor: this.name }, this.label, this.required && index.h("span", { key: 'd3d36db9915a3e471bd6b1609d9192c51c80a979', class: "ui-date-picker__required" }, "*"))), index.h("div", { key: '83e942a71f893ad337580fa4fa6cee791fe25f95', class: "ui-date-picker__wrapper" }, index.h("input", { key: 'ec67147299f6331d9d78fc3ce42268e848b2f90b', type: "date", class: "ui-date-picker__field", id: this.name, name: this.name, value: this.value, min: this.min, max: this.max, placeholder: this.placeholder, disabled: this.disabled, readOnly: this.readonly, required: this.required, onInput: this.handleInput, onFocus: this.handleFocus, onBlur: this.handleBlur }), index.h("div", { key: 'ae1ffb9d232473487d23b4bcc9e596d78c6fff37', class: "ui-date-picker__icon" }, index.h("svg", { key: '4e5ed1acd3a71355a8c3811d4fd6c08fac280060', viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2" }, index.h("rect", { key: 'da68d620e7e5f5613d7fe84d915a5acb72025d2a', x: "3", y: "4", width: "18", height: "18", rx: "2", ry: "2" }), index.h("line", { key: '8394d83f687130b1f57293d7524930ed9bc576f9', x1: "16", y1: "2", x2: "16", y2: "6" }), index.h("line", { key: 'b28bd53001d84f2168ad6ed4d14b906256d0d3cf', x1: "8", y1: "2", x2: "8", y2: "6" }), index.h("line", { key: '940f3a5dda26ead172e443a1355d8ab216c05580', x1: "3", y1: "10", x2: "21", y2: "10" })))), (hasError || this.helperText) && (index.h("div", { key: 'c48974c84aa3e75c77fd55a9f95fdb8b7910a56b', class: { 'ui-date-picker__message': true, 'ui-date-picker__message--error': hasError } }, hasError ? this.error : this.helperText)))));
    }
