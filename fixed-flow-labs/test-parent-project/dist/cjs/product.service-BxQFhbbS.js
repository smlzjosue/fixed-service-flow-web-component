...
class CatalogueService {
    ...
    async listCatalogue(subcatalogId = this.FILTER_INTERNET_INALAMBRICO, pageNo = 1, searchText = '', brand = '', price = '') {
        ...
        const apiResponse = await token_service.httpService.post('api/Catalogue/listCatalogue', request);
...
class ProductService {
    ...
    async getEquipmentDetail(productId) {
        try {
            ...
            const response = await token_service.httpService.post('api/Catalogue/equipmentDetail', request);
...
//# sourceMappingURL=product.service-BxQFhbbS.js.map
